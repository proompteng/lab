...
- This directory now exposes a `kustomization.yaml` that renders the [OT-Container-Kit Redis Operator](https://github.com/OT-CONTAINER-KIT/redis-operator) Helm chart (v0.26.1) via the Kustomize `helmCharts` plugin.
