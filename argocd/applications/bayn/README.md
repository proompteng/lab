...
exact source/image/strategy/account plan, and activates the native controller. The public Bayn deployment rolls out
...
deactivate the native controller and prove its writer fence is clear before activating a compatible replacement
