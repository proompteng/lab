...
- A `graf-neo4j-browser` LoadBalancer service is applied alongside the Helm release; it carries `tailscale.com/hostname=neo4j-browser` so operators can reach the Neo4j Browser via that tailnet DNS name.
