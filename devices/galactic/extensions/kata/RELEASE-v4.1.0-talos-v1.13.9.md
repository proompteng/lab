...
extension or its activation label, and these candidate digests must not replace the accepted r4 installer references
above until a separately authorized node rollout records installation and live persistent-block acceptance.
