...
> **Release notes:** Every SDK version is documented in [`packages/temporal-bun-sdk/CHANGELOG.md`](https://github.com/proompteng/lab/blob/main/packages/temporal-bun-sdk/CHANGELOG.md).
