...
// The window manager admits twenty windows, and each Code window may watch
// sixteen directories. Allow one reconnect overlap for every supported stream
// while retaining a hard per-identity ceiling.
