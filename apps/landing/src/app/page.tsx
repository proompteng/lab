      ...
      <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(129,140,248,0.12),_transparent_55%),radial-gradient(circle_at_bottom,_rgba(129,140,248,0.12),_transparent_40%)]">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pb-16 sm:pb-24">
          ...
          <main className="flex flex-col gap-12 py-10 sm:gap-16 sm:py-16">
            ...
            <ControlPlaneOverview {...content.controlPlane} />
            <SocialProof {...content.socialProof} />
            <Metrics {...content.metrics} />
            <BenefitsGrid {...content.benefits} />
            <FeatureShowcase sections={content.showcase.sections} />
            <ContentCards sectionId="use-cases" title={content.useCases.title} items={content.useCases.items} />
            <ContentCards sectionId="models" title={content.modelCatalog.title} items={content.modelCatalog.items} />
            <PlaybookTimeline {...content.playbook} />
          ...
          <footer className="mt-16 border-t border-border/60 pt-12 pb-10 text-sm text-muted-foreground sm:mt-24">
            <div className="grid gap-10 sm:grid-cols-[minmax(0,1.4fr)_repeat(3,minmax(0,1fr))]">
              <div>
                ...
                <p className="mt-3 max-w-sm text-sm">
                  A control plane for AI agents focused on clear policies and visibility.
                </p>
              </div>
            ...
            <p className="mt-10 text-xs text-muted-foreground">
              (c) {new Date().getFullYear()} proompteng. Built for teams shipping AI agents.
            </p>
          </footer>
        </div>
      </div>
