...
describe('buildCodexPrompt', () => {
  it('constructs an implementation prompt with execution rules and memory capture', () => {
    ...
    expect(prompt).toContain('Agents app-server runner streams turn events')
    expect(prompt).not.toContain('services/jangar/scripts/codex')
    expect(prompt).not.toContain('codex-nats-publish')
