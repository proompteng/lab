...
export class HandlerError extends Message<HandlerError> {
  ...
  static equals(a: HandlerError | PlainMessage<HandlerError> | undefined, b: HandlerError | PlainMessage<HandlerError> | undefined): boolean {
...
export class UnsuccessfulOperationError extends Message<UnsuccessfulOperationError> {
  ...
  static equals(a: UnsuccessfulOperationError | PlainMessage<UnsuccessfulOperationError> | undefined, b: UnsuccessfulOperationError | PlainMessage<UnsuccessfulOperationError> | undefined): boolean {
...
export class StartOperationRequest extends Message<StartOperationRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "callback_header", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
  ...
  static equals(a: StartOperationRequest | PlainMessage<StartOperationRequest> | undefined, b: StartOperationRequest | PlainMessage<StartOperationRequest> | undefined): boolean {
...
export class StartOperationResponse extends Message<StartOperationResponse> {
  ...
  static equals(a: StartOperationResponse | PlainMessage<StartOperationResponse> | undefined, b: StartOperationResponse | PlainMessage<StartOperationResponse> | undefined): boolean {
...
export class StartOperationResponse_Sync extends Message<StartOperationResponse_Sync> {
  ...
  static equals(a: StartOperationResponse_Sync | PlainMessage<StartOperationResponse_Sync> | undefined, b: StartOperationResponse_Sync | PlainMessage<StartOperationResponse_Sync> | undefined): boolean {
...
export class StartOperationResponse_Async extends Message<StartOperationResponse_Async> {
  ...
  static equals(a: StartOperationResponse_Async | PlainMessage<StartOperationResponse_Async> | undefined, b: StartOperationResponse_Async | PlainMessage<StartOperationResponse_Async> | undefined): boolean {
...
export class EndpointSpec extends Message<EndpointSpec> {
  ...
  static equals(a: EndpointSpec | PlainMessage<EndpointSpec> | undefined, b: EndpointSpec | PlainMessage<EndpointSpec> | undefined): boolean {
...
export class EndpointTarget extends Message<EndpointTarget> {
  ...
  static equals(a: EndpointTarget | PlainMessage<EndpointTarget> | undefined, b: EndpointTarget | PlainMessage<EndpointTarget> | undefined): boolean {
...
export class EndpointTarget_Worker extends Message<EndpointTarget_Worker> {
  ...
  static equals(a: EndpointTarget_Worker | PlainMessage<EndpointTarget_Worker> | undefined, b: EndpointTarget_Worker | PlainMessage<EndpointTarget_Worker> | undefined): boolean {
...
export class EndpointTarget_External extends Message<EndpointTarget_External> {
  ...
  static equals(a: EndpointTarget_External | PlainMessage<EndpointTarget_External> | undefined, b: EndpointTarget_External | PlainMessage<EndpointTarget_External> | undefined): boolean {
