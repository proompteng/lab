...
import { ActivityType, Header, Memo, Payload, Payloads, Priority, RetryPolicy, SearchAttributes, WorkflowExecution, WorkflowType } from "../../common/v1/message_pbts";
...
export class ScheduleActivityTaskCommandAttributes extends Message<ScheduleActivityTaskCommandAttributes> {
  ...
  static equals(a: ScheduleActivityTaskCommandAttributes | PlainMessage<ScheduleActivityTaskCommandAttributes> | undefined, b: ScheduleActivityTaskCommandAttributes | PlainMessage<ScheduleActivityTaskCommandAttributes> | undefined): boolean {
...
export class RequestCancelActivityTaskCommandAttributes extends Message<RequestCancelActivityTaskCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RequestCancelActivityTaskCommandAttributes {
    return new RequestCancelActivityTaskCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RequestCancelActivityTaskCommandAttributes {
    return new RequestCancelActivityTaskCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RequestCancelActivityTaskCommandAttributes {
    return new RequestCancelActivityTaskCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: RequestCancelActivityTaskCommandAttributes | PlainMessage<RequestCancelActivityTaskCommandAttributes> | undefined, b: RequestCancelActivityTaskCommandAttributes | PlainMessage<RequestCancelActivityTaskCommandAttributes> | undefined): boolean {
...
export class StartTimerCommandAttributes extends Message<StartTimerCommandAttributes> {
  ...
  static equals(a: StartTimerCommandAttributes | PlainMessage<StartTimerCommandAttributes> | undefined, b: StartTimerCommandAttributes | PlainMessage<StartTimerCommandAttributes> | undefined): boolean {
...
export class CompleteWorkflowExecutionCommandAttributes extends Message<CompleteWorkflowExecutionCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CompleteWorkflowExecutionCommandAttributes {
    return new CompleteWorkflowExecutionCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CompleteWorkflowExecutionCommandAttributes {
    return new CompleteWorkflowExecutionCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CompleteWorkflowExecutionCommandAttributes {
    return new CompleteWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: CompleteWorkflowExecutionCommandAttributes | PlainMessage<CompleteWorkflowExecutionCommandAttributes> | undefined, b: CompleteWorkflowExecutionCommandAttributes | PlainMessage<CompleteWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class FailWorkflowExecutionCommandAttributes extends Message<FailWorkflowExecutionCommandAttributes> {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): FailWorkflowExecutionCommandAttributes {
    return new FailWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: FailWorkflowExecutionCommandAttributes | PlainMessage<FailWorkflowExecutionCommandAttributes> | undefined, b: FailWorkflowExecutionCommandAttributes | PlainMessage<FailWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class CancelTimerCommandAttributes extends Message<CancelTimerCommandAttributes> {
  ...
  static equals(a: CancelTimerCommandAttributes | PlainMessage<CancelTimerCommandAttributes> | undefined, b: CancelTimerCommandAttributes | PlainMessage<CancelTimerCommandAttributes> | undefined): boolean {
...
export class CancelWorkflowExecutionCommandAttributes extends Message<CancelWorkflowExecutionCommandAttributes> {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CancelWorkflowExecutionCommandAttributes {
    return new CancelWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: CancelWorkflowExecutionCommandAttributes | PlainMessage<CancelWorkflowExecutionCommandAttributes> | undefined, b: CancelWorkflowExecutionCommandAttributes | PlainMessage<CancelWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class RequestCancelExternalWorkflowExecutionCommandAttributes extends Message<RequestCancelExternalWorkflowExecutionCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RequestCancelExternalWorkflowExecutionCommandAttributes {
    return new RequestCancelExternalWorkflowExecutionCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RequestCancelExternalWorkflowExecutionCommandAttributes {
    return new RequestCancelExternalWorkflowExecutionCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RequestCancelExternalWorkflowExecutionCommandAttributes {
    return new RequestCancelExternalWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: RequestCancelExternalWorkflowExecutionCommandAttributes | PlainMessage<RequestCancelExternalWorkflowExecutionCommandAttributes> | undefined, b: RequestCancelExternalWorkflowExecutionCommandAttributes | PlainMessage<RequestCancelExternalWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class SignalExternalWorkflowExecutionCommandAttributes extends Message<SignalExternalWorkflowExecutionCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SignalExternalWorkflowExecutionCommandAttributes {
    return new SignalExternalWorkflowExecutionCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SignalExternalWorkflowExecutionCommandAttributes {
    return new SignalExternalWorkflowExecutionCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SignalExternalWorkflowExecutionCommandAttributes {
    return new SignalExternalWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: SignalExternalWorkflowExecutionCommandAttributes | PlainMessage<SignalExternalWorkflowExecutionCommandAttributes> | undefined, b: SignalExternalWorkflowExecutionCommandAttributes | PlainMessage<SignalExternalWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class UpsertWorkflowSearchAttributesCommandAttributes extends Message<UpsertWorkflowSearchAttributesCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UpsertWorkflowSearchAttributesCommandAttributes {
    return new UpsertWorkflowSearchAttributesCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UpsertWorkflowSearchAttributesCommandAttributes {
    return new UpsertWorkflowSearchAttributesCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UpsertWorkflowSearchAttributesCommandAttributes {
    return new UpsertWorkflowSearchAttributesCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: UpsertWorkflowSearchAttributesCommandAttributes | PlainMessage<UpsertWorkflowSearchAttributesCommandAttributes> | undefined, b: UpsertWorkflowSearchAttributesCommandAttributes | PlainMessage<UpsertWorkflowSearchAttributesCommandAttributes> | undefined): boolean {
...
export class ModifyWorkflowPropertiesCommandAttributes extends Message<ModifyWorkflowPropertiesCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ModifyWorkflowPropertiesCommandAttributes {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ModifyWorkflowPropertiesCommandAttributes {
    return new ModifyWorkflowPropertiesCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: ModifyWorkflowPropertiesCommandAttributes | PlainMessage<ModifyWorkflowPropertiesCommandAttributes> | undefined, b: ModifyWorkflowPropertiesCommandAttributes | PlainMessage<ModifyWorkflowPropertiesCommandAttributes> | undefined): boolean {
...
export class RecordMarkerCommandAttributes extends Message<RecordMarkerCommandAttributes> {
  ...
  static equals(a: RecordMarkerCommandAttributes | PlainMessage<RecordMarkerCommandAttributes> | undefined, b: RecordMarkerCommandAttributes | PlainMessage<RecordMarkerCommandAttributes> | undefined): boolean {
...
export class ContinueAsNewWorkflowExecutionCommandAttributes extends Message<ContinueAsNewWorkflowExecutionCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ContinueAsNewWorkflowExecutionCommandAttributes {
    return new ContinueAsNewWorkflowExecutionCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ContinueAsNewWorkflowExecutionCommandAttributes {
    return new ContinueAsNewWorkflowExecutionCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ContinueAsNewWorkflowExecutionCommandAttributes {
    return new ContinueAsNewWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: ContinueAsNewWorkflowExecutionCommandAttributes | PlainMessage<ContinueAsNewWorkflowExecutionCommandAttributes> | undefined, b: ContinueAsNewWorkflowExecutionCommandAttributes | PlainMessage<ContinueAsNewWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class StartChildWorkflowExecutionCommandAttributes extends Message<StartChildWorkflowExecutionCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): StartChildWorkflowExecutionCommandAttributes {
    return new StartChildWorkflowExecutionCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): StartChildWorkflowExecutionCommandAttributes {
    return new StartChildWorkflowExecutionCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): StartChildWorkflowExecutionCommandAttributes {
    return new StartChildWorkflowExecutionCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: StartChildWorkflowExecutionCommandAttributes | PlainMessage<StartChildWorkflowExecutionCommandAttributes> | undefined, b: StartChildWorkflowExecutionCommandAttributes | PlainMessage<StartChildWorkflowExecutionCommandAttributes> | undefined): boolean {
...
export class ProtocolMessageCommandAttributes extends Message<ProtocolMessageCommandAttributes> {
  ...
  static equals(a: ProtocolMessageCommandAttributes | PlainMessage<ProtocolMessageCommandAttributes> | undefined, b: ProtocolMessageCommandAttributes | PlainMessage<ProtocolMessageCommandAttributes> | undefined): boolean {
...
export class ScheduleNexusOperationCommandAttributes extends Message<ScheduleNexusOperationCommandAttributes> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "nexus_header", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 9 /* ScalarType.STRING */} },
  ]);
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ScheduleNexusOperationCommandAttributes {
    return new ScheduleNexusOperationCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: ScheduleNexusOperationCommandAttributes | PlainMessage<ScheduleNexusOperationCommandAttributes> | undefined, b: ScheduleNexusOperationCommandAttributes | PlainMessage<ScheduleNexusOperationCommandAttributes> | undefined): boolean {
...
export class RequestCancelNexusOperationCommandAttributes extends Message<RequestCancelNexusOperationCommandAttributes> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RequestCancelNexusOperationCommandAttributes {
    return new RequestCancelNexusOperationCommandAttributes().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RequestCancelNexusOperationCommandAttributes {
    return new RequestCancelNexusOperationCommandAttributes().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RequestCancelNexusOperationCommandAttributes {
    return new RequestCancelNexusOperationCommandAttributes().fromJsonString(jsonString, options);
  }

  static equals(a: RequestCancelNexusOperationCommandAttributes | PlainMessage<RequestCancelNexusOperationCommandAttributes> | undefined, b: RequestCancelNexusOperationCommandAttributes | PlainMessage<RequestCancelNexusOperationCommandAttributes> | undefined): boolean {
...
export class Command extends Message<Command> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "schedule_activity_task_command_attributes", kind: "message", T: ScheduleActivityTaskCommandAttributes, oneof: "attributes" },
    { no: 3, name: "start_timer_command_attributes", kind: "message", T: StartTimerCommandAttributes, oneof: "attributes" },
    { no: 4, name: "complete_workflow_execution_command_attributes", kind: "message", T: CompleteWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 5, name: "fail_workflow_execution_command_attributes", kind: "message", T: FailWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 6, name: "request_cancel_activity_task_command_attributes", kind: "message", T: RequestCancelActivityTaskCommandAttributes, oneof: "attributes" },
    { no: 7, name: "cancel_timer_command_attributes", kind: "message", T: CancelTimerCommandAttributes, oneof: "attributes" },
    { no: 8, name: "cancel_workflow_execution_command_attributes", kind: "message", T: CancelWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 9, name: "request_cancel_external_workflow_execution_command_attributes", kind: "message", T: RequestCancelExternalWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 10, name: "record_marker_command_attributes", kind: "message", T: RecordMarkerCommandAttributes, oneof: "attributes" },
    { no: 11, name: "continue_as_new_workflow_execution_command_attributes", kind: "message", T: ContinueAsNewWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 12, name: "start_child_workflow_execution_command_attributes", kind: "message", T: StartChildWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 13, name: "signal_external_workflow_execution_command_attributes", kind: "message", T: SignalExternalWorkflowExecutionCommandAttributes, oneof: "attributes" },
    { no: 14, name: "upsert_workflow_search_attributes_command_attributes", kind: "message", T: UpsertWorkflowSearchAttributesCommandAttributes, oneof: "attributes" },
    { no: 15, name: "protocol_message_command_attributes", kind: "message", T: ProtocolMessageCommandAttributes, oneof: "attributes" },
    { no: 17, name: "modify_workflow_properties_command_attributes", kind: "message", T: ModifyWorkflowPropertiesCommandAttributes, oneof: "attributes" },
    { no: 18, name: "schedule_nexus_operation_command_attributes", kind: "message", T: ScheduleNexusOperationCommandAttributes, oneof: "attributes" },
    { no: 19, name: "request_cancel_nexus_operation_command_attributes", kind: "message", T: RequestCancelNexusOperationCommandAttributes, oneof: "attributes" },
  ]);
