...
export class NotFoundFailure extends Message<NotFoundFailure> {
  ...
  static equals(a: NotFoundFailure | PlainMessage<NotFoundFailure> | undefined, b: NotFoundFailure | PlainMessage<NotFoundFailure> | undefined): boolean {
...
export class WorkflowExecutionAlreadyStartedFailure extends Message<WorkflowExecutionAlreadyStartedFailure> {
  ...
  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): WorkflowExecutionAlreadyStartedFailure {
    return new WorkflowExecutionAlreadyStartedFailure().fromJsonString(jsonString, options);
  }

  static equals(a: WorkflowExecutionAlreadyStartedFailure | PlainMessage<WorkflowExecutionAlreadyStartedFailure> | undefined, b: WorkflowExecutionAlreadyStartedFailure | PlainMessage<WorkflowExecutionAlreadyStartedFailure> | undefined): boolean {
...
export class NamespaceNotActiveFailure extends Message<NamespaceNotActiveFailure> {
  ...
  static equals(a: NamespaceNotActiveFailure | PlainMessage<NamespaceNotActiveFailure> | undefined, b: NamespaceNotActiveFailure | PlainMessage<NamespaceNotActiveFailure> | undefined): boolean {
...
export class NamespaceUnavailableFailure extends Message<NamespaceUnavailableFailure> {
  ...
  static equals(a: NamespaceUnavailableFailure | PlainMessage<NamespaceUnavailableFailure> | undefined, b: NamespaceUnavailableFailure | PlainMessage<NamespaceUnavailableFailure> | undefined): boolean {
...
export class NamespaceInvalidStateFailure extends Message<NamespaceInvalidStateFailure> {
  ...
  static equals(a: NamespaceInvalidStateFailure | PlainMessage<NamespaceInvalidStateFailure> | undefined, b: NamespaceInvalidStateFailure | PlainMessage<NamespaceInvalidStateFailure> | undefined): boolean {
...
export class NamespaceNotFoundFailure extends Message<NamespaceNotFoundFailure> {
  ...
  static equals(a: NamespaceNotFoundFailure | PlainMessage<NamespaceNotFoundFailure> | undefined, b: NamespaceNotFoundFailure | PlainMessage<NamespaceNotFoundFailure> | undefined): boolean {
...
export class NamespaceAlreadyExistsFailure extends Message<NamespaceAlreadyExistsFailure> {
  ...
  static equals(a: NamespaceAlreadyExistsFailure | PlainMessage<NamespaceAlreadyExistsFailure> | undefined, b: NamespaceAlreadyExistsFailure | PlainMessage<NamespaceAlreadyExistsFailure> | undefined): boolean {
...
export class ClientVersionNotSupportedFailure extends Message<ClientVersionNotSupportedFailure> {
  ...
  static equals(a: ClientVersionNotSupportedFailure | PlainMessage<ClientVersionNotSupportedFailure> | undefined, b: ClientVersionNotSupportedFailure | PlainMessage<ClientVersionNotSupportedFailure> | undefined): boolean {
...
export class ServerVersionNotSupportedFailure extends Message<ServerVersionNotSupportedFailure> {
  ...
  static equals(a: ServerVersionNotSupportedFailure | PlainMessage<ServerVersionNotSupportedFailure> | undefined, b: ServerVersionNotSupportedFailure | PlainMessage<ServerVersionNotSupportedFailure> | undefined): boolean {
...
export class CancellationAlreadyRequestedFailure extends Message<CancellationAlreadyRequestedFailure> {
  ...
  static equals(a: CancellationAlreadyRequestedFailure | PlainMessage<CancellationAlreadyRequestedFailure> | undefined, b: CancellationAlreadyRequestedFailure | PlainMessage<CancellationAlreadyRequestedFailure> | undefined): boolean {
...
export class QueryFailedFailure extends Message<QueryFailedFailure> {
  ...
  static equals(a: QueryFailedFailure | PlainMessage<QueryFailedFailure> | undefined, b: QueryFailedFailure | PlainMessage<QueryFailedFailure> | undefined): boolean {
...
export class PermissionDeniedFailure extends Message<PermissionDeniedFailure> {
  ...
  static equals(a: PermissionDeniedFailure | PlainMessage<PermissionDeniedFailure> | undefined, b: PermissionDeniedFailure | PlainMessage<PermissionDeniedFailure> | undefined): boolean {
...
export class ResourceExhaustedFailure extends Message<ResourceExhaustedFailure> {
  ...
  static equals(a: ResourceExhaustedFailure | PlainMessage<ResourceExhaustedFailure> | undefined, b: ResourceExhaustedFailure | PlainMessage<ResourceExhaustedFailure> | undefined): boolean {
...
export class SystemWorkflowFailure extends Message<SystemWorkflowFailure> {
  ...
  static equals(a: SystemWorkflowFailure | PlainMessage<SystemWorkflowFailure> | undefined, b: SystemWorkflowFailure | PlainMessage<SystemWorkflowFailure> | undefined): boolean {
...
export class WorkflowNotReadyFailure extends Message<WorkflowNotReadyFailure> {
  ...
  static equals(a: WorkflowNotReadyFailure | PlainMessage<WorkflowNotReadyFailure> | undefined, b: WorkflowNotReadyFailure | PlainMessage<WorkflowNotReadyFailure> | undefined): boolean {
...
export class NewerBuildExistsFailure extends Message<NewerBuildExistsFailure> {
  ...
  static equals(a: NewerBuildExistsFailure | PlainMessage<NewerBuildExistsFailure> | undefined, b: NewerBuildExistsFailure | PlainMessage<NewerBuildExistsFailure> | undefined): boolean {
...
export class MultiOperationExecutionFailure extends Message<MultiOperationExecutionFailure> {
  ...
  static equals(a: MultiOperationExecutionFailure | PlainMessage<MultiOperationExecutionFailure> | undefined, b: MultiOperationExecutionFailure | PlainMessage<MultiOperationExecutionFailure> | undefined): boolean {
...
export class MultiOperationExecutionFailure_OperationStatus extends Message<MultiOperationExecutionFailure_OperationStatus> {
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MultiOperationExecutionFailure_OperationStatus {
    return new MultiOperationExecutionFailure_OperationStatus().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MultiOperationExecutionFailure_OperationStatus {
    return new MultiOperationExecutionFailure_OperationStatus().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MultiOperationExecutionFailure_OperationStatus {
    return new MultiOperationExecutionFailure_OperationStatus().fromJsonString(jsonString, options);
  }

  static equals(a: MultiOperationExecutionFailure_OperationStatus | PlainMessage<MultiOperationExecutionFailure_OperationStatus> | undefined, b: MultiOperationExecutionFailure_OperationStatus | PlainMessage<MultiOperationExecutionFailure_OperationStatus> | undefined): boolean {
