...
export class SourceInfo extends Message<SourceInfo> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "extensions", kind: "message", T: SourceInfo_Extension, repeated: true },
  ]);
 ...
 */
export class SourceInfo_Extension extends Message<SourceInfo_Extension> {
  /**
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "affected_components", kind: "enum", T: proto3.getEnumType(SourceInfo_Extension_Component), repeated: true },
  ...
  static equals(a: SourceInfo_Extension | PlainMessage<SourceInfo_Extension> | undefined, b: SourceInfo_Extension | PlainMessage<SourceInfo_Extension> | undefined): boolean {
    return proto3.util.equals(SourceInfo_Extension, a, b);
  }
}
...
// Retrieve enum metadata with: proto3.getEnumType(SourceInfo_Extension_Component)
proto3.util.setEnumType(SourceInfo_Extension_Component, "google.api.expr.v1alpha1.SourceInfo.Extension.Component", [
  { no: 0, name: "COMPONENT_UNSPECIFIED" },
  { no: 1, name: "COMPONENT_PARSER" },
  { no: 2, name: "COMPONENT_TYPE_CHECKER" },
  { no: 3, name: "COMPONENT_RUNTIME" },
]);
 ...
 */
export class SourceInfo_Extension_Version extends Message<SourceInfo_Extension_Version> {
  /**
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SourceInfo_Extension_Version {
    return new SourceInfo_Extension_Version().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SourceInfo_Extension_Version {
    return new SourceInfo_Extension_Version().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SourceInfo_Extension_Version {
    return new SourceInfo_Extension_Version().fromJsonString(jsonString, options);
  }
  ...
  static equals(a: SourceInfo_Extension_Version | PlainMessage<SourceInfo_Extension_Version> | undefined, b: SourceInfo_Extension_Version | PlainMessage<SourceInfo_Extension_Version> | undefined): boolean {
    return proto3.util.equals(SourceInfo_Extension_Version, a, b);
  }
}
