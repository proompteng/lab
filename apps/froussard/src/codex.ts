...
const buildImplementationPrompt = ({
  ...
  return [
    ...
    '',
    'Runtime environment (from apps/froussard/Dockerfile.codex):',
    '- Workspace: /workspace, repo at /workspace/lab (WORKSPACE/WORKTREE).',
    '- Versions: Node 24.11.1, Go 1.25.4, Bun 1.3.5.',
    '- Tools: git, gh, jq, curl, docker (dind via DOCKER_HOST tcp://localhost:2375),',
    '  argo, kubeconform, temporal, protobuf-compiler.',
    'Memory capture:',
