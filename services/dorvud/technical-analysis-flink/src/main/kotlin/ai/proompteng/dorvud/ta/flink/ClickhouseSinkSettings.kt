...
internal const val MAX_SAFE_OPTIONS_CLICKHOUSE_INSERT_BATCH_SIZE: Int = 1_000
...
internal fun normalizeOptionsClickhouseInsertBatchSize(requested: Int): Int =
  requested.coerceIn(1, MAX_SAFE_OPTIONS_CLICKHOUSE_INSERT_BATCH_SIZE)
