...
class AvroSerde(
  ...
  private fun flattenStatus(env: Envelope<TaStatusPayload>): GenericData.Record {
    ...
    record.put("source_lag_ms", env.payload.sourceLagMs)
    ...
    record.put("current_input_event_count", env.payload.currentInputEventCount)
    record.put("current_output_event_count", env.payload.currentOutputEventCount)
    record.put("current_record_count", env.payload.currentRecordCount)
    record.put("input_rate_per_second", env.payload.inputRatePerSecond)
    record.put("output_rate_per_second", env.payload.outputRatePerSecond)
    record.put("microbar_event_count", env.payload.microbarEventCount)
    record.put("signal_event_count", env.payload.signalEventCount)
    record.put("microbar_rate_per_second", env.payload.microbarRatePerSecond)
    record.put("signal_rate_per_second", env.payload.signalRatePerSecond)
    record.put("clickhouse_sink_enabled", env.payload.clickhouseSinkEnabled)
    record.put("per_symbol_latest_event_ts", env.payload.perSymbolLatestEventTs)
    record.put("market_session_state", env.payload.marketSessionState)
    record.put("status_reason", env.payload.statusReason)
