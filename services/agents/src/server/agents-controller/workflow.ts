...
const WORKFLOW_LOOPS_ENABLED_ENV = 'AGENTS_CONTROLLER_WORKFLOW_LOOPS_ENABLED'
const WORKFLOW_LOOP_MAX_ITERATIONS_ENV = 'AGENTS_CONTROLLER_WORKFLOW_LOOP_MAX_ITERATIONS'
const WORKFLOW_LOOP_STATUS_HISTORY_LIMIT_ENV = 'AGENTS_CONTROLLER_WORKFLOW_LOOP_STATUS_HISTORY_LIMIT'
