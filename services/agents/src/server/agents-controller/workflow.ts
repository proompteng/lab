...
import { parseBooleanEnv, parseNumberEnv, parseOptionalNumber, readAgentsEnv } from './env-config'

const PARAMETERS_MAX_ENTRIES = 100
const PARAMETERS_MAX_VALUE_BYTES = 2048
const FORBIDDEN_PARAMETER_KEYS = new Set(['prompt'])

const WORKFLOW_LOOPS_ENABLED_ENV = 'AGENTS_AGENTS_CONTROLLER_WORKFLOW_LOOPS_ENABLED'
const WORKFLOW_LOOP_MAX_ITERATIONS_ENV = 'AGENTS_AGENTS_CONTROLLER_WORKFLOW_LOOP_MAX_ITERATIONS'
const WORKFLOW_LOOP_STATUS_HISTORY_LIMIT_ENV = 'AGENTS_AGENTS_CONTROLLER_WORKFLOW_LOOP_STATUS_HISTORY_LIMIT'
...
export const isWorkflowLoopsEnabled = () => parseBooleanEnv(readAgentsEnv(WORKFLOW_LOOPS_ENABLED_ENV), false)

export const resolveWorkflowLoopMaxIterationsLimit = () =>
  parseNumberEnv(readAgentsEnv(WORKFLOW_LOOP_MAX_ITERATIONS_ENV), WORKFLOW_LOOP_MAX_ITERATIONS_DEFAULT, 1)

export const resolveWorkflowLoopStatusHistoryLimit = () =>
  parseNumberEnv(readAgentsEnv(WORKFLOW_LOOP_STATUS_HISTORY_LIMIT_ENV), WORKFLOW_LOOP_STATUS_HISTORY_LIMIT_DEFAULT, 1)
