...
const globalState = globalThis as typeof globalThis & {
  __agentsNativeKubeTlsCache?: Map<string, string>
}

const BUN_KUBE_TLS_CACHE_DIR = join(tmpdir(), 'agents-kube-tls')
...
const getBunTlsCache = () => {
  if (!globalState.__agentsNativeKubeTlsCache) {
    globalState.__agentsNativeKubeTlsCache = new Map<string, string>()
  }

  return globalState.__agentsNativeKubeTlsCache
}
