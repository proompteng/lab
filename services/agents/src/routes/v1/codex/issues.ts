...
import {
  getCodexIssuesHandler as getCodexIssuesApiHandler,
...
export const getCodexIssuesHandler = async (request: Request, deps: Partial<CodexRunsApiDependencies> = {}) => {
  ...
  return getCodexIssuesApiHandler(request, resolved.value)
}
