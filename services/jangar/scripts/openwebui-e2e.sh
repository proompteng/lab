...
export OPENWEBUI_IMAGE="${OPENWEBUI_IMAGE:-ghcr.io/open-webui/open-webui:v0.9.2}"
if [[ "$use_mock_codex" == "1" ]]; then
...
export JANGAR_MODELS="${JANGAR_MODELS:-gpt-5.6-sol}"
export JANGAR_DEFAULT_MODEL="${JANGAR_DEFAULT_MODEL:-gpt-5.6-sol}"
