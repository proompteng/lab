...
const CONTROL_PLANE_PRIMITIVES: PrimitiveDefinition[] = [
  {
    ...
    section: 'Resources',
    listPath: '/control-plane/agents',
    detailPath: '/control-plane/agents/$name',
  },
  {
    kind: 'AgentProvider',
    ...
    section: 'Resources',
    listPath: '/control-plane/agent-providers',
    detailPath: '/control-plane/agent-providers/$name',
  },
  {
    ...
    section: 'Resources',
    listPath: '/control-plane/implementation-specs',
    detailPath: '/control-plane/implementation-specs/$name',
  },
  {
    ...
    section: 'Resources',
    listPath: '/control-plane/implementation-sources',
    detailPath: '/control-plane/implementation-sources/$name',
  },
  {
    kind: 'Tool',
    title: 'Tools',
    ...
    section: 'Resources',
    listPath: '/control-plane/tools',
    detailPath: '/control-plane/tools/$name',
  },
  {
    kind: 'AgentRun',
    title: 'Agent runs',
  ...
  },
  {
    ...
    section: 'Runs',
    listPath: '/control-plane/tool-runs',
    detailPath: '/control-plane/tool-runs/$name',
  },
  {
    kind: 'ApprovalPolicy',
    title: 'Approvals',
    ...
    section: 'Policies',
    listPath: '/control-plane/approvals',
    detailPath: '/control-plane/approvals/$name',
  },
  {
    kind: 'Budget',
    title: 'Budgets',
    ...
    section: 'Policies',
    listPath: '/control-plane/budgets',
    detailPath: '/control-plane/budgets/$name',
  },
  {
    kind: 'SecretBinding',
    ...
    section: 'Policies',
    listPath: '/control-plane/secret-bindings',
    detailPath: '/control-plane/secret-bindings/$name',
  },
  {
    kind: 'Signal',
    title: 'Signals',
    ...
    section: 'Signals',
    listPath: '/control-plane/signals',
    detailPath: '/control-plane/signals/$name',
  },
  {
    kind: 'SignalDelivery',
    ...
    section: 'Signals',
    listPath: '/control-plane/signal-deliveries',
    detailPath: '/control-plane/signal-deliveries/$name',
  },
  {
    kind: 'Memory',
    title: 'Memories',
    ...
    section: 'Storage',
    listPath: '/control-plane/memories',
    detailPath: '/control-plane/memories/$name',
  },
  {
    kind: 'Artifact',
    title: 'Artifacts',
    ...
    section: 'Storage',
    listPath: '/control-plane/artifacts',
    detailPath: '/control-plane/artifacts/$name',
  },
  {
    kind: 'Workspace',
    title: 'Workspaces',
    ...
    section: 'Storage',
    listPath: '/control-plane/workspaces',
    detailPath: '/control-plane/workspaces/$name',
  },
  {
    kind: 'Orchestration',
    ...
    listPath: '/control-plane/orchestrations',
    detailPath: '/control-plane/orchestrations/$name',
  },
  {
    ...
    section: 'Orchestration',
    listPath: '/control-plane/orchestration-runs',
    detailPath: '/control-plane/orchestration-runs/$name',
  },
  {
    kind: 'Schedule',
    title: 'Schedules',
