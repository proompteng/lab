...
export const recoverIntradayAuthorityCycle = Effect.gen(function* () {
  ...
  yield* sql`
    ...
    BEGIN
      ...
      WHERE cycle.schema_version = 'bayn.autonomous-cycle.v3'
        ...
        AND repair_observed_at < cycle.submission_cutoff_at
      ...
      IF cardinality(repairable_cycle_ids) > 1 THEN
        RAISE EXCEPTION 'refusing to recover more than one intraday authority cycle' USING ERRCODE = '55000';
      END IF;
...
export default recoverIntradayAuthorityCycle
