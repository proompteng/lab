...
const emptyExecutionFunnel = (): CycleObservabilityProjectionRow['execution_funnel'] => ({
  ...
  latestOrderAt: null,
  latestFillAt: null,
  maximumIntentToSubmitLatencyMs: null,
  maximumOrderAcknowledgementLatencyMs: null,
  maximumOrderObservationLatencyMs: null,
  maximumIntentToBrokerFillLatencyMs: null,
  maximumFillIngestionLatencyMs: null,
  latencyClockRegressionCount: 0,
  ...
  test('projects the current cycle opportunity-to-fill funnel and broker exposure', () => {
    const row: CycleObservabilityProjectionRow = {
      ...
      execution_funnel: {
        ...
        positionSnapshotObservedAt: '2026-07-27T13:35:08.000Z',
        positionCount: 2,
