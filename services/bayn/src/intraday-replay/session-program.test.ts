...
test('session preparation rejects changed strategy, partial hours, unknown calendar and future as-of metadata', () => {
  ...
  for (const invalid of [
    ...
    { ...input, source: { ...input.source, firstAvailableAtMs: Date.parse('2026-09-04T14:30:00Z') } },
    { ...input, source: { ...input.source, lastAvailableAtMs: Date.parse('2026-09-04T19:00:00Z') } },
    { ...input, calendar: [] },
