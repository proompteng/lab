...
from .part_03_single_strategy_qty import *
...
class _DecisionEngineMethodsPart2:
...
class DecisionEngine(
    _DecisionEngineFieldsPart1,
    _DecisionEngineMethodsPart1,
    _DecisionEngineMethodsPart2,
    object,
):
    pass
