...
__compat_module__ = __compat_import_module__(f"{__name__}.part_01_empty_meta")
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_02_evaluate_microbar_cross_sectional"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(f"{__name__}.part_03_coerce_plugin_result")
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
    __compat_loaded_module__.__dict__.update(
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_04_breakoutcontinuationlongplugin"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_05_latedaycontinuationlongplugin"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
