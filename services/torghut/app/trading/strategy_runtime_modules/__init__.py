...
__compat_module__ = __compat_import_module__(f"{__name__}.empty_meta")
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.evaluate_microbar_cross_sectional"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
...
__compat_module__ = __compat_import_module__(f"{__name__}.coerce_plugin_result")
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
    __compat_loaded_module__.__dict__.update(
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.breakout_continuation_long_plugin"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.late_day_continuation_long_plugin"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
