...
from app.trading.discovery.fast_replay_modules.extract_price import (
...
from app.trading.discovery.fast_replay_modules.frontier_selection_blockers_for_row import (
    candidate_direction as _candidate_direction,
    candidate_symbols as _candidate_symbols,
)
from app.trading.discovery.fast_replay_modules.preview_rank_key import (
