...
__compat_source__ = "".join([_SOURCE_01, _SOURCE_02, _SOURCE_03, _SOURCE_04])
__compat_exec_globals__ = globals()
__compat_exec_globals__["__package__"] = "app.trading"
exec(
    compile(__compat_source__, "app/trading/research_sleeves.py", "exec"),
