...
__compat_module__ = __compat_import_module__(f"{__name__}.part_01_statements_22")
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_02_extract_stage_renewal_bonds"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_03_runtime_ledger_row_rank"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_04_compile_hypothesis_runtime_statuses"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
