...
def normalize_reason_metric(*args: Any, **kwargs: Any) -> Any: ...
def split_reason_codes(*args: Any, **kwargs: Any) -> Any: ...
def optional_decimal(*args: Any, **kwargs: Any) -> Any: ...

RuntimeUncertaintyGateAction: TypeAlias = Literal["pass", "degrade", "abstain", "fail"]
