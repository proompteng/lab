...
class _ClickHouseSignalIngestorMethodsPart3:
...
class ClickHouseSignalIngestor(
    _ClickHouseSignalIngestorFieldsPart1,
    _ClickHouseSignalIngestorMethodsPart1,
    _ClickHouseSignalIngestorMethodsPart2,
    _ClickHouseSignalIngestorMethodsPart3,
    object,
):
    pass
