...
__compat_module__ = __compat_import_module__(
    f"{__name__}.clickhouse_signal_ingestor_core_methods"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.clickhouse_signal_ingestor_market_methods"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.clickhouse_signal_ingestor_persistence_methods"
)
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
...
__compat_module__ = __compat_import_module__(f"{__name__}.attach_simulation_context")
__compat_module_segments__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_module_segments__:
    __compat_loaded_module__.__dict__.update(
