...
def evaluate_momentum_pullback_long(
    *,
    ...
    max_pullback_bps = _decimal_param(
        params, "max_price_below_ema12_bps", Decimal("18")
    )
...
def evaluate_breakout_continuation_long(
    *,
    ...
    min_price_vs_opening_range_high_bps = _decimal_param(
        ...
        _decimal_param(
            params, "min_price_above_opening_range_high_bps", Decimal("-12")
        ),
    )
    ...
    min_opening_range_width_bps = _optional_decimal_param(
    ...
    min_imbalance_pressure = _decimal_param(
    ...
    ema_extension_cap_bps = _scaled_extension_cap(
        ...
        multiplier=_optional_decimal_param(
    ...
    effective_bullish_hist_min = _decimal_param(
        params, "bullish_hist_min", Decimal("0.008")
    )
    if leader_reclaim_confirmed:
        effective_bullish_hist_min -= _optional_decimal_param(
            params,
    ...
    classical_breakout_shape_passes = (
        ...
        and _optional_min_threshold(
            opening_range_width_bps, min_opening_range_width_bps
        )
    ...
    breakout_failure_confirmed = (
        ...
        or (
            ...
            <= _decimal_param(params, "exit_session_open_drive_bps", Decimal("18"))
        )
    ...
    session_strength_reversal_confirmed = (
        ...
        <= _decimal_param(
            params, "exit_recent_imbalance_pressure_max", Decimal("-0.03")
        )
        and (
            (
                price_vs_opening_range_high_bps is not None
...
def evaluate_mean_reversion_rebound_long(
    *,
    ...
    max_session_open_drive_bps = _optional_decimal_param(
        params, "max_price_vs_session_open_bps", Decimal("-20")
    )
    max_session_range_position = _optional_decimal_param(
        params, "max_session_range_position", Decimal("0.32")
    )
    min_session_range_bps = _optional_decimal_param(
        ...
        _gate(
            ...
            thresholds=(
                *_threshold_range(
                    ...
                    ceil=_decimal_param(
                        params, "max_price_below_vwap_bps", Decimal("70")
                    ),
                    required=True,
                ),
                *_threshold_range(
                    ...
                    floor=_decimal_param(
                        params, "min_price_below_ema12_bps", Decimal("2")
                    ),
                    ceil=_decimal_param(
                        params, "max_price_below_ema12_bps", Decimal("35")
                    ),
                    required=True,
                ),
                *_threshold_range(
            ...
            thresholds=(
                ...
                *_threshold_range(
                    ...
                    ceil=_optional_decimal_param(
                        params, "vol_ceil", Decimal("0.00055")
                    ),
                    required=False,
                ),
            ),
    ...
    if all(gate.passed for gate in buy_gates):
        ...
        if (
            price_position_in_session_range is not None
            and price_position_in_session_range <= Decimal("0.18")
        ):
            confidence += Decimal("0.02")
        if (
            recent_imbalance_pressure_avg is not None
    ...
    exit_reasons: dict[str, bool] = {
        ...
        "macd_rollover": macd_hist
        <= _decimal_param(params, "exit_macd_hist_max", Decimal("-0.002")),
        "imbalance_reversal": (
            recent_imbalance_pressure_avg is not None
            and recent_imbalance_pressure_avg
            <= _decimal_param(
        ...
        "range_recovery": (
            ...
            and price_position_in_session_range
            >= _decimal_param(
                params, "exit_session_range_position_min", Decimal("0.58")
            )
        ),
    }
...
def evaluate_mean_reversion_exhaustion_short(
    *,
    ...
    if all(gate.passed for gate in sell_gates):
        ...
        if rank_feature:
            universe_size = max(
                2,
                int(
                    _optional_decimal_param(params, "universe_size", Decimal("2"))
                    or Decimal("2")
                ),
            )
            top_n = max(
                1,
                int(
                    _optional_decimal_param(params, "top_n", Decimal("1"))
                    or Decimal("1")
                ),
            )
            selection_mode = (
    ...
    exit_reasons: dict[str, bool] = {
        ...
        >= _decimal_param(params, "exit_macd_hist_min", Decimal("0.003")),
        "imbalance_reversal": (
            recent_imbalance_pressure_avg is not None
            and recent_imbalance_pressure_avg
            >= _decimal_param(
                params, "exit_recent_imbalance_pressure_min", Decimal("0.03")
            )
        ),
        "range_reversion": (
            price_position_in_session_range is not None
            and price_position_in_session_range
            <= _decimal_param(
                params, "exit_session_range_position_max", Decimal("0.44")
            )
        ),
    }
    exit_gate = _exit_trigger_gate(reason_flags=exit_reasons)
...
def evaluate_washout_rebound_long(
    *,
    ...
    max_session_open_selloff_bps = _decimal_param(
        params, "max_session_open_selloff_bps", Decimal("120")
    )
    max_price_below_vwap_bps = _decimal_param(
        ...
        _gate(
            ...
            thresholds=(
                ...
                *_threshold_range(
                    ...
                    ceil=_optional_decimal_param(
                        params, "vol_ceil", Decimal("0.00075")
                    ),
                    required=False,
                ),
            ),
    ...
    macd_rollover = macd_hist <= _decimal_param(
...
def evaluate_late_day_continuation_long(
    *,
    ...
    same_day_opening_window_confirmed = _required_min_threshold(
        opening_window_return_bps,
        min_same_day_opening_window_return_bps,
    ) and _required_min_threshold(
        cross_section_positive_opening_window_return_ratio,
        ...
        _gate(
            ...
            thresholds=(
                ...
                *_threshold_range(
                    ...
                    ceil=_optional_decimal_param(
                        params, "vol_ceil", Decimal("0.00035")
                    ),
                    required=False,
                ),
            ),
...
def evaluate_end_of_day_reversal_long(
    *,
        ...
        _gate(
            ...
            thresholds=(
                ...
                *_threshold_range(
                    ...
                    ceil=_optional_decimal_param(
                        params, "vol_ceil", Decimal("0.00050")
                    ),
                    required=False,
                ),
            ),
    ...
    exit_reasons: dict[str, bool] = {
        "vwap_recovered": (vwap_session is not None and price >= vwap_session)
        or price >= ema12,
        "rsi_recovered": rsi14 >= _decimal_param(params, "exit_rsi_min", Decimal("56")),
        "imbalance_reversal": (
            recent_imbalance_pressure_avg is not None
...
def _effective_entry_end_minute(
    ...
    *,
    ...
    flatten_start_minute = _optional_minute_param(
...
def _resolve_entry_notional_multiplier(
    *,
    ...
    rank_ceil = _optional_decimal_param(
