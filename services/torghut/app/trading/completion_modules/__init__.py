...
__compat_module__ = __compat_import_module__(f"{__name__}.part_01_runtime_matrix_path")
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_02_runtime_ledger_bucket_existing_blockers"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(f"{__name__}.part_03_effective_row_status")
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
    __compat_loaded_module__.__dict__.update(
