...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--start-date",
        required=True,
        help="Inclusive UTC trading-day start in YYYY-MM-DD format.",
    )
    parser.add_argument(
        "--end-date",
        required=True,
        help="Inclusive UTC trading-day end in YYYY-MM-DD format.",
    )
    parser.add_argument(
        "--digest",
        required=True,
    ...
    parser.add_argument(
        "--output-dir",
        required=True,
        help="Directory where manifests should be written.",
    )
    parser.add_argument(
        "--cache-policy",
        default="refresh",
        help="Replay cache policy for each generated manifest.",
    )
    ...
    parser.add_argument(
        "--strategy-spec-ref", default="strategy-specs/intraday_tsmom_v1@1.1.0.json"
    )
