        ...
        rows.append(
            "\t".join(
                [
                    ...
                    _sanitize_tsv_field(item.get("raw_objective_met", "")),
                    _sanitize_tsv_field(item.get("objective_met", "")),
                    _sanitize_tsv_field(item.get("terminal_validation_status", "")),
                    _sanitize_tsv_field(item.get("terminal_validation_reason", "")),
                    _sanitize_tsv_field(item.get("search_action", "")),
                    _sanitize_tsv_field(item.get("search_reason", "")),
