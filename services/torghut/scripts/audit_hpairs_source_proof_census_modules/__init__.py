...
__compat_module__ = __compat_import_module__(f"{__name__}.part_01_statements_73")
...
__compat_module__ = __compat_import_module__(
    f"{__name__}.part_02_source_event_row_matches_identity"
)
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
...
__compat_module__ = __compat_import_module__(f"{__name__}.part_03_totals")
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
    __compat_loaded_module__.__dict__.update(
...
__compat_module__ = __compat_import_module__(f"{__name__}.part_04_blocker_ladder")
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
    __compat_loaded_module__.__dict__.update(
...
__compat_module__ = __compat_import_module__(f"{__name__}.part_05_parse_timestamp")
__compat_part_modules__.append(__compat_module__)
__compat_export__(__compat_module__)
for __compat_loaded_module__ in __compat_part_modules__:
    __compat_loaded_module__.__dict__.update(
