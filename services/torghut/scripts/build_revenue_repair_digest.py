...
_REPAIR_CATALOG: dict[str, dict[str, object]] = {
    "alpha_readiness_not_promotion_eligible": {
        "code": "repair_alpha_readiness",
        "dimension": "alpha_readiness",
        "action": "clear_hypothesis_blockers_before_capital",
        "priority": 70,
        "expected_unblock_value": 6,
    },
    "execution_tca_stale": {
    ...
    "execution_tca_missing": {
        "code": "repair_execution_tca",
        "dimension": "execution_tca",
        "action": "restore_execution_tca_settlement",
        "priority": 68,
        "expected_unblock_value": 4,
    },
    "execution_tca_slippage_guardrail_exceeded": {
        "code": "repair_execution_quality",
        "dimension": "execution_tca",
        "action": "reduce_execution_slippage_before_promotion",
        "priority": 75,
        "expected_unblock_value": 5,
    },
    ...
    "quant_health_degraded": {
        "code": "repair_quant_ingestion",
        "dimension": "quant_ingestion",
        "action": "restore_quant_health_receipts",
        "priority": 58,
        "expected_unblock_value": 2,
    },
    "quant_health_fetch_failed": {
        "code": "repair_quant_ingestion",
        "dimension": "quant_ingestion",
        "action": "restore_quant_health_route",
        "priority": 58,
        "expected_unblock_value": 2,
    },
    "quant_latest_metrics_empty": {
        "code": "repair_quant_ingestion",
        "dimension": "quant_ingestion",
        "action": "backfill_quant_latest_metrics",
        "priority": 57,
        "expected_unblock_value": 2,
    },
    ...
    "insufficient_buying_power": {
        "code": "repair_buying_power",
        "dimension": "capital_account",
        "action": "settle_account_buying_power_or_downsize_orders",
        "priority": 55,
        "expected_unblock_value": 2,
    },
}
...
def _repair_from_reason(
    ...
    *,
    ...
    catalog = _REPAIR_CATALOG.get(reason, {})
