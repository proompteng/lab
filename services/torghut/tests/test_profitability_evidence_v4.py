...
class TestProfitabilityEvidenceV4(TestCase):
    ...
    def test_fill_price_error_budget_report_emits_calibrated_contract_when_within_budget(
        self,
    ) -> None:
    ...
    def test_fill_price_error_budget_report_stays_pending_when_metrics_missing(
        self,
    ) -> None:
        report = build_fill_price_error_budget_report_v1(
            run_id="run-5",
