...
class TestHypothesisReadiness(TestCase):
    ...
    def test_default_hypothesis_registry_self_governs_without_jangar_quorum(self) -> None:
    ...
    def test_hypothesis_registry_dependency_check_rejects_blank_capability(self) -> None:
        registry = load_hypothesis_registry()
