...
class TestAutonomyRuntime(TestCase):
    def test_runtime_deterministic_ordering(self) -> None:
        ...
        self.assertEqual(
            [d.strategy_id for d in first.decisions], ["a-strategy", "b-strategy"]
        )
        self.assertEqual(
    ...
    def test_runtime_isolates_plugin_errors(self) -> None:
        ...
        self.assertTrue(
            any(
                error.startswith("plugin_not_found:missing_plugin@9.9.9")
