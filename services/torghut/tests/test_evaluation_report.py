...
class TestEvaluationReport(TestCase):
    def test_report_generation_from_fixture(self) -> None:
        ...
        report = generate_evaluation_report(
            results, config=config, gate_policy=EvaluationGatePolicy()
        )
        ...
        self.assertIn(
            "impact_bps_at_full_participation", report.impact_assumptions.assumptions
        )
        self.assertEqual(
            report.impact_assumptions.assumptions["impact_participation_exponent"],
            "0.5",
        )
    ...
    def test_report_prefers_recorded_impact_inputs_when_present(self) -> None:
        ...
        self.assertEqual(
            report.impact_assumptions.assumptions["recorded_inputs_count"], "2"
        )
    ...
    def test_score_replay_profitability_candidate_penalizes_constraint_failures(
        self,
    ) -> None:
    ...
    def test_score_replay_profitability_candidate_penalizes_missing_profit_factor_and_decisions(
        self,
    ) -> None:
        candidate = score_replay_profitability_candidate(
            family="breakout_continuation",
    ...
    def test_score_replay_profitability_candidate_penalizes_drawdown_and_low_profit_factor(
        self,
    ) -> None:
        candidate = score_replay_profitability_candidate(
            family="breakout_continuation",
