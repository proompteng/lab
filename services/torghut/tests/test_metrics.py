...
class TestTradingMetrics(TestCase):
    ...
    def test_lean_strategy_shadow_metric_is_exported(self) -> None:
        metrics = TradingMetrics()
    ...
    def test_uncertainty_metrics_are_exported(self) -> None:
        ...
        metrics.runtime_regime_gate_action_total["abstain"] = 2
        ...
        self.assertIn(
            'torghut_trading_runtime_regime_gate_action_total{action="abstain"} 2',
            payload,
        )
        self.assertIn(
            'torghut_trading_runtime_regime_gate_blocked_total{action="abstain"} 1',
            payload,
        )
        self.assertIn(
