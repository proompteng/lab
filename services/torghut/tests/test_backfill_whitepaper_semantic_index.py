...
class _RaisingWorkflow(_FakeWorkflow):
    def __init__(
        self, *, raise_full_text: bool = False, raise_synthesis: bool = False
    ) -> None:
        super().__init__()
...
class TestBackfillWhitepaperSemanticIndex(TestCase):
    def setUp(self) -> None:
        ...
        with Session(self.engine) as session:
            ...
            synthesis = WhitepaperSynthesis(
                ...
                synthesis_json={
                    "claims": [{"claim_id": "claim-1", "claim_text": "edge"}]
                },
            )
    ...
    def test_process_run_syncs_claim_graph_when_requested(self) -> None:
        ...
        with (
            ...
            patch(
                "scripts.backfill_whitepaper_semantic_index.WhitepaperWorkflowService",
    ...
    def test_process_run_returns_partial_when_one_indexer_fails(self) -> None:
        ...
        with Session(self.engine) as session:
            ...
            run.orchestration_context_json = {
    ...
    def test_process_run_raises_when_all_indexers_fail(self) -> None:
        ...
        with (
            ...
            with self.assertRaisesRegex(
                RuntimeError,
                "full_text_index:full-text-failed;synthesis_index:synthesis-failed",
            ):
