...
EXPLICIT_IMPORT_SURFACES = (
    ...
    "app.trading.autonomy.lane_candidate_payloads",
    "app.trading.autonomy.lane_common",
    "app.trading.autonomy.lane_phase_payloads",
    "app.trading.autonomy.lane_profitability_manifest",
    "app.trading.autonomy.lane_regime_artifacts",
    "app.trading.autonomy.lane_stage_artifacts",
    "app.trading.autonomy.lane_strategy_factory",
    "app.trading.autonomy.policy_check",
    "app.trading.completion",
    "app.trading.decisions",
    "app.trading.discovery.autoresearch",
    "app.trading.discovery.candidate_spec_base_profiles_primary",
    "app.trading.discovery.candidate_spec_base_profiles_secondary",
    "app.trading.discovery.candidate_spec_common",
    "app.trading.discovery.candidate_spec_execution_research_overlays",
    "app.trading.discovery.candidate_spec_family_selection",
    "app.trading.discovery.candidate_spec_feedback_profiles",
    "app.trading.discovery.candidate_spec_hpairs_profiles",
    "app.trading.discovery.candidate_spec_hypothesis_policy",
    "app.trading.discovery.candidate_spec_mechanism_overlay_state",
    "app.trading.discovery.candidate_spec_mechanism_overlays",
    "app.trading.discovery.candidate_spec_microstructure_overlays",
    "app.trading.discovery.candidate_spec_portfolio_profiles_primary",
    "app.trading.discovery.candidate_spec_portfolio_profiles_secondary",
    "app.trading.discovery.candidate_spec_profile_constants",
    "app.trading.discovery.candidate_spec_profile_variants",
    "app.trading.discovery.candidate_spec_profiles",
    "app.trading.discovery.candidate_spec_replay_validation_overlays",
    "app.trading.discovery.candidate_spec_stat_arb_impact_overlays",
