...
class TestDecisionEngine(TestCase):
        ...
        strategy = Strategy(
            ...
            description=_compose_strategy_description(
                StrategyConfig(
                    ...
                    params={
                        "min_price_above_vwap_bps": "0",
                        "max_price_above_vwap_bps": "100",
                        "min_price_above_ema12_bps": "0",
                        "max_price_above_ema12_bps": "100",
                        "min_bear_rsi": "50",
                        "max_bear_rsi": "70",
                        "min_price_vs_session_open_bps": "0",
                        "min_opening_window_return_bps": "0",
                        ...
                        "max_recent_quote_invalid_ratio": "1",
                        "max_recent_quote_jump_bps": "1000",
                    },
                )
            ),
            enabled=True,
    ...
    def test_scheduler_runtime_mean_reversion_exhaustion_short_caps_exit_only_buy_to_short_inventory(
        ...
        strategy = Strategy(
            ...
            universe_type="mean_reversion_exhaustion_short_v1",
            universe_symbols=["META"],
            max_position_pct_equity=Decimal("0.01"),
            max_notional_per_trade=Decimal("100"),
        )
        signal = SignalEnvelope(
            event_ts=datetime(2026, 3, 24, 17, 26, 12, tzinfo=timezone.utc),
        ...
        self.assertEqual(len(decisions), 1)
        self.assertEqual(decisions[0].action, "buy")
        self.assertEqual(decisions[0].qty, Decimal("1.2500"))

    def test_scheduler_runtime_mean_reversion_exhaustion_short_buy_respects_min_hold(
        self,
    ) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
            id=uuid.uuid4(),
            name="mean-reversion-exhaustion-short-min-hold",
            description=_compose_strategy_description(
                StrategyConfig(
                    name="mean-reversion-exhaustion-short-min-hold",
                    strategy_id="mean_reversion_exhaustion_short_v1@research",
                ...
                positions=[
                    {
                        ...
                        "market_value": "-744.75",
                        "avg_entry_price": "598.00",
                        "opened_at": "2026-03-24T17:25:30+00:00",
                    }
                ],
            )
    ...
    def test_scheduler_runtime_mean_reversion_exhaustion_short_buy_requires_positive_profit(
        self,
    ) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
            id=uuid.uuid4(),
            name="mean-reversion-exhaustion-short-profit-gate",
            description=_compose_strategy_description(
                StrategyConfig(
                    name="mean-reversion-exhaustion-short-profit-gate",
                    strategy_id="mean_reversion_exhaustion_short_v1@research",
                ...
                positions=[
                    {
                        ...
                        "opened_at": "2026-03-24T17:22:00+00:00",
                    }
                ],
            )
    ...
    def test_scheduler_runtime_mean_reversion_exhaustion_short_opens_short_sell_when_flat(
        self,
    ) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
        ...
        self.assertEqual(len(decisions), 1)
        self.assertEqual(decisions[0].action, "sell")
        self.assertGreater(decisions[0].qty, Decimal("0"))

    def test_scheduler_runtime_microbar_cross_sectional_long_opens_buy_when_flat(self) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
            id=uuid.uuid4(),
            name="adaptive-open-reversal-long",
            description=_compose_strategy_description(
                StrategyConfig(
                    name="adaptive-open-reversal-long",
                    strategy_id="adaptive_open_reversal_long_v1@research",
        ...
        signal = SignalEnvelope(
            event_ts=datetime(2026, 3, 24, 14, 15, 5, tzinfo=timezone.utc),
            symbol="SHOP",
            timeframe="1Sec",
            seq=401,
            payload={
                ...
                "cross_section_session_open_rank": 0.00,
                "cross_section_vwap_w5m_rank": 0.42,
            },
        )
    ...
    def test_scheduler_runtime_microbar_cross_sectional_long_skips_exit_only_sell_without_long_inventory(
        self,
    ) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
        ...
        signal = SignalEnvelope(
            event_ts=datetime(2026, 3, 24, 15, 0, 5, tzinfo=timezone.utc),
            symbol="SHOP",
            timeframe="1Sec",
            seq=402,
            payload={
                ...
                "cross_section_continuation_breadth": 0.40,
                "cross_section_session_open_rank": 0.52,
                "cross_section_vwap_w5m_rank": 0.61,
            },
        )
    ...
    def test_scheduler_runtime_microbar_cross_sectional_short_opens_sell_when_flat(self) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
            id=uuid.uuid4(),
            name="adaptive-close-continuation-short",
            description=_compose_strategy_description(
                StrategyConfig(
                    name="adaptive-close-continuation-short",
                    strategy_id="adaptive_close_continuation_short_v1@research",
                    strategy_type="microbar_cross_sectional_short_v1",
                    version="1.0.0",
                    base_timeframe="1Sec",
                    universe_type="microbar_cross_sectional_short_v1",
                    universe_symbols=["AAPL", "AMAT", "AMD", "AVGO", "GOOG", "INTC", "META", "MSFT", "MU", "NVDA", "PLTR", "SHOP"],
                    max_position_pct_equity=Decimal("1.0"),
                    max_notional_per_trade=Decimal("32500"),
                    params={
        ...
        signal = SignalEnvelope(
            event_ts=datetime(2026, 3, 24, 14, 30, 5, tzinfo=timezone.utc),
            symbol="META",
            timeframe="1Sec",
            seq=403,
            payload={
                ...
                "cross_section_continuation_breadth": 0.10,
                "cross_section_session_open_rank": 0.55,
                "cross_section_vwap_w5m_rank": 0.05,
            },
        )
    ...
    def test_scheduler_runtime_microbar_cross_sectional_short_skips_exit_only_buy_without_short_inventory(
        self,
    ) -> None:
        engine = DecisionEngine(price_fetcher=None)
        strategy = Strategy(
        ...
        signal = SignalEnvelope(
            event_ts=datetime(2026, 3, 24, 20, 0, 5, tzinfo=timezone.utc),
            symbol="META",
            timeframe="1Sec",
            seq=404,
            payload={
                ...
                "cross_section_continuation_breadth": 0.08,
                "cross_section_session_open_rank": 0.45,
                "cross_section_vwap_w5m_rank": 0.12,
            },
        )
