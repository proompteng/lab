...
def upgrade() -> None:
    op.add_column(
        ...
        sa.Column("expected_shortfall_bps_p50", sa.Numeric(20, 8), nullable=True),
    )
    op.add_column(
        "execution_tca_metrics",
        sa.Column("expected_shortfall_bps_p95", sa.Numeric(20, 8), nullable=True),
    )
    op.add_column(
        "execution_tca_metrics",
    ...
    op.add_column(
        "execution_tca_metrics",
        sa.Column("divergence_bps", sa.Numeric(20, 8), nullable=True),
    )
    op.add_column(
        "execution_tca_metrics",
