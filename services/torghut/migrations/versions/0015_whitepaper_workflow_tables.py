...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "authors_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.UniqueConstraint(
            "document_key", name="uq_whitepaper_documents_document_key"
        ),
    )
    op.create_index(
        "ix_whitepaper_documents_status", "whitepaper_documents", ["status"]
    )
    op.create_index(
        "ix_whitepaper_documents_source", "whitepaper_documents", ["source"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_whitepaper_document_versions_document_id",
        "whitepaper_document_versions",
        ["document_id"],
    )
    op.create_index(
        "ix_whitepaper_document_versions_parse_status",
        "whitepaper_document_versions",
        ["parse_status"],
    )
    op.create_index(
        "ix_whitepaper_document_versions_checksum",
        "whitepaper_document_versions",
        ["checksum_sha256"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=32),
            nullable=False,
            server_default=sa.text("'pdf_extract'"),
        ),
        sa.Column("full_text", sa.Text(), nullable=False),
        sa.Column("full_text_sha256", sa.String(length=64), nullable=False),
        sa.Column(
            "section_index_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "references_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "tables_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "figures_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "chunk_manifest_json",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.UniqueConstraint(
            "document_version_id", name="uq_whitepaper_contents_document_version_id"
        ),
    )
    op.create_index(
        "ix_whitepaper_contents_full_text_sha256",
        "whitepaper_contents",
        ["full_text_sha256"],
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "inngest_run_id", name="uq_whitepaper_analysis_runs_inngest_run_id"
        ),
    )
    op.create_index(
        "ix_whitepaper_analysis_runs_status", "whitepaper_analysis_runs", ["status"]
    )
    op.create_index(
        "ix_whitepaper_analysis_runs_document_id",
        "whitepaper_analysis_runs",
        ["document_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_whitepaper_analysis_runs_inngest_event_id",
        "whitepaper_analysis_runs",
        ["inngest_event_id"],
    )
    op.create_index(
        "ix_whitepaper_analysis_runs_created_at",
        "whitepaper_analysis_runs",
        ["created_at"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "step_order", sa.BigInteger(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "attempt", sa.BigInteger(), nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
            "status",
            sa.String(length=32),
    ...
    op.create_index(
        "ix_whitepaper_analysis_steps_run_id",
        "whitepaper_analysis_steps",
        ["analysis_run_id"],
    )
    op.create_index(
        "ix_whitepaper_analysis_steps_step_name",
        "whitepaper_analysis_steps",
        ["step_name"],
    )
    op.create_index(
        "ix_whitepaper_analysis_steps_status", "whitepaper_analysis_steps", ["status"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "input_context_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "output_context_json",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.UniqueConstraint(
            "agentrun_name", name="uq_whitepaper_codex_agentruns_agentrun_name"
        ),
    )
    op.create_index(
        "ix_whitepaper_codex_agentruns_run_id",
        "whitepaper_codex_agentruns",
        ["analysis_run_id"],
    )
    op.create_index(
        "ix_whitepaper_codex_agentruns_status", "whitepaper_codex_agentruns", ["status"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "key_findings_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "novelty_claims_json",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "synthesis_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.UniqueConstraint(
            "analysis_run_id", name="uq_whitepaper_syntheses_analysis_run_id"
        ),
    )
    op.create_index(
        "ix_whitepaper_syntheses_generated_by", "whitepaper_syntheses", ["generated_by"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "gating_json", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.UniqueConstraint(
            "analysis_run_id", name="uq_whitepaper_viability_verdicts_analysis_run_id"
        ),
    )
    op.create_index(
        "ix_whitepaper_viability_verdicts_verdict",
        "whitepaper_viability_verdicts",
        ["verdict"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "is_merged", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
    ...
    op.create_index(
        "ix_whitepaper_design_pull_requests_status",
        "whitepaper_design_pull_requests",
        ["status"],
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "design_pull_request_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
        sa.Column(
            "artifact_scope",
            sa.String(length=32),
    ...
    op.create_index(
        "ix_whitepaper_artifacts_artifact_type",
        "whitepaper_artifacts",
        ["artifact_type"],
    )
    op.create_index(
        "ix_whitepaper_artifacts_analysis_run_id",
        "whitepaper_artifacts",
        ["analysis_run_id"],
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index(
        "uq_whitepaper_artifacts_ceph_object", table_name="whitepaper_artifacts"
    )
    op.drop_index(
        "ix_whitepaper_artifacts_document_version_id", table_name="whitepaper_artifacts"
    )
    op.drop_index(
        "ix_whitepaper_artifacts_analysis_run_id", table_name="whitepaper_artifacts"
    )
    op.drop_index(
        "ix_whitepaper_artifacts_artifact_type", table_name="whitepaper_artifacts"
    )
    op.drop_table("whitepaper_artifacts")

    op.drop_index(
        "uq_whitepaper_design_pull_requests_run_attempt",
        table_name="whitepaper_design_pull_requests",
    )
    op.drop_index(
        "ix_whitepaper_design_pull_requests_merged",
        table_name="whitepaper_design_pull_requests",
    ...
    op.drop_index(
        "ix_whitepaper_syntheses_generated_by", table_name="whitepaper_syntheses"
    )
    op.drop_table("whitepaper_syntheses")

    op.drop_index(
        "ix_whitepaper_codex_agentruns_head_branch",
        table_name="whitepaper_codex_agentruns",
    )
    op.drop_index(
        "ix_whitepaper_codex_agentruns_codex_session_id",
        table_name="whitepaper_codex_agentruns",
    ...
    op.drop_index(
        "ix_whitepaper_codex_agentruns_status", table_name="whitepaper_codex_agentruns"
    )
    op.drop_index(
        "ix_whitepaper_codex_agentruns_run_id", table_name="whitepaper_codex_agentruns"
    )
    op.drop_table("whitepaper_codex_agentruns")

    op.drop_index(
        "uq_whitepaper_analysis_steps_run_step_attempt",
        table_name="whitepaper_analysis_steps",
    )
    op.drop_index(
        "ix_whitepaper_analysis_steps_status", table_name="whitepaper_analysis_steps"
    )
    op.drop_index(
        "ix_whitepaper_analysis_steps_step_name", table_name="whitepaper_analysis_steps"
    )
    op.drop_index(
        "ix_whitepaper_analysis_steps_run_id", table_name="whitepaper_analysis_steps"
    )
    op.drop_table("whitepaper_analysis_steps")

    op.drop_index(
        "ix_whitepaper_analysis_runs_created_at", table_name="whitepaper_analysis_runs"
    )
    op.drop_index(
        "ix_whitepaper_analysis_runs_inngest_event_id",
        table_name="whitepaper_analysis_runs",
    )
    op.drop_index(
        "ix_whitepaper_analysis_runs_document_version_id",
        table_name="whitepaper_analysis_runs",
    ...
    op.drop_index(
        "ix_whitepaper_analysis_runs_document_id", table_name="whitepaper_analysis_runs"
    )
    op.drop_index(
        "ix_whitepaper_analysis_runs_status", table_name="whitepaper_analysis_runs"
    )
    op.drop_table("whitepaper_analysis_runs")

    op.drop_index(
        "ix_whitepaper_contents_full_text_sha256", table_name="whitepaper_contents"
    )
    op.drop_table("whitepaper_contents")

    op.drop_index(
        "uq_whitepaper_document_versions_ceph_object",
        table_name="whitepaper_document_versions",
    )
    op.drop_index(
        "uq_whitepaper_document_versions_document_version",
        table_name="whitepaper_document_versions",
    ...
    op.drop_index(
        "uq_whitepaper_documents_source_identifier", table_name="whitepaper_documents"
    )
