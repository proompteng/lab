...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name='fk_whitepaper_document_versions_document_id_whitepaper_documents',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name='fk_whitepaper_contents_document_version_id_whitepaper_document_versions',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['document_id'],
            ['whitepaper_documents.id'],
            name='fk_whitepaper_analysis_runs_document_id_whitepaper_documents',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['document_version_id'],
            ['whitepaper_document_versions.id'],
            name='fk_whitepaper_analysis_runs_document_version_id_whitepaper_document_versions',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name='fk_whitepaper_analysis_steps_analysis_run_id_whitepaper_analysis_runs',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['analysis_run_id'],
            ['whitepaper_analysis_runs.id'],
            name='fk_whitepaper_codex_agentruns_analysis_run_id_whitepaper_analysis_runs',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['analysis_step_id'],
            ['whitepaper_analysis_steps.id'],
            name='fk_whitepaper_codex_agentruns_analysis_step_id_whitepaper_analysis_steps',
            ondelete='SET NULL',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['analysis_run_id'],
            ['whitepaper_analysis_runs.id'],
            name='fk_whitepaper_syntheses_analysis_run_id_whitepaper_analysis_runs',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['analysis_run_id'],
            ['whitepaper_analysis_runs.id'],
            name='fk_whitepaper_viability_verdicts_analysis_run_id_whitepaper_analysis_runs',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['analysis_run_id'],
            ['whitepaper_analysis_runs.id'],
            name='fk_whitepaper_design_pull_requests_analysis_run_id_whitepaper_analysis_runs',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['codex_agentrun_id'],
            ['whitepaper_codex_agentruns.id'],
            name='fk_whitepaper_design_pull_requests_codex_agentrun_id_whitepaper_codex_agentruns',
            ondelete='SET NULL',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['analysis_run_id'],
            ['whitepaper_analysis_runs.id'],
            name='fk_whitepaper_artifacts_analysis_run_id_whitepaper_analysis_runs',
            ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['design_pull_request_id'],
            ['whitepaper_design_pull_requests.id'],
            name='fk_whitepaper_artifacts_design_pull_request_id_whitepaper_design_pull_requests',
            ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['document_id'],
            ['whitepaper_documents.id'],
            name='fk_whitepaper_artifacts_document_id_whitepaper_documents',
            ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['document_version_id'],
            ['whitepaper_document_versions.id'],
            name='fk_whitepaper_artifacts_document_version_id_whitepaper_document_versions',
            ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['synthesis_id'],
            ['whitepaper_syntheses.id'],
            name='fk_whitepaper_artifacts_synthesis_id_whitepaper_syntheses',
            ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['viability_verdict_id'],
            ['whitepaper_viability_verdicts.id'],
            name='fk_whitepaper_artifacts_viability_verdict_id_whitepaper_viability_verdicts',
            ondelete='SET NULL',
        ),
