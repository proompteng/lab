...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_vnext_dataset_snapshots_run_id", "vnext_dataset_snapshots", ["run_id"]
    )
    op.create_index(
        "ix_vnext_dataset_snapshots_candidate_id",
        "vnext_dataset_snapshots",
        ["candidate_id"],
    )
    op.create_index(
        "ix_vnext_dataset_snapshots_dataset_id",
        "vnext_dataset_snapshots",
        ["dataset_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_feature_view_specs_run_id", "vnext_feature_view_specs", ["run_id"]
    )
    op.create_index(
        "ix_vnext_feature_view_specs_candidate_id",
        "vnext_feature_view_specs",
        ["candidate_id"],
    )
    op.create_index(
        "ix_vnext_feature_view_specs_strategy_id",
        "vnext_feature_view_specs",
        ["strategy_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_model_artifacts_run_id", "vnext_model_artifacts", ["run_id"]
    )
    op.create_index(
        "ix_vnext_model_artifacts_candidate_id",
        "vnext_model_artifacts",
        ["candidate_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_experiment_specs_run_id", "vnext_experiment_specs", ["run_id"]
    )
    op.create_index(
        "ix_vnext_experiment_specs_candidate_id",
        "vnext_experiment_specs",
        ["candidate_id"],
    )
    op.create_index(
        "ix_vnext_experiment_specs_experiment_id",
        "vnext_experiment_specs",
        ["experiment_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_experiment_runs_run_id", "vnext_experiment_runs", ["run_id"]
    )
    op.create_index(
        "ix_vnext_experiment_runs_candidate_id",
        "vnext_experiment_runs",
        ["candidate_id"],
    )
    op.create_index(
        "ix_vnext_experiment_runs_experiment_id",
        "vnext_experiment_runs",
        ["experiment_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_simulation_calibrations_run_id",
        "vnext_simulation_calibrations",
        ["run_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_shadow_live_deviations_run_id",
        "vnext_shadow_live_deviations",
        ["run_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_vnext_promotion_decisions_run_id", "vnext_promotion_decisions", ["run_id"]
    )
    op.create_index(
        "ix_vnext_promotion_decisions_candidate_id",
        "vnext_promotion_decisions",
        ["candidate_id"],
    )
    op.create_index(
        "ix_vnext_promotion_decisions_target",
        "vnext_promotion_decisions",
        ["promotion_target"],
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_vnext_promotion_decisions_target", table_name="vnext_promotion_decisions"
    )
    op.drop_index(
        "ix_vnext_promotion_decisions_candidate_id",
        table_name="vnext_promotion_decisions",
    ...
    op.drop_index(
        "ix_vnext_promotion_decisions_run_id", table_name="vnext_promotion_decisions"
    )
    ...
    op.drop_index(
        "uq_vnext_experiment_runs_candidate_run", table_name="vnext_experiment_runs"
    )
    op.drop_index(
        "ix_vnext_experiment_runs_experiment_id", table_name="vnext_experiment_runs"
    )
    op.drop_index(
        "ix_vnext_experiment_runs_candidate_id", table_name="vnext_experiment_runs"
    )
    ...
    op.drop_index(
        "ix_vnext_experiment_specs_experiment_id", table_name="vnext_experiment_specs"
    )
    op.drop_index(
        "ix_vnext_experiment_specs_candidate_id", table_name="vnext_experiment_specs"
    )
    op.drop_index(
        "ix_vnext_experiment_specs_run_id", table_name="vnext_experiment_specs"
    )
    ...
    op.drop_index(
        "ix_vnext_model_artifacts_strategy_id", table_name="vnext_model_artifacts"
    )
    op.drop_index(
        "ix_vnext_model_artifacts_candidate_id", table_name="vnext_model_artifacts"
    )
    ...
    op.drop_index(
        "ix_vnext_feature_view_specs_strategy_id", table_name="vnext_feature_view_specs"
    )
    op.drop_index(
        "ix_vnext_feature_view_specs_candidate_id",
        table_name="vnext_feature_view_specs",
    ...
    op.drop_index(
        "ix_vnext_feature_view_specs_run_id", table_name="vnext_feature_view_specs"
    )
    op.drop_table("vnext_feature_view_specs")

    op.drop_index(
        "uq_vnext_dataset_snapshots_run_dataset_id",
        table_name="vnext_dataset_snapshots",
    )
    op.drop_index(
        "ix_vnext_dataset_snapshots_dataset_id", table_name="vnext_dataset_snapshots"
    )
    op.drop_index(
        "ix_vnext_dataset_snapshots_candidate_id", table_name="vnext_dataset_snapshots"
    )
    op.drop_index(
        "ix_vnext_dataset_snapshots_run_id", table_name="vnext_dataset_snapshots"
    )
