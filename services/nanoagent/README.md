...
host. Nanoagent removes its bootstrap bearer token from Terminal and Codex child environments, never injects a shared
OpenAI API key, and never logs terminal input, file content, or prompts.
