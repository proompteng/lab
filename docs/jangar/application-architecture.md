...
The current architecture priority is controller-witness carry and failure-debt maturity on top of stage clearance,
evidence settlement, evidence-quality admission, resource-pressure escrow, and source-heartbeat witness settlement.
Final verdicts remain the consumer surface, but they must now carry explicit evidence before they are treated as durable
...
evidence carry, failure-debt maturity, and Torghut consumer proof. Serving readiness, route health, rollout health,
watch reliability, bounded summary reads, and database freshness can stay green while evidence quality is dirty, runner
resource pressure is dirty, source truth is missing, AgentRun ingestion is unknown, retained failure debt is not yet
retired, or a material verdict still sees stale controller authority. That disagreement is witness variance, not a
reason to widen dispatch, claim merge readiness, or spend Torghut capital.
