# Jangar persistence (chat + work orders)

Jangar is the control plane UI for Codex background workers. It stores chat context (`chat_sessions`, `chat_messages`) and the work orders that trigger Temporal workflows.
