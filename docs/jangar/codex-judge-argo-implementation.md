...
| B) Notify wrapper                      | `docs/jangar/codex-judge-argo-implementation.md` | Retired             | Superseded by Agents runner status, log, artifact, and terminal-event APIs.                                                                                                     | -                                                      | -                                                                                                          | The Jangar notify wrapper and `codex-implement` path are no longer the generic Codex execution boundary.                                                                                                          |
| C) Run-complete ingest + persistence   | `docs/jangar/codex-judge-argo-design.md`         | Retired             | Superseded by app-server runner events, AgentRun terminal events, and Agents Codex projection storage.                                                                          | -                                                      | -                                                                                                          | Generic completion ingestion belongs to Agents; Jangar consumes domain projections.                                                                                                                               |
