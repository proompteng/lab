...
- `docs/torghut/design-system/v6/210-torghut-source-bound-verification-carry-import-and-no-delta-release-2026-05-14.md`
  (current Torghut source-bound verification-carry import and no-delta release contract)
