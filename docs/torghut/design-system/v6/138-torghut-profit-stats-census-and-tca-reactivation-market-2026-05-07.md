...
Scope: Torghut profitability, database statistics quality, trade-decision freshness, execution TCA, options data,
promotion readiness, autoresearch, Jangar evidence census consumption, validation, and rollback.
