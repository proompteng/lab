...
Scope: Torghut quant profitability, route-evidence clearinghouse settlement, zero-notional repair execution,
routeable-candidate proof compaction, active-session TCA quality, Jangar dispatch custody, rollout image proof,
capital safety, validation, rollout, rollback, and cross-stage handoff.
