...
Scope: Make Torghut profitability depend on fresh, lane-local proof receipts and bounded database reads instead of
route-time scans that can time out under production load.
