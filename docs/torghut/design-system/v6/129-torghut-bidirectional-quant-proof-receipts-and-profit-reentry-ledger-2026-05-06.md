...
Scope: Torghut quant profitability, runtime hypothesis custody, proof persistence, Jangar capital admission, paper/live
guardrails, and engineer/deployer handoff.

Companion Jangar contract:

- `docs/agents/designs/125-jangar-quant-proof-replication-and-capital-admission-firebreak-2026-05-06.md`
