...
Scope: Torghut quant profitability, hypothesis-local evidence warrants, empirical reclocking, capital gates, and
Jangar lane-local quorum consumption.

Companion Jangar contract:

- `docs/agents/designs/91-jangar-evidence-warrants-and-lane-local-quorum-2026-05-05.md`
