# 64. Torghut Profit Window, Opportunity Book, and Source-Freshness Warrant Contract (2026-03-21)

Status: Approved for implementation (`plan`)
Canonical scope: This contract consolidates the March 21 profit-window, opportunity-book, source-freshness warrant,
and evidence-escrow requirements.

## Executive summary

The decision is to cut Torghut over to lane-local profit windows, opportunity books, and evidence escrows through a
shadow-and-enforce plan, not a portfolio-wide hard switch. The reason is that the live system still has enough truth to
keep learning,
