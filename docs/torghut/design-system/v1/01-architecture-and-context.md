...
| `torghut` | `DB_DSN`, `CLICKHOUSE_*`, `TRADING_*`, `LLM_*` | `argocd/applications/torghut/knative-service.yaml` |
...
- **Recovery:** see `v1/08-component-clickhouse-capacity-ttl-and-disk-guardrails.md` and `v1/21-runbooks-ta-replay-and-recovery.md`.
...
- **Recovery:** see `v1/22-runbooks-ws-connection-limit-and-auth.md`.
...
- **Recovery:** see `v1/24-runbooks-knative-revision-failures.md`.
