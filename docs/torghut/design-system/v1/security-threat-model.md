...
## Non-goals
- Formal compliance certification documentation (see `v1/compliance-and-auditability.md`).
...
- **Mitigations:**
  ...
  - circuit breakers and fallback to deterministic-only mode (see `v1/ai-layer-circuit-breakers-and-fallbacks.md`).
