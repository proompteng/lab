...
## Responsibilities
1) Establish a *single* active WS connection per Alpaca account/feed.
...
Readiness failing is *intentional*: it removes the pod from service endpoints and signals operator action is required.
