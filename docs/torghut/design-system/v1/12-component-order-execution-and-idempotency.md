...
| Partial commit | order submitted but DB write fails | broker shows order; DB missing execution | reconciliation must backfill from broker state; see `v1/13-component-reconciliation.md` |
