...
| --- | --- | --- | --- |
| Keeper metadata loss | replicas read-only; unknown table errors | `system.replicas` shows readonly; errors in queries | see `v1/23-runbooks-clickhouse-replica-and-keeper.md` (`SYSTEM RESTORE REPLICA`) |
