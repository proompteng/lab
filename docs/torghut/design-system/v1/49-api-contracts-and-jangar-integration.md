...
| ClickHouse unavailable | TA APIs 503/500 | Jangar returns 503/500 | restore ClickHouse; check auth/host; see ClickHouse runbooks |
...
- **Consequences:** ClickHouse availability affects UI; ensure alerts and runbooks exist.
