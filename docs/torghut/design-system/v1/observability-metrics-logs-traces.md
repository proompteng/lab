...
- Implementation status: Partially implemented: metrics/renderers, structured logs, OpenTelemetry, guardrail exporters, and operational manifests exist; full SLO/on-call process is mostly doc/runbook-level.
