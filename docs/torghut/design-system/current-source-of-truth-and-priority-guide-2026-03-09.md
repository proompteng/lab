...
1. bind Jangar rollout and launch authority to sealed recovery warrants, runtime proof cells, and projection watermarks
   in `docs/agents/designs/65-jangar-recovery-warrants-and-runtime-proof-cells-contract-2026-03-21.md`;
2. bind Torghut promotion and rollback authority to local mirrors, hypothesis vaults, and settled post-cost profit
