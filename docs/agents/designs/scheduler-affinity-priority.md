...
- Env wiring: `charts/agents/templates/deployment.yaml` maps defaults to `AGENTS_AGENT_RUNNER_*` env vars.
- Runtime behavior: `services/agents/src/server/agents-controller` applies defaults unless overridden by
