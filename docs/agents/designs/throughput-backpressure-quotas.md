...
- Concurrency is enforced in `services/agents/src/server/agents-controller`:
  - `AGENTS_CONTROLLER_CONCURRENCY_NAMESPACE` (default 10)
  - `AGENTS_CONTROLLER_CONCURRENCY_AGENT` (default 5)
  - `AGENTS_CONTROLLER_CONCURRENCY_CLUSTER` (default 100)
...
- `AGENTS_CONTROLLER_QUEUE_NAMESPACE`
- `AGENTS_CONTROLLER_QUEUE_REPO`
- `AGENTS_CONTROLLER_QUEUE_CLUSTER`
- `AGENTS_CONTROLLER_RATE_WINDOW_SECONDS`
- `AGENTS_CONTROLLER_RATE_NAMESPACE`
- `AGENTS_CONTROLLER_RATE_REPO`
- `AGENTS_CONTROLLER_RATE_CLUSTER`
