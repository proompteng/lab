...
function TooltipProvider({
  ...
  return <TooltipPrimitive.Provider data-slot="tooltip-provider" delay={resolvedDelay} {...props} />
}
...
function TooltipTrigger({ asChild = false, render, ...props }: TooltipPrimitive.Trigger.Props & { asChild?: boolean }) {
  return <TooltipPrimitive.Trigger data-slot="tooltip-trigger" render={asChild ? <Slot /> : render} {...props} />
}
