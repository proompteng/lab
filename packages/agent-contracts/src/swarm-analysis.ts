...
export const DEFAULT_SWARM_REQUIREMENT_SCOPE_FIELD_LIMIT = 16_384
...
export const makeRequirementObjective = (description: string, payload: string, options: { maxBytes?: number } = {}) => {
  ...
  return clampUtf8(combined, options.maxBytes ?? DEFAULT_SWARM_REQUIREMENT_SCOPE_FIELD_LIMIT).value
}
