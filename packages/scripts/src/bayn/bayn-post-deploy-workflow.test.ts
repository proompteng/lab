...
describe('Bayn post-deploy workflow', () => {
  ...
  test('keeps Kubernetes reads narrow and gives only the no-permission runner a direct Bayn HTTP path', () => {
    ...
    expect(baynNetworkPolicy).toContain('actions-ephemeral-runner: "True"')
