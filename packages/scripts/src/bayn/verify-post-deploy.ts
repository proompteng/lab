...
export const verifyReadOnlyBaynIdentity = async (run: RunCommand): Promise<void> => {
  const deniedChecks: readonly (readonly string[])[] = [
    ...
    ['update', 'deployments.apps', '--subresource=scale', '-n', 'bayn'],
    ...
    ['get', 'services', '--subresource=proxy', '-n', 'bayn'],
    ['create', 'services', '--subresource=proxy', '-n', 'bayn'],
    ['update', 'services', '--subresource=proxy', '-n', 'bayn'],
    ['patch', 'services', '--subresource=proxy', '-n', 'bayn'],
    ['delete', 'services', '--subresource=proxy', '-n', 'bayn'],
    ['create', 'pods', '--subresource=eviction', '-n', 'bayn'],
