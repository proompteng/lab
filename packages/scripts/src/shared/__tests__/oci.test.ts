...
describe('native OCI build workflows', () => {
  ...
  it('routes the enabled Headlamp image through a real Nix OCI attr', () => {
    ...
    expect(headlampImageModule).toContain('find "$out/headlamp/frontend" -type d -exec chmod 0777 {} +')
    expect(headlampImageModule).toContain('find "$out/headlamp/frontend" -type f -exec chmod 0666 {} +')
