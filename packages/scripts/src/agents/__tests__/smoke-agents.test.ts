...
describe('synthesis autonomous trader provider', () => {
  ...
  it('keeps the trader prompt aligned with day-trading authority', () => {
    ...
    expect(prompt).toContain('GPT-5.5 execution style')
    expect(prompt).toContain('Work outcome-first')
    expect(prompt).toContain('Do not run open-ended exploration')
    expect(prompt).toContain('Bound research to the highest-impact catalyst')
    ...
    expect(taskPrompt).toContain('GPT-5.5 execution style')
    expect(taskPrompt).toContain('Work outcome-first')
    expect(taskPrompt).toContain('Bound research to the highest-impact catalyst')
    ...
    expect(taskPrompt).toContain('56be940b69bf1a56578040eda9bf2e3699c5220e')
    ...
    expect(prompt).toContain('protective_preflight.py --ensure-dtbp-entry --submit-smoke')
    expect(prompt).toContain('build-live-scan-input --bars')
    expect(prompt).toContain('synthesis_autotrader_client.py')
    ...
    expect(prompt).toContain('--require-live-state --max-input-age-seconds 300')
    ...
    expect(prompt).toContain('non-open status such as `replaced`, `canceled`, `filled`, or `reconciled`')
    ...
    expect(prompt).toContain('protective-preflight.json')
    expect(prompt).toContain('live-scan-input.json')
    ...
    expect(taskPrompt).toContain('protective_preflight.py --ensure-dtbp-entry --submit-smoke')
    expect(taskPrompt).toContain('build-live-scan-input --bars')
    expect(taskPrompt).toContain('synthesis_autotrader_client.py')
    ...
    expect(taskPrompt).toContain('--require-live-state --max-input-age-seconds 300')
    ...
    expect(taskPrompt).toContain('non-open status such as `replaced`, `canceled`, `filled`, or `reconciled`')
  ...
  it('wires the analysis daytrading bootstrap into the trader provider', () => {
    ...
    expect(objectAt(bootstrap, 'content')).toContain('protective-preflight.json')
    expect(objectAt(bootstrap, 'content')).toContain('live-scan-input.json')
    ...
    expect(artifactNames).toContain('autonomous-trader-protective-preflight')
    expect(artifactNames).toContain('autonomous-trader-live-scan-input')
