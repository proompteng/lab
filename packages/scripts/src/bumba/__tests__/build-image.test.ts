...
describe('bumba build-image internals', () => {
  it('pins the dependency closures observed by both native builders', () => {
    ...
    expect(image).toContain('x86_64-linux = "sha256-5m7aO8KOEVHMsz9KQ/runoc8h/PGoAxcnP57upysx/4="')
    expect(image).toContain('aarch64-linux = "sha256-hvciCSOQHo4TYttowRa0qXC5MuYy948QJG3ZYpiupeQ="')
  })
