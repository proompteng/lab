...
| `src/agents/deploy-service.ts` | Applies the Argo CD Application manifest for Agents (kubectl only). | `kubectl` | `bun run packages/scripts/src/agents/deploy-service.ts` |
