...
| `src/agents/deploy-argocd.ts` | Applies the Argo CD Application manifest for Agents (kubectl only). | `kubectl` | `bun run packages/scripts/src/agents/deploy-argocd.ts` |
