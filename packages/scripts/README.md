...
| `src/agents/deploy-argocd.ts` | Applies the Argo CD Application manifest for Agents and optionally syncs/waits. | `kubectl`, `argocd` | `bun run packages/scripts/src/agents/deploy-argocd.ts` |
