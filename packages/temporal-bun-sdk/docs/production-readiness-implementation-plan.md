...
- Add `tests/replay/corpus/manifest.json`.
  - Fields: fixture name, Temporal Server version, SDK version, workflow type,
    feature tags, history event count, expected command count, payload codec
    profile, captured date, and source command.
