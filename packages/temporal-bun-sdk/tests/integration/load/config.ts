...
const DEFAULT_WORKFLOW_COUNT = 18
const DEFAULT_WORKFLOW_CONCURRENCY = 6
const DEFAULT_ACTIVITY_CONCURRENCY = 8
const DEFAULT_ACTIVITY_DELAY_MS = 150
const DEFAULT_ACTIVITY_BURSTS = 3
const DEFAULT_ACTIVITY_PAYLOAD_BYTES = 2_048
const DEFAULT_COMPUTE_ITERATIONS = 120_000
const DEFAULT_CPU_ROUNDS = 4
