...
const DEFAULT_WORKFLOW_COUNT = 24
const DEFAULT_WORKFLOW_CONCURRENCY = 6
const DEFAULT_ACTIVITY_CONCURRENCY = 8
const DEFAULT_ACTIVITY_DELAY_MS = 200
const DEFAULT_ACTIVITY_BURSTS = 4
const DEFAULT_ACTIVITY_PAYLOAD_BYTES = 2_048
const DEFAULT_COMPUTE_ITERATIONS = 250_000
const DEFAULT_CPU_ROUNDS = 6
const DEFAULT_TIMER_DELAY_MS = 75
const DEFAULT_THROUGHPUT_FLOOR = 2
const DEFAULT_STICKY_RATIO = 0.65
const DEFAULT_WORKFLOW_POLL_P95_MS = 3_500
const DEFAULT_ACTIVITY_POLL_P95_MS = 3_500
const DEFAULT_WORKFLOW_DEADLINE_MS = 120_000
