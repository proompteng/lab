...
export class FieldInfo extends Message<FieldInfo> {
  ...
  static equals(
    a: FieldInfo | PlainMessage<FieldInfo> | undefined,
    b: FieldInfo | PlainMessage<FieldInfo> | undefined,
  ): boolean {
...
export class TypeReference extends Message<TypeReference> {
  ...
  static equals(
    a: TypeReference | PlainMessage<TypeReference> | undefined,
    b: TypeReference | PlainMessage<TypeReference> | undefined,
  ): boolean {
 ...
 */
export const field_info = proto3.makeExtension<FieldOptions, FieldInfo>('google.api.field_info', FieldOptions, () => ({
  no: 291403980,
  kind: 'message',
  T: FieldInfo,
}))
