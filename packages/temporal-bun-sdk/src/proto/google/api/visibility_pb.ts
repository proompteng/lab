...
export class Visibility extends Message<Visibility> {
  ...
  static equals(
    a: Visibility | PlainMessage<Visibility> | undefined,
    b: Visibility | PlainMessage<Visibility> | undefined,
  ): boolean {
...
export class VisibilityRule extends Message<VisibilityRule> {
  ...
  static equals(
    a: VisibilityRule | PlainMessage<VisibilityRule> | undefined,
    b: VisibilityRule | PlainMessage<VisibilityRule> | undefined,
  ): boolean {
