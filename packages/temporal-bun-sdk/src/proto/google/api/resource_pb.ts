...
export class ResourceDescriptor extends Message<ResourceDescriptor> {
  ...
  static equals(
    a: ResourceDescriptor | PlainMessage<ResourceDescriptor> | undefined,
    b: ResourceDescriptor | PlainMessage<ResourceDescriptor> | undefined,
  ): boolean {
...
export class ResourceReference extends Message<ResourceReference> {
  ...
  static equals(
    a: ResourceReference | PlainMessage<ResourceReference> | undefined,
    b: ResourceReference | PlainMessage<ResourceReference> | undefined,
  ): boolean {
