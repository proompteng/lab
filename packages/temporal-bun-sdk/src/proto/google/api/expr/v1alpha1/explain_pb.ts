...
export class Explain extends Message<Explain> {
  ...
  static equals(
    a: Explain | PlainMessage<Explain> | undefined,
    b: Explain | PlainMessage<Explain> | undefined,
  ): boolean {
...
export class Explain_ExprStep extends Message<Explain_ExprStep> {
  ...
  static equals(
    a: Explain_ExprStep | PlainMessage<Explain_ExprStep> | undefined,
    b: Explain_ExprStep | PlainMessage<Explain_ExprStep> | undefined,
  ): boolean {
