...
export class DeclType extends Message<DeclType> {
  ...
  static equals(
    a: DeclType | PlainMessage<DeclType> | undefined,
    b: DeclType | PlainMessage<DeclType> | undefined,
  ): boolean {
...
export class IdentDecl extends Message<IdentDecl> {
  ...
  static equals(
    a: IdentDecl | PlainMessage<IdentDecl> | undefined,
    b: IdentDecl | PlainMessage<IdentDecl> | undefined,
  ): boolean {
...
export class FunctionDecl extends Message<FunctionDecl> {
  ...
  static equals(
    a: FunctionDecl | PlainMessage<FunctionDecl> | undefined,
    b: FunctionDecl | PlainMessage<FunctionDecl> | undefined,
  ): boolean {
