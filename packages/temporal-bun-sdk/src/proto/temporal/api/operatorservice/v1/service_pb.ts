...
import type {
  AddOrUpdateRemoteClusterRequestSchema,
  AddOrUpdateRemoteClusterResponseSchema,
  ...
  DeleteNexusEndpointResponseSchema,
  GetNexusEndpointRequestSchema,
  GetNexusEndpointResponseSchema,
  ListClustersRequestSchema,
  ListClustersResponseSchema,
  ListNexusEndpointsRequestSchema,
  ListNexusEndpointsResponseSchema,
  ListSearchAttributesRequestSchema,
  ListSearchAttributesResponseSchema,
  RemoveRemoteClusterRequestSchema,
  RemoveRemoteClusterResponseSchema,
  RemoveSearchAttributesRequestSchema,
  RemoveSearchAttributesResponseSchema,
  UpdateNexusEndpointRequestSchema,
  UpdateNexusEndpointResponseSchema,
} from './request_response_pb.ts'
import { file_temporal_api_operatorservice_v1_request_response } from './request_response_pb.ts'
...
}> = /*@__PURE__*/ serviceDesc(file_temporal_api_operatorservice_v1_service, 0)
