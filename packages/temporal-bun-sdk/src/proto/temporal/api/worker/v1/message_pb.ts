...
export class WorkerPollerInfo extends Message<WorkerPollerInfo> {
  ...
  static equals(
    a: WorkerPollerInfo | PlainMessage<WorkerPollerInfo> | undefined,
    b: WorkerPollerInfo | PlainMessage<WorkerPollerInfo> | undefined,
  ): boolean {
...
export class WorkerSlotsInfo extends Message<WorkerSlotsInfo> {
  ...
  static equals(
    a: WorkerSlotsInfo | PlainMessage<WorkerSlotsInfo> | undefined,
    b: WorkerSlotsInfo | PlainMessage<WorkerSlotsInfo> | undefined,
  ): boolean {
...
export class WorkerHostInfo extends Message<WorkerHostInfo> {
  ...
  static equals(
    a: WorkerHostInfo | PlainMessage<WorkerHostInfo> | undefined,
    b: WorkerHostInfo | PlainMessage<WorkerHostInfo> | undefined,
  ): boolean {
...
export class WorkerHeartbeat extends Message<WorkerHeartbeat> {
  ...
  static equals(
    a: WorkerHeartbeat | PlainMessage<WorkerHeartbeat> | undefined,
    b: WorkerHeartbeat | PlainMessage<WorkerHeartbeat> | undefined,
  ): boolean {
...
export class WorkerInfo extends Message<WorkerInfo> {
  ...
  static equals(
    a: WorkerInfo | PlainMessage<WorkerInfo> | undefined,
    b: WorkerInfo | PlainMessage<WorkerInfo> | undefined,
  ): boolean {
...
export class PluginInfo extends Message<PluginInfo> {
  ...
  static equals(
    a: PluginInfo | PlainMessage<PluginInfo> | undefined,
    b: PluginInfo | PlainMessage<PluginInfo> | undefined,
  ): boolean {
