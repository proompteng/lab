...
import type { Memo, SearchAttributes, WorkflowExecution, WorkflowType } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { ScheduleOverlapPolicy } from '../../enums/v1/schedule_pb.ts'
import { file_temporal_api_enums_v1_schedule } from '../../enums/v1/schedule_pb.ts'
import type { WorkflowExecutionStatus } from '../../enums/v1/workflow_pb.ts'
import { file_temporal_api_enums_v1_workflow } from '../../enums/v1/workflow_pb.ts'
import type { NewWorkflowExecutionInfo } from '../../workflow/v1/message_pb.ts'
 ...
 */
export const file_temporal_api_schedule_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
      file_google_protobuf_duration,
      file_google_protobuf_timestamp,
      file_temporal_api_common_v1_message,
      file_temporal_api_enums_v1_schedule,
 ...
 */
export const CalendarSpecSchema: GenMessage<CalendarSpec> =
  /*@__PURE__*/
 ...
 */
export const RangeSchema: GenMessage<Range> = /*@__PURE__*/ messageDesc(file_temporal_api_schedule_v1_message, 1)
 ...
 */
export const StructuredCalendarSpecSchema: GenMessage<StructuredCalendarSpec> =
  /*@__PURE__*/
 ...
 */
export const IntervalSpecSchema: GenMessage<IntervalSpec> =
  /*@__PURE__*/
 ...
 */
export const ScheduleSpecSchema: GenMessage<ScheduleSpec> =
  /*@__PURE__*/
 ...
 */
export const SchedulePoliciesSchema: GenMessage<SchedulePolicies> =
  /*@__PURE__*/
 ...
 */
export const ScheduleActionSchema: GenMessage<ScheduleAction> =
  /*@__PURE__*/
 ...
 */
export const ScheduleActionResultSchema: GenMessage<ScheduleActionResult> =
  /*@__PURE__*/
 ...
 */
export const ScheduleStateSchema: GenMessage<ScheduleState> =
  /*@__PURE__*/
 ...
 */
export const TriggerImmediatelyRequestSchema: GenMessage<TriggerImmediatelyRequest> =
  /*@__PURE__*/
 ...
 */
export const BackfillRequestSchema: GenMessage<BackfillRequest> =
  /*@__PURE__*/
 ...
 */
export const SchedulePatchSchema: GenMessage<SchedulePatch> =
  /*@__PURE__*/
 ...
 */
export const ScheduleInfoSchema: GenMessage<ScheduleInfo> =
  /*@__PURE__*/
 ...
 */
export const ScheduleSchema: GenMessage<Schedule> = /*@__PURE__*/ messageDesc(file_temporal_api_schedule_v1_message, 13)
 ...
 */
export const ScheduleListInfoSchema: GenMessage<ScheduleListInfo> =
  /*@__PURE__*/
 ...
 */
export const ScheduleListEntrySchema: GenMessage<ScheduleListEntry> =
  /*@__PURE__*/
