...
import type { Header, Payloads, ResetOptions } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { BatchOperationState } from '../../enums/v1/batch_operation_pb.ts'
import { file_temporal_api_enums_v1_batch_operation } from '../../enums/v1/batch_operation_pb.ts'
import type { ResetReapplyType, ResetType } from '../../enums/v1/reset_pb.ts'
import { file_temporal_api_enums_v1_reset } from '../../enums/v1/reset_pb.ts'
import type { WorkflowRuleSpec } from '../../rules/v1/message_pb.ts'
import { file_temporal_api_rules_v1_message } from '../../rules/v1/message_pb.ts'
import type { PostResetOperation, WorkflowExecutionOptions } from '../../workflow/v1/message_pb.ts'
 ...
 */
export const file_temporal_api_batch_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
      file_google_protobuf_duration,
      file_google_protobuf_field_mask,
      file_google_protobuf_timestamp,
 ...
 */
export const BatchOperationInfoSchema: GenMessage<BatchOperationInfo> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationTerminationSchema: GenMessage<BatchOperationTermination> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationSignalSchema: GenMessage<BatchOperationSignal> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationCancellationSchema: GenMessage<BatchOperationCancellation> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationDeletionSchema: GenMessage<BatchOperationDeletion> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationResetSchema: GenMessage<BatchOperationReset> =
  /*@__PURE__*/
 ...
 */
export type BatchOperationUpdateWorkflowExecutionOptions =
 ...
 */
export const BatchOperationUpdateWorkflowExecutionOptionsSchema: GenMessage<BatchOperationUpdateWorkflowExecutionOptions> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationUnpauseActivitiesSchema: GenMessage<BatchOperationUnpauseActivities> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationTriggerWorkflowRuleSchema: GenMessage<BatchOperationTriggerWorkflowRule> =
  /*@__PURE__*/
 ...
 */
export const BatchOperationResetActivitiesSchema: GenMessage<BatchOperationResetActivities> =
  /*@__PURE__*/
 ...
 */
export type BatchOperationUpdateActivityOptions =
 ...
 */
export const BatchOperationUpdateActivityOptionsSchema: GenMessage<BatchOperationUpdateActivityOptions> =
  /*@__PURE__*/
