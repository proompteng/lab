...
export const file_temporal_api_batch_v1_message: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_duration, file_google_protobuf_field_mask, file_google_protobuf_timestamp, file_temporal_api_activity_v1_message, file_temporal_api_common_v1_message, file_temporal_api_enums_v1_batch_operation, file_temporal_api_enums_v1_reset, file_temporal_api_rules_v1_message, file_temporal_api_workflow_v1_message]);
...
export type BatchOperationInfo = Message<"temporal.api.batch.v1.BatchOperationInfo"> & {
   ...
   * Operation type
   *
   * @generated from field: temporal.api.enums.v1.BatchOperationType operation_type = 5;
   */
 ...
 *
 * @generated from message temporal.api.batch.v1.BatchOperationTerminateActivities
 */
export type BatchOperationTerminateActivities = Message<"temporal.api.batch.v1.BatchOperationTerminateActivities"> & {
  /**
   * The identity of the worker/client
   *
...
/**
 * Describes the message temporal.api.batch.v1.BatchOperationTerminateActivities.
 * Use `create(BatchOperationTerminateActivitiesSchema)` to create a new message.
 */
export const BatchOperationTerminateActivitiesSchema: GenMessage<BatchOperationTerminateActivities> = /*@__PURE__*/
 ...
 *
 * @generated from message temporal.api.batch.v1.BatchOperationCancelActivities
 */
export type BatchOperationCancelActivities = Message<"temporal.api.batch.v1.BatchOperationCancelActivities"> & {
  /**
   * The identity of the worker/client
   *
   * @generated from field: string identity = 1;
...
/**
 * Describes the message temporal.api.batch.v1.BatchOperationCancelActivities.
 * Use `create(BatchOperationCancelActivitiesSchema)` to create a new message.
 */
export const BatchOperationCancelActivitiesSchema: GenMessage<BatchOperationCancelActivities> = /*@__PURE__*/
 ...
 *
 * @generated from message temporal.api.batch.v1.BatchOperationDeleteActivities
 */
export type BatchOperationDeleteActivities = Message<"temporal.api.batch.v1.BatchOperationDeleteActivities"> & {
};

/**
 * Describes the message temporal.api.batch.v1.BatchOperationDeleteActivities.
 * Use `create(BatchOperationDeleteActivitiesSchema)` to create a new message.
 */
export const BatchOperationDeleteActivitiesSchema: GenMessage<BatchOperationDeleteActivities> = /*@__PURE__*/
...
export const BatchOperationTriggerWorkflowRuleSchema: GenMessage<BatchOperationTriggerWorkflowRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_batch_v1_message, 11);
...
export const BatchOperationResetActivitiesSchema: GenMessage<BatchOperationResetActivities> = /*@__PURE__*/
  messageDesc(file_temporal_api_batch_v1_message, 12);
...
export const BatchOperationUpdateActivityOptionsSchema: GenMessage<BatchOperationUpdateActivityOptions> = /*@__PURE__*/
  messageDesc(file_temporal_api_batch_v1_message, 13);
