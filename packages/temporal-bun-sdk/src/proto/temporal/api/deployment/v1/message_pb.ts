...
} from '../../enums/v1/deployment_pb.ts'
import { file_temporal_api_enums_v1_deployment } from '../../enums/v1/deployment_pb.ts'
import type { RoutingConfigUpdateState, TaskQueueType } from '../../enums/v1/task_queue_pb.ts'
 ...
 */
export const file_temporal_api_deployment_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
 ...
 */
export const WorkerDeploymentOptionsSchema: GenMessage<WorkerDeploymentOptions> =
  /*@__PURE__*/
 ...
 */
export const DeploymentInfoSchema: GenMessage<DeploymentInfo> =
  /*@__PURE__*/
 ...
 */
export const DeploymentInfo_TaskQueueInfoSchema: GenMessage<DeploymentInfo_TaskQueueInfo> =
  /*@__PURE__*/
 ...
 */
export const UpdateDeploymentMetadataSchema: GenMessage<UpdateDeploymentMetadata> =
  /*@__PURE__*/
 ...
 */
export const DeploymentListInfoSchema: GenMessage<DeploymentListInfo> =
  /*@__PURE__*/
 ...
 */
export const WorkerDeploymentVersionInfoSchema: GenMessage<WorkerDeploymentVersionInfo> =
  /*@__PURE__*/
 ...
 */
export type WorkerDeploymentVersionInfo_VersionTaskQueueInfo =
 ...
 */
export const WorkerDeploymentVersionInfo_VersionTaskQueueInfoSchema: GenMessage<WorkerDeploymentVersionInfo_VersionTaskQueueInfo> =
  /*@__PURE__*/
 ...
 */
export const VersionDrainageInfoSchema: GenMessage<VersionDrainageInfo> =
  /*@__PURE__*/
 ...
 */
export const WorkerDeploymentInfoSchema: GenMessage<WorkerDeploymentInfo> =
  /*@__PURE__*/
 ...
 */
export type WorkerDeploymentInfo_WorkerDeploymentVersionSummary =
  Message<'temporal.api.deployment.v1.WorkerDeploymentInfo.WorkerDeploymentVersionSummary'> & {
    /**
     * Deprecated. Use `deployment_version`.
     *
     * @generated from field: string version = 1 [deprecated = true];
 ...
 */
export const WorkerDeploymentInfo_WorkerDeploymentVersionSummarySchema: GenMessage<WorkerDeploymentInfo_WorkerDeploymentVersionSummary> =
  /*@__PURE__*/
 ...
 */
export const WorkerDeploymentVersionSchema: GenMessage<WorkerDeploymentVersion> =
  /*@__PURE__*/
 ...
 */
export const VersionMetadataSchema: GenMessage<VersionMetadata> =
  /*@__PURE__*/
 ...
 */
export const RoutingConfigSchema: GenMessage<RoutingConfig> =
  /*@__PURE__*/
