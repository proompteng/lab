...
export class WorkerDeploymentOptions extends Message<WorkerDeploymentOptions> {
  ...
  static equals(
    a: WorkerDeploymentOptions | PlainMessage<WorkerDeploymentOptions> | undefined,
    b: WorkerDeploymentOptions | PlainMessage<WorkerDeploymentOptions> | undefined,
  ): boolean {
...
export class DeploymentInfo extends Message<DeploymentInfo> {
  ...
  static equals(
    a: DeploymentInfo | PlainMessage<DeploymentInfo> | undefined,
    b: DeploymentInfo | PlainMessage<DeploymentInfo> | undefined,
  ): boolean {
...
export class DeploymentInfo_TaskQueueInfo extends Message<DeploymentInfo_TaskQueueInfo> {
  ...
  static equals(
    a: DeploymentInfo_TaskQueueInfo | PlainMessage<DeploymentInfo_TaskQueueInfo> | undefined,
    b: DeploymentInfo_TaskQueueInfo | PlainMessage<DeploymentInfo_TaskQueueInfo> | undefined,
  ): boolean {
...
export class UpdateDeploymentMetadata extends Message<UpdateDeploymentMetadata> {
  ...
  static equals(
    a: UpdateDeploymentMetadata | PlainMessage<UpdateDeploymentMetadata> | undefined,
    b: UpdateDeploymentMetadata | PlainMessage<UpdateDeploymentMetadata> | undefined,
  ): boolean {
...
export class DeploymentListInfo extends Message<DeploymentListInfo> {
  ...
  static equals(
    a: DeploymentListInfo | PlainMessage<DeploymentListInfo> | undefined,
    b: DeploymentListInfo | PlainMessage<DeploymentListInfo> | undefined,
  ): boolean {
...
export class WorkerDeploymentVersionInfo extends Message<WorkerDeploymentVersionInfo> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 8,
      name: 'task_queue_infos',
      kind: 'message',
      T: WorkerDeploymentVersionInfo_VersionTaskQueueInfo,
      repeated: true,
    },
  ...
  static equals(
    a: WorkerDeploymentVersionInfo | PlainMessage<WorkerDeploymentVersionInfo> | undefined,
    b: WorkerDeploymentVersionInfo | PlainMessage<WorkerDeploymentVersionInfo> | undefined,
  ): boolean {
...
export class WorkerDeploymentVersionInfo_VersionTaskQueueInfo extends Message<WorkerDeploymentVersionInfo_VersionTaskQueueInfo> {
  ...
  static equals(
    a:
      | WorkerDeploymentVersionInfo_VersionTaskQueueInfo
      | PlainMessage<WorkerDeploymentVersionInfo_VersionTaskQueueInfo>
      | undefined,
    b:
      | WorkerDeploymentVersionInfo_VersionTaskQueueInfo
      | PlainMessage<WorkerDeploymentVersionInfo_VersionTaskQueueInfo>
...
export class VersionDrainageInfo extends Message<VersionDrainageInfo> {
  ...
  static equals(
    a: VersionDrainageInfo | PlainMessage<VersionDrainageInfo> | undefined,
    b: VersionDrainageInfo | PlainMessage<VersionDrainageInfo> | undefined,
  ): boolean {
...
export class WorkerDeploymentInfo extends Message<WorkerDeploymentInfo> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 2,
      name: 'version_summaries',
      kind: 'message',
      T: WorkerDeploymentInfo_WorkerDeploymentVersionSummary,
      repeated: true,
    },
    { no: 3, name: 'create_time', kind: 'message', T: Timestamp },
  ...
  static equals(
    a: WorkerDeploymentInfo | PlainMessage<WorkerDeploymentInfo> | undefined,
    b: WorkerDeploymentInfo | PlainMessage<WorkerDeploymentInfo> | undefined,
  ): boolean {
...
export class WorkerDeploymentInfo_WorkerDeploymentVersionSummary extends Message<WorkerDeploymentInfo_WorkerDeploymentVersionSummary> {
  ...
  static equals(
    a:
      | WorkerDeploymentInfo_WorkerDeploymentVersionSummary
      | PlainMessage<WorkerDeploymentInfo_WorkerDeploymentVersionSummary>
      | undefined,
    b:
      | WorkerDeploymentInfo_WorkerDeploymentVersionSummary
      | PlainMessage<WorkerDeploymentInfo_WorkerDeploymentVersionSummary>
...
export class WorkerDeploymentVersion extends Message<WorkerDeploymentVersion> {
  ...
  static equals(
    a: WorkerDeploymentVersion | PlainMessage<WorkerDeploymentVersion> | undefined,
    b: WorkerDeploymentVersion | PlainMessage<WorkerDeploymentVersion> | undefined,
  ): boolean {
...
export class VersionMetadata extends Message<VersionMetadata> {
  ...
  static equals(
    a: VersionMetadata | PlainMessage<VersionMetadata> | undefined,
    b: VersionMetadata | PlainMessage<VersionMetadata> | undefined,
  ): boolean {
...
export class RoutingConfig extends Message<RoutingConfig> {
  ...
  static equals(
    a: RoutingConfig | PlainMessage<RoutingConfig> | undefined,
    b: RoutingConfig | PlainMessage<RoutingConfig> | undefined,
  ): boolean {
