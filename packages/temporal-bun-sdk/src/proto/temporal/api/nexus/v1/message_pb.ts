...
import type { Payload } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { NexusHandlerErrorRetryBehavior } from '../../enums/v1/nexus_pb.ts'
import { file_temporal_api_enums_v1_nexus } from '../../enums/v1/nexus_pb.ts'
import type { Message } from '@bufbuild/protobuf'

/**
 * Describes the file temporal/api/nexus/v1/message.proto.
 */
export const file_temporal_api_nexus_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [file_google_protobuf_timestamp, file_temporal_api_common_v1_message, file_temporal_api_enums_v1_nexus],
  )
 ...
 */
export const FailureSchema: GenMessage<Failure> = /*@__PURE__*/ messageDesc(file_temporal_api_nexus_v1_message, 0)
 ...
 */
export const HandlerErrorSchema: GenMessage<HandlerError> =
  /*@__PURE__*/
 ...
 */
export const UnsuccessfulOperationErrorSchema: GenMessage<UnsuccessfulOperationError> =
  /*@__PURE__*/
 ...
 */
export const LinkSchema: GenMessage<Link> = /*@__PURE__*/ messageDesc(file_temporal_api_nexus_v1_message, 3)
 ...
 */
export const StartOperationRequestSchema: GenMessage<StartOperationRequest> =
  /*@__PURE__*/
 ...
 */
export const RequestSchema: GenMessage<Request> = /*@__PURE__*/ messageDesc(file_temporal_api_nexus_v1_message, 6)
 ...
 */
export const StartOperationResponseSchema: GenMessage<StartOperationResponse> =
  /*@__PURE__*/
 ...
 */
export const StartOperationResponse_SyncSchema: GenMessage<StartOperationResponse_Sync> =
  /*@__PURE__*/
 ...
 */
export const StartOperationResponse_AsyncSchema: GenMessage<StartOperationResponse_Async> =
  /*@__PURE__*/
 ...
 */
export const CancelOperationResponseSchema: GenMessage<CancelOperationResponse> =
  /*@__PURE__*/
 ...
 */
export const ResponseSchema: GenMessage<Response> = /*@__PURE__*/ messageDesc(file_temporal_api_nexus_v1_message, 9)
 ...
 */
export const EndpointSchema: GenMessage<Endpoint> = /*@__PURE__*/ messageDesc(file_temporal_api_nexus_v1_message, 10)
 ...
 */
export const EndpointSpecSchema: GenMessage<EndpointSpec> =
  /*@__PURE__*/
 ...
 */
export const EndpointTargetSchema: GenMessage<EndpointTarget> =
  /*@__PURE__*/
 ...
 */
export const EndpointTarget_WorkerSchema: GenMessage<EndpointTarget_Worker> =
  /*@__PURE__*/
 ...
 */
export const EndpointTarget_ExternalSchema: GenMessage<EndpointTarget_External> =
  /*@__PURE__*/
