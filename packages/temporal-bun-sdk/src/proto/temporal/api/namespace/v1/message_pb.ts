...
export const file_temporal_api_namespace_v1_message: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_duration, file_google_protobuf_timestamp, file_temporal_api_enums_v1_namespace]);
...
export type NamespaceInfo_Capabilities = Message<"temporal.api.namespace.v1.NamespaceInfo.Capabilities"> & {
   ...
   *
   * @generated from field: bool workflow_update_callbacks = 12;
   */
  workflowUpdateCallbacks: boolean;

  /**
   * When true, workers should use poller autoscaling by default unless explicitly configured otherwise.
   *
   * @generated from field: bool poller_autoscaling_auto_enroll = 13;
   */
  pollerAutoscalingAutoEnroll: boolean;

  /**
   * True if the namespace supports pagination of `RespondWorkflowTaskCompleted` request.
   *
   * @generated from field: bool workflow_task_completion_pagination = 14;
   */
  workflowTaskCompletionPagination: boolean;

  /**
   * True if the namespace supports start delay for standalone activities.
   *
   * @generated from field: bool standalone_activity_start_delay = 15;
   */
  standaloneActivityStartDelay: boolean;

  /**
   * True if the namespace supports batch operations for standalone activities.
   *
   * @generated from field: bool standalone_activity_batch_operations = 16;
   */
  standaloneActivityBatchOperations: boolean;

  /**
   * True if the namespace supports standalone activity operator commands.
   *
   * @generated from field: bool standalone_activity_operator_commands = 17;
   */
  standaloneActivityOperatorCommands: boolean;
};
...
export type NamespaceInfo_Limits = Message<"temporal.api.namespace.v1.NamespaceInfo.Limits"> & {
   ...
   *
   * @generated from field: int64 workflow_task_completion_size_limit_error = 3;
   */
  workflowTaskCompletionSizeLimitError: bigint;
};
