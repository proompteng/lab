...
export class NamespaceInfo extends Message<NamespaceInfo> {
  ...
  static equals(
    a: NamespaceInfo | PlainMessage<NamespaceInfo> | undefined,
    b: NamespaceInfo | PlainMessage<NamespaceInfo> | undefined,
  ): boolean {
...
export class NamespaceInfo_Capabilities extends Message<NamespaceInfo_Capabilities> {
  ...
  static equals(
    a: NamespaceInfo_Capabilities | PlainMessage<NamespaceInfo_Capabilities> | undefined,
    b: NamespaceInfo_Capabilities | PlainMessage<NamespaceInfo_Capabilities> | undefined,
  ): boolean {
...
export class NamespaceConfig extends Message<NamespaceConfig> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 7,
      name: 'custom_search_attribute_aliases',
      kind: 'map',
      K: 9 /* ScalarType.STRING */,
      V: { kind: 'scalar', T: 9 /* ScalarType.STRING */ },
    },
  ...
  static equals(
    a: NamespaceConfig | PlainMessage<NamespaceConfig> | undefined,
    b: NamespaceConfig | PlainMessage<NamespaceConfig> | undefined,
  ): boolean {
...
export class BadBinaries extends Message<BadBinaries> {
  ...
  static equals(
    a: BadBinaries | PlainMessage<BadBinaries> | undefined,
    b: BadBinaries | PlainMessage<BadBinaries> | undefined,
  ): boolean {
...
export class BadBinaryInfo extends Message<BadBinaryInfo> {
  ...
  static equals(
    a: BadBinaryInfo | PlainMessage<BadBinaryInfo> | undefined,
    b: BadBinaryInfo | PlainMessage<BadBinaryInfo> | undefined,
  ): boolean {
...
export class UpdateNamespaceInfo extends Message<UpdateNamespaceInfo> {
  ...
  static equals(
    a: UpdateNamespaceInfo | PlainMessage<UpdateNamespaceInfo> | undefined,
    b: UpdateNamespaceInfo | PlainMessage<UpdateNamespaceInfo> | undefined,
  ): boolean {
...
export class NamespaceFilter extends Message<NamespaceFilter> {
  ...
  static equals(
    a: NamespaceFilter | PlainMessage<NamespaceFilter> | undefined,
    b: NamespaceFilter | PlainMessage<NamespaceFilter> | undefined,
  ): boolean {
