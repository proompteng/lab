...
import type { ArchivalState, NamespaceState } from '../../enums/v1/namespace_pb.ts'
import { file_temporal_api_enums_v1_namespace } from '../../enums/v1/namespace_pb.ts'
import type { Message } from '@bufbuild/protobuf'

/**
 * Describes the file temporal/api/namespace/v1/message.proto.
 */
export const file_temporal_api_namespace_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
 ...
 */
export const NamespaceInfoSchema: GenMessage<NamespaceInfo> =
  /*@__PURE__*/
 ...
 */
export const NamespaceInfo_CapabilitiesSchema: GenMessage<NamespaceInfo_Capabilities> =
  /*@__PURE__*/
 ...
 */
export const NamespaceConfigSchema: GenMessage<NamespaceConfig> =
  /*@__PURE__*/
 ...
 */
export const BadBinariesSchema: GenMessage<BadBinaries> =
  /*@__PURE__*/
 ...
 */
export const BadBinaryInfoSchema: GenMessage<BadBinaryInfo> =
  /*@__PURE__*/
 ...
 */
export const UpdateNamespaceInfoSchema: GenMessage<UpdateNamespaceInfo> =
  /*@__PURE__*/
 ...
 */
export const NamespaceFilterSchema: GenMessage<NamespaceFilter> =
  /*@__PURE__*/
