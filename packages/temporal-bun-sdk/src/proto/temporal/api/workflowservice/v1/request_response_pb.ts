...
import type { FastForwardPollingResult } from "../../enums/v1/time_skipping_pb.js";
import { file_temporal_api_enums_v1_time_skipping } from "../../enums/v1/time_skipping_pb.js";
...
import type { ActivityType, Callback, DataBlob, Execution, Header, Link, Memo, MeteringMetadata, OnConflictOptions as OnConflictOptions$1, Payload, Payloads, Priority, RetryPolicy, SearchAttributes, TimeSkippingConfig, TimeSkippingFastForwardInfo, WorkerSelector, WorkerVersionCapabilities, WorkerVersionStamp, WorkflowExecution, WorkflowType } from "../../common/v1/message_pb.js";
...
import { file_temporal_api_compute_v1_config } from "../../compute/v1/config_pb.js";
...
import type { BuildIdAssignmentRule, BuildIdReachability, CompatibleBuildIdRedirectRule, CompatibleVersionSet, PollerGroupInfo, PollerGroupsInfo, PollerInfo, PollerScalingDecision, RateLimit, StickyExecutionAttributes, TaskQueue, TaskQueueConfig, TaskQueueMetadata, TaskQueuePartitionMetadata, TaskQueueStats, TaskQueueStatus, TaskQueueVersionInfo, TaskQueueVersioningInfo, TaskQueueVersionSelection, TimestampedBuildIdAssignmentRule, TimestampedCompatibleBuildIdRedirectRule } from "../../taskqueue/v1/message_pb.js";
...
export const file_temporal_api_workflowservice_v1_request_response: GenFile = /*@__PURE__*/
  fileDesc("", [file_temporal_api_enums_v1_batch_operation, file_temporal_api_enums_v1_common, file_temporal_api_enums_v1_workflow, file_temporal_api_enums_v1_namespace, file_temporal_api_enums_v1_failed_cause, file_temporal_api_enums_v1_query, file_temporal_api_enums_v1_reset, file_temporal_api_enums_v1_task_queue, file_temporal_api_enums_v1_deployment, file_temporal_api_enums_v1_update, file_temporal_api_enums_v1_time_skipping, file_temporal_api_enums_v1_activity, file_temporal_api_enums_v1_nexus, file_temporal_api_activity_v1_message, file_temporal_api_common_v1_message, file_temporal_api_history_v1_message, file_temporal_api_workflow_v1_message, file_temporal_api_command_v1_message, file_temporal_api_compute_v1_config, file_temporal_api_deployment_v1_message, file_temporal_api_failure_v1_message, file_temporal_api_filter_v1_message, file_temporal_api_protocol_v1_message, file_temporal_api_namespace_v1_message, file_temporal_api_query_v1_message, file_temporal_api_replication_v1_message, file_temporal_api_rules_v1_message, file_temporal_api_sdk_v1_worker_config, file_temporal_api_schedule_v1_message, file_temporal_api_taskqueue_v1_message, file_temporal_api_update_v1_message, file_temporal_api_version_v1_message, file_temporal_api_batch_v1_message, file_temporal_api_sdk_v1_task_complete_metadata, file_temporal_api_sdk_v1_user_metadata, file_temporal_api_nexus_v1_message, file_temporal_api_worker_v1_message, file_google_protobuf_duration, file_google_protobuf_field_mask, file_google_protobuf_timestamp]);
...
export type DescribeNamespaceResponse = Message<"temporal.api.workflowservice.v1.DescribeNamespaceResponse"> & {
   ...
   * poll response.
   *
   * @generated from field: repeated temporal.api.taskqueue.v1.PollerGroupInfo poller_group_infos = 7 [deprecated = true];
   * @deprecated
   */
   ...
   *
   * @generated from field: temporal.api.taskqueue.v1.PollerGroupsInfo poller_groups_info = 8;
   */
  pollerGroupsInfo?: PollerGroupsInfo | undefined;
};
...
export type StartWorkflowExecutionRequest = Message<"temporal.api.workflowservice.v1.StartWorkflowExecutionRequest"> & {
   ...
   *
   * @generated from field: temporal.api.common.v1.TimeSkippingConfig time_skipping_config = 29;
   */
...
export type PollWorkflowTaskQueueResponse = Message<"temporal.api.workflowservice.v1.PollWorkflowTaskQueueResponse"> & {
   ...
   *
   * @generated from field: repeated temporal.api.taskqueue.v1.PollerGroupInfo poller_group_infos = 18 [deprecated = true];
   * @deprecated
   */
  pollerGroupInfos: PollerGroupInfo[];
   ...
   *     according to the weights.
   *
   * @generated from field: temporal.api.taskqueue.v1.PollerGroupsInfo poller_groups_info = 19;
   */
  pollerGroupsInfo?: PollerGroupsInfo | undefined;
};
...
export type RespondWorkflowTaskCompletedRequest = Message<"temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest"> & {
   ...
   *
   * @generated from field: int32 page_number = 21;
   */
  pageNumber: number;
   ...
   *
   * @generated from field: bool intermediate_page = 22;
   */
...
export type PollActivityTaskQueueResponse = Message<"temporal.api.workflowservice.v1.PollActivityTaskQueueResponse"> & {
   ...
   *     according to the weights.
   *
   * @generated from field: repeated temporal.api.taskqueue.v1.PollerGroupInfo poller_group_infos = 21 [deprecated = true];
   * @deprecated
   */
  pollerGroupInfos: PollerGroupInfo[];
   ...
   *     according to the weights.
   *
   * @generated from field: temporal.api.taskqueue.v1.PollerGroupsInfo poller_groups_info = 22;
   */
  pollerGroupsInfo?: PollerGroupsInfo | undefined;
};
...
export type SignalWithStartWorkflowExecutionRequest = Message<"temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionRequest"> & {
   ...
   * Time-skipping configuration. If not set, time skipping is disabled.
   *
   * @generated from field: temporal.api.common.v1.TimeSkippingConfig time_skipping_config = 27;
   */
  timeSkippingConfig?: TimeSkippingConfig | undefined;
};
...
export type SignalWithStartWorkflowExecutionResponse = Message<"temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse"> & {
   ...
   * If the workflow was started as a result of a de-dupe, this field will contain the run id of the first execution in the chain.
   *
   * @generated from field: string first_execution_run_id = 4;
   */
  firstExecutionRunId: string;
...
export type GetSystemInfoResponse_Capabilities = Message<"temporal.api.workflowservice.v1.GetSystemInfoResponse.Capabilities"> & {
   ...
   *
   * @generated from field: bool server_scaled_provider_cloud_run = 13;
   */
  serverScaledProviderCloudRun: boolean;
};
 ...
 */
export const CountSchedulesResponse_AggregationGroupSchema: GenMessage<CountSchedulesResponse_AggregationGroup> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 99, 0);
...
export const UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersionSchema: GenMessage<UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersion> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 100, 0);
...
export const UpdateWorkerBuildIdCompatibilityRequest_MergeSetsSchema: GenMessage<UpdateWorkerBuildIdCompatibilityRequest_MergeSets> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 100, 1);
...
export const UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 0);
...
export const UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 1);
...
export const UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 2);
...
export const UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 3);
...
export const UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 4);
...
export const UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRule> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 5);
...
export const UpdateWorkerVersioningRulesRequest_CommitBuildIdSchema: GenMessage<UpdateWorkerVersioningRulesRequest_CommitBuildId> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 104, 6);
...
export type StartBatchOperationRequest = Message<"temporal.api.workflowservice.v1.StartBatchOperationRequest"> & {
   ...
   *
   * @generated from field: repeated temporal.api.common.v1.WorkflowExecution executions = 5 [deprecated = true];
   * @deprecated
   */
   ...
   *
   * @generated from field: repeated temporal.api.common.v1.Execution target_executions = 22;
   */
  ...
  operation: {
    ...
    /**
     * @generated from field: temporal.api.batch.v1.BatchOperationCancelActivities cancel_activities_operation = 19;
     */
    value: BatchOperationCancelActivities;
    case: "cancelActivitiesOperation";
  } | {
    /**
     * @generated from field: temporal.api.batch.v1.BatchOperationTerminateActivities terminate_activities_operation = 20;
     */
    value: BatchOperationTerminateActivities;
    case: "terminateActivitiesOperation";
  } | {
    /**
     * @generated from field: temporal.api.batch.v1.BatchOperationDeleteActivities delete_activities_operation = 21;
     */
    value: BatchOperationDeleteActivities;
    case: "deleteActivitiesOperation";
  } | { case: undefined; value?: undefined };
};
...
export type DescribeBatchOperationResponse = Message<"temporal.api.workflowservice.v1.DescribeBatchOperationResponse"> & {
   ...
   *
   * @generated from field: repeated temporal.api.common.v1.Execution executions = 12;
   */
...
export type PollNexusTaskQueueResponse = Message<"temporal.api.workflowservice.v1.PollNexusTaskQueueResponse"> & {
   ...
   *     according to the weights.
   *
   * @generated from field: repeated temporal.api.taskqueue.v1.PollerGroupInfo poller_group_infos = 5 [deprecated = true];
   * @deprecated
   */
  pollerGroupInfos: PollerGroupInfo[];
   ...
   *     according to the weights.
   *
   * @generated from field: temporal.api.taskqueue.v1.PollerGroupsInfo poller_groups_info = 6;
   */
  pollerGroupsInfo?: PollerGroupsInfo | undefined;
};
...
export const ExecuteMultiOperationRequest_OperationSchema: GenMessage<ExecuteMultiOperationRequest_Operation> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 128, 0);
...
export const ExecuteMultiOperationResponse_ResponseSchema: GenMessage<ExecuteMultiOperationResponse_Response> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 129, 0);
 ...
 */
export const UpdateActivityExecutionOptionsRequestSchema: GenMessage<UpdateActivityExecutionOptionsRequest> = /*@__PURE__*/
 ...
 */
export const UpdateActivityExecutionOptionsResponseSchema: GenMessage<UpdateActivityExecutionOptionsResponse> = /*@__PURE__*/
 ...
 */
export const PauseActivityExecutionRequestSchema: GenMessage<PauseActivityExecutionRequest> = /*@__PURE__*/
 ...
 */
export const PauseActivityExecutionResponseSchema: GenMessage<PauseActivityExecutionResponse> = /*@__PURE__*/
 ...
 */
export const UnpauseActivityExecutionRequestSchema: GenMessage<UnpauseActivityExecutionRequest> = /*@__PURE__*/
 ...
 */
export const UnpauseActivityExecutionResponseSchema: GenMessage<UnpauseActivityExecutionResponse> = /*@__PURE__*/
...
export type ResetActivityExecutionRequest = Message<"temporal.api.workflowservice.v1.ResetActivityExecutionRequest"> & {
   ...
   *
   * @generated from field: bool reset_heartbeat = 11;
   */
  resetHeartbeat: boolean;
};
 ...
 */
export const ResetActivityExecutionRequestSchema: GenMessage<ResetActivityExecutionRequest> = /*@__PURE__*/
 ...
 */
export const ResetActivityExecutionResponseSchema: GenMessage<ResetActivityExecutionResponse> = /*@__PURE__*/
...
export const DescribeWorkerDeploymentVersionResponse_VersionTaskQueueSchema: GenMessage<DescribeWorkerDeploymentVersionResponse_VersionTaskQueue> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 151, 0);
 ...
 */
export const CreateWorkerDeploymentRequestSchema: GenMessage<CreateWorkerDeploymentRequest> = /*@__PURE__*/
 ...
 */
export const CreateWorkerDeploymentResponseSchema: GenMessage<CreateWorkerDeploymentResponse> = /*@__PURE__*/
...
export const ListWorkerDeploymentsResponse_WorkerDeploymentSummarySchema: GenMessage<ListWorkerDeploymentsResponse_WorkerDeploymentSummary> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 165, 0);
 ...
 */
export const CreateWorkerDeploymentVersionRequestSchema: GenMessage<CreateWorkerDeploymentVersionRequest> = /*@__PURE__*/
 ...
 */
export const CreateWorkerDeploymentVersionResponseSchema: GenMessage<CreateWorkerDeploymentVersionResponse> = /*@__PURE__*/
...
export type UpdateWorkerDeploymentVersionComputeConfigRequest = Message<"temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionComputeConfigRequest"> & {
   ...
   */
  computeConfigScalingGroups: { [key: string]: ComputeConfigScalingGroupUpdate };
 ...
 */
export const UpdateWorkerDeploymentVersionComputeConfigRequestSchema: GenMessage<UpdateWorkerDeploymentVersionComputeConfigRequest> = /*@__PURE__*/
 ...
 */
export const UpdateWorkerDeploymentVersionComputeConfigResponseSchema: GenMessage<UpdateWorkerDeploymentVersionComputeConfigResponse> = /*@__PURE__*/
 ...
 */
export const ValidateWorkerDeploymentVersionComputeConfigRequestSchema: GenMessage<ValidateWorkerDeploymentVersionComputeConfigRequest> = /*@__PURE__*/
 ...
 */
export const ValidateWorkerDeploymentVersionComputeConfigResponseSchema: GenMessage<ValidateWorkerDeploymentVersionComputeConfigResponse> = /*@__PURE__*/
...
export const UpdateTaskQueueConfigRequest_RateLimitUpdateSchema: GenMessage<UpdateTaskQueueConfigRequest_RateLimitUpdate> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 198, 0);
...
/**
 * @generated from message temporal.api.workflowservice.v1.CountWorkersRequest
 */
export type CountWorkersRequest = Message<"temporal.api.workflowservice.v1.CountWorkersRequest"> & {
  /**
   * @generated from field: string namespace = 1;
   */
  namespace: string;
   ...
   * by the server and not by the user. By default, system workers are excluded.
   *
   * @generated from field: bool include_system_workers = 3;
   */
  includeSystemWorkers: boolean;
};

/**
 * Describes the message temporal.api.workflowservice.v1.CountWorkersRequest.
 * Use `create(CountWorkersRequestSchema)` to create a new message.
 */
export const CountWorkersRequestSchema: GenMessage<CountWorkersRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 206);

/**
 * @generated from message temporal.api.workflowservice.v1.CountWorkersResponse
 */
export type CountWorkersResponse = Message<"temporal.api.workflowservice.v1.CountWorkersResponse"> & {
  /**
...
/**
 * Describes the message temporal.api.workflowservice.v1.CountWorkersResponse.
 * Use `create(CountWorkersResponseSchema)` to create a new message.
 */
export const CountWorkersResponseSchema: GenMessage<CountWorkersResponse> = /*@__PURE__*/
...
export const PauseWorkflowExecutionRequestSchema: GenMessage<PauseWorkflowExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 208);
...
export const PauseWorkflowExecutionResponseSchema: GenMessage<PauseWorkflowExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 209);
...
export const UnpauseWorkflowExecutionRequestSchema: GenMessage<UnpauseWorkflowExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 210);
...
export const UnpauseWorkflowExecutionResponseSchema: GenMessage<UnpauseWorkflowExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 211);
...
export const StartActivityExecutionRequestSchema: GenMessage<StartActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 212);
...
export const StartActivityExecutionResponseSchema: GenMessage<StartActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 213);
...
export type DescribeActivityExecutionRequest = Message<"temporal.api.workflowservice.v1.DescribeActivityExecutionRequest"> & {
   ...
   *
   * @generated from field: bool include_heartbeat_details = 7;
   */
   ...
   *
   * @generated from field: bool include_last_failure = 8;
   */
...
export const DescribeActivityExecutionRequestSchema: GenMessage<DescribeActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 214);
...
export const DescribeActivityExecutionResponseSchema: GenMessage<DescribeActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 215);
...
export const PollActivityExecutionRequestSchema: GenMessage<PollActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 216);
...
export const PollActivityExecutionResponseSchema: GenMessage<PollActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 217);
...
export const ListActivityExecutionsRequestSchema: GenMessage<ListActivityExecutionsRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 218);
...
export const ListActivityExecutionsResponseSchema: GenMessage<ListActivityExecutionsResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 219);
 ...
 */
export const StartNexusOperationExecutionRequestSchema: GenMessage<StartNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 220);
 ...
 */
export const StartNexusOperationExecutionResponseSchema: GenMessage<StartNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 221);
 ...
 */
export const DescribeNexusOperationExecutionRequestSchema: GenMessage<DescribeNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 222);
 ...
 */
export const DescribeNexusOperationExecutionResponseSchema: GenMessage<DescribeNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 223);
 ...
 */
export const PollNexusOperationExecutionRequestSchema: GenMessage<PollNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 224);
 ...
 */
export const PollNexusOperationExecutionResponseSchema: GenMessage<PollNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 225);
 ...
 */
export const ListNexusOperationExecutionsRequestSchema: GenMessage<ListNexusOperationExecutionsRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 226);
 ...
 */
export const ListNexusOperationExecutionsResponseSchema: GenMessage<ListNexusOperationExecutionsResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 227);
...
export const CountActivityExecutionsRequestSchema: GenMessage<CountActivityExecutionsRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 228);
...
export const CountActivityExecutionsResponseSchema: GenMessage<CountActivityExecutionsResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 229);
...
export const CountActivityExecutionsResponse_AggregationGroupSchema: GenMessage<CountActivityExecutionsResponse_AggregationGroup> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 229, 0);
 ...
 */
export const CountNexusOperationExecutionsRequestSchema: GenMessage<CountNexusOperationExecutionsRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 230);
 ...
 */
export const CountNexusOperationExecutionsResponseSchema: GenMessage<CountNexusOperationExecutionsResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 231);
 ...
 */
export const CountNexusOperationExecutionsResponse_AggregationGroupSchema: GenMessage<CountNexusOperationExecutionsResponse_AggregationGroup> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 231, 0);
...
export const RequestCancelActivityExecutionRequestSchema: GenMessage<RequestCancelActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 232);
...
export const RequestCancelActivityExecutionResponseSchema: GenMessage<RequestCancelActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 233);
...
export const TerminateActivityExecutionRequestSchema: GenMessage<TerminateActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 234);
...
export const TerminateActivityExecutionResponseSchema: GenMessage<TerminateActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 235);
...
export const DeleteActivityExecutionRequestSchema: GenMessage<DeleteActivityExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 236);
...
export const DeleteActivityExecutionResponseSchema: GenMessage<DeleteActivityExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 237);
 ...
 */
export const RequestCancelNexusOperationExecutionRequestSchema: GenMessage<RequestCancelNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 238);
 ...
 */
export const RequestCancelNexusOperationExecutionResponseSchema: GenMessage<RequestCancelNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 239);
 ...
 */
export const TerminateNexusOperationExecutionRequestSchema: GenMessage<TerminateNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 240);
 ...
 */
export const TerminateNexusOperationExecutionResponseSchema: GenMessage<TerminateNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 241);
 ...
 */
export const DeleteNexusOperationExecutionRequestSchema: GenMessage<DeleteNexusOperationExecutionRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 242);
 ...
 */
export const DeleteNexusOperationExecutionResponseSchema: GenMessage<DeleteNexusOperationExecutionResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 243);
 ...
 *
 * @generated from message temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingRequest
 */
export type PollWorkflowExecutionTimeSkippingRequest = Message<"temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingRequest"> & {
  /**
   * @generated from field: string namespace = 1;
   */
  namespace: string;
   ...
   *
   * @generated from field: string fast_forward_id = 3;
   */
  fastForwardId: string;
};

/**
 * Describes the message temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingRequest.
 * Use `create(PollWorkflowExecutionTimeSkippingRequestSchema)` to create a new message.
 */
export const PollWorkflowExecutionTimeSkippingRequestSchema: GenMessage<PollWorkflowExecutionTimeSkippingRequest> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 244);

/**
 * @generated from message temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingResponse
 */
export type PollWorkflowExecutionTimeSkippingResponse = Message<"temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingResponse"> & {
  /**
   * The outcome of the poll for the fast-forward identified by the request's `fast_forward_id`.
   *
   * @generated from field: temporal.api.enums.v1.FastForwardPollingResult fast_forward_polling_result = 1;
   */
   ...
   *
   * @generated from field: string failed_reason = 2;
   */
  failedReason: string;
   ...
   *
   * @generated from field: temporal.api.common.v1.TimeSkippingFastForwardInfo fast_forward_info = 3;
   */
  fastForwardInfo?: TimeSkippingFastForwardInfo | undefined;
};

/**
 * Describes the message temporal.api.workflowservice.v1.PollWorkflowExecutionTimeSkippingResponse.
 * Use `create(PollWorkflowExecutionTimeSkippingResponseSchema)` to create a new message.
 */
export const PollWorkflowExecutionTimeSkippingResponseSchema: GenMessage<PollWorkflowExecutionTimeSkippingResponse> = /*@__PURE__*/
  messageDesc(file_temporal_api_workflowservice_v1_request_response, 245);
