...
import type { BatchOperationState, BatchOperationType } from '../../enums/v1/batch_operation_pb.ts'
import { file_temporal_api_enums_v1_batch_operation } from '../../enums/v1/batch_operation_pb.ts'
...
import type { ArchivalState } from '../../enums/v1/namespace_pb.ts'
import { file_temporal_api_enums_v1_namespace } from '../../enums/v1/namespace_pb.ts'
import type { WorkflowTaskFailedCause } from '../../enums/v1/failed_cause_pb.ts'
import { file_temporal_api_enums_v1_failed_cause } from '../../enums/v1/failed_cause_pb.ts'
import type { QueryRejectCondition, QueryResultType } from '../../enums/v1/query_pb.ts'
import { file_temporal_api_enums_v1_query } from '../../enums/v1/query_pb.ts'
...
import type {
  ...
  TaskQueueType,
  TaskReachability,
} from '../../enums/v1/task_queue_pb.ts'
import { file_temporal_api_enums_v1_task_queue } from '../../enums/v1/task_queue_pb.ts'
import type { DeploymentReachability } from '../../enums/v1/deployment_pb.ts'
import { file_temporal_api_enums_v1_deployment } from '../../enums/v1/deployment_pb.ts'
...
import type { History } from '../../history/v1/message_pb.ts'
import { file_temporal_api_history_v1_message } from '../../history/v1/message_pb.ts'
import type {
  CallbackInfo,
  OnConflictOptions,
  PendingActivityInfo,
...
} from '../../workflow/v1/message_pb.ts'
import { file_temporal_api_workflow_v1_message } from '../../workflow/v1/message_pb.ts'
import type { Command } from '../../command/v1/message_pb.ts'
import { file_temporal_api_command_v1_message } from '../../command/v1/message_pb.ts'
import type {
  Deployment,
  DeploymentInfo,
  DeploymentListInfo,
...
} from '../../deployment/v1/message_pb.ts'
...
import type {
  ...
  WorkflowTypeFilter,
} from '../../filter/v1/message_pb.ts'
import { file_temporal_api_filter_v1_message } from '../../filter/v1/message_pb.ts'
import type { Message as Message$1 } from '../../protocol/v1/message_pb.ts'
import { file_temporal_api_protocol_v1_message } from '../../protocol/v1/message_pb.ts'
import type {
  NamespaceConfig,
  NamespaceFilter,
  NamespaceInfo,
  UpdateNamespaceInfo,
} from '../../namespace/v1/message_pb.ts'
import { file_temporal_api_namespace_v1_message } from '../../namespace/v1/message_pb.ts'
import type { QueryRejected, WorkflowQuery, WorkflowQueryResult } from '../../query/v1/message_pb.ts'
import { file_temporal_api_query_v1_message } from '../../query/v1/message_pb.ts'
import type {
  ClusterReplicationConfig,
  FailoverStatus,
  NamespaceReplicationConfig,
} from '../../replication/v1/message_pb.ts'
import { file_temporal_api_replication_v1_message } from '../../replication/v1/message_pb.ts'
import type { WorkflowRule, WorkflowRuleSpec } from '../../rules/v1/message_pb.ts'
import { file_temporal_api_rules_v1_message } from '../../rules/v1/message_pb.ts'
import type { WorkerConfig } from '../../sdk/v1/worker_config_pb.ts'
import { file_temporal_api_sdk_v1_worker_config } from '../../sdk/v1/worker_config_pb.ts'
import type { Schedule, ScheduleInfo, ScheduleListEntry, SchedulePatch } from '../../schedule/v1/message_pb.ts'
import { file_temporal_api_schedule_v1_message } from '../../schedule/v1/message_pb.ts'
import type {
...
} from '../../taskqueue/v1/message_pb.ts'
import { file_temporal_api_taskqueue_v1_message } from '../../taskqueue/v1/message_pb.ts'
import type { Outcome, Request, UpdateRef, WaitPolicy } from '../../update/v1/message_pb.ts'
import { file_temporal_api_update_v1_message } from '../../update/v1/message_pb.ts'
import type { VersionInfo } from '../../version/v1/message_pb.ts'
import { file_temporal_api_version_v1_message } from '../../version/v1/message_pb.ts'
import type {
...
} from '../../batch/v1/message_pb.ts'
import { file_temporal_api_batch_v1_message } from '../../batch/v1/message_pb.ts'
...
import type { HandlerError, Request as Request$1, Response } from '../../nexus/v1/message_pb.ts'
import { file_temporal_api_nexus_v1_message } from '../../nexus/v1/message_pb.ts'
import type { WorkerHeartbeat, WorkerInfo } from '../../worker/v1/message_pb.ts'
import { file_temporal_api_worker_v1_message } from '../../worker/v1/message_pb.ts'
...
export const file_temporal_api_workflowservice_v1_request_response: GenFile =
  ...
  fileDesc(
    ...
    [
      ...
      file_temporal_api_enums_v1_query,
      file_temporal_api_enums_v1_reset,
      file_temporal_api_enums_v1_task_queue,
      file_temporal_api_enums_v1_deployment,
      ...
      file_temporal_api_command_v1_message,
      file_temporal_api_deployment_v1_message,
      file_temporal_api_failure_v1_message,
      file_temporal_api_filter_v1_message,
      file_temporal_api_protocol_v1_message,
      file_temporal_api_namespace_v1_message,
      file_temporal_api_query_v1_message,
      file_temporal_api_replication_v1_message,
      file_temporal_api_rules_v1_message,
      file_temporal_api_sdk_v1_worker_config,
      file_temporal_api_schedule_v1_message,
      file_temporal_api_taskqueue_v1_message,
      file_temporal_api_update_v1_message,
      file_temporal_api_version_v1_message,
      file_temporal_api_batch_v1_message,
      file_temporal_api_sdk_v1_task_complete_metadata,
      file_temporal_api_sdk_v1_user_metadata,
      file_temporal_api_nexus_v1_message,
 ...
 */
export const RegisterNamespaceRequestSchema: GenMessage<RegisterNamespaceRequest> =
  /*@__PURE__*/
 ...
 */
export const RegisterNamespaceResponseSchema: GenMessage<RegisterNamespaceResponse> =
  /*@__PURE__*/
 ...
 */
export const ListNamespacesRequestSchema: GenMessage<ListNamespacesRequest> =
  /*@__PURE__*/
 ...
 */
export const ListNamespacesResponseSchema: GenMessage<ListNamespacesResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeNamespaceRequestSchema: GenMessage<DescribeNamespaceRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeNamespaceResponseSchema: GenMessage<DescribeNamespaceResponse> =
  /*@__PURE__*/
 ...
 */
export const UpdateNamespaceRequestSchema: GenMessage<UpdateNamespaceRequest> =
  /*@__PURE__*/
 ...
 */
export const UpdateNamespaceResponseSchema: GenMessage<UpdateNamespaceResponse> =
  /*@__PURE__*/
 ...
 */
export const DeprecateNamespaceRequestSchema: GenMessage<DeprecateNamespaceRequest> =
  /*@__PURE__*/
 ...
 */
export const DeprecateNamespaceResponseSchema: GenMessage<DeprecateNamespaceResponse> =
  /*@__PURE__*/
 ...
 */
export const StartWorkflowExecutionRequestSchema: GenMessage<StartWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type StartWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.StartWorkflowExecutionResponse'> & {
    /**
 ...
 */
export const StartWorkflowExecutionResponseSchema: GenMessage<StartWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const GetWorkflowExecutionHistoryRequestSchema: GenMessage<GetWorkflowExecutionHistoryRequest> =
  /*@__PURE__*/
...
export type GetWorkflowExecutionHistoryResponse =
  Message<'temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryResponse'> & {
    /**
 ...
 */
export const GetWorkflowExecutionHistoryResponseSchema: GenMessage<GetWorkflowExecutionHistoryResponse> =
  /*@__PURE__*/
 ...
 */
export type GetWorkflowExecutionHistoryReverseRequest =
  Message<'temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const GetWorkflowExecutionHistoryReverseRequestSchema: GenMessage<GetWorkflowExecutionHistoryReverseRequest> =
  /*@__PURE__*/
...
export type GetWorkflowExecutionHistoryReverseResponse =
  Message<'temporal.api.workflowservice.v1.GetWorkflowExecutionHistoryReverseResponse'> & {
    /**
     * @generated from field: temporal.api.history.v1.History history = 1;
     */
    history?: History
 ...
 */
export const GetWorkflowExecutionHistoryReverseResponseSchema: GenMessage<GetWorkflowExecutionHistoryReverseResponse> =
  /*@__PURE__*/
 ...
 */
export const PollWorkflowTaskQueueRequestSchema: GenMessage<PollWorkflowTaskQueueRequest> =
  /*@__PURE__*/
 ...
 */
export const PollWorkflowTaskQueueResponseSchema: GenMessage<PollWorkflowTaskQueueResponse> =
  /*@__PURE__*/
 ...
 */
export type RespondWorkflowTaskCompletedRequest =
  Message<'temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest'> & {
    /**
 ...
 */
export const RespondWorkflowTaskCompletedRequestSchema: GenMessage<RespondWorkflowTaskCompletedRequest> =
  /*@__PURE__*/
 ...
 */
export type RespondWorkflowTaskCompletedRequest_Capabilities =
  Message<'temporal.api.workflowservice.v1.RespondWorkflowTaskCompletedRequest.Capabilities'> & {
    /**
 ...
 */
export const RespondWorkflowTaskCompletedRequest_CapabilitiesSchema: GenMessage<RespondWorkflowTaskCompletedRequest_Capabilities> =
  /*@__PURE__*/
 ...
 */
export type RespondWorkflowTaskCompletedResponse =
 ...
 */
export const RespondWorkflowTaskCompletedResponseSchema: GenMessage<RespondWorkflowTaskCompletedResponse> =
  /*@__PURE__*/
 ...
 */
export type RespondWorkflowTaskFailedRequest =
  Message<'temporal.api.workflowservice.v1.RespondWorkflowTaskFailedRequest'> & {
    /**
     * The task token as received in `PollWorkflowTaskQueueResponse`
     *
     * @generated from field: bytes task_token = 1;
 ...
 */
export const RespondWorkflowTaskFailedRequestSchema: GenMessage<RespondWorkflowTaskFailedRequest> =
  /*@__PURE__*/
 ...
 */
export type RespondWorkflowTaskFailedResponse =
 ...
 */
export const RespondWorkflowTaskFailedResponseSchema: GenMessage<RespondWorkflowTaskFailedResponse> =
  /*@__PURE__*/
 ...
 */
export const PollActivityTaskQueueRequestSchema: GenMessage<PollActivityTaskQueueRequest> =
  /*@__PURE__*/
 ...
 */
export const PollActivityTaskQueueResponseSchema: GenMessage<PollActivityTaskQueueResponse> =
  /*@__PURE__*/
 ...
 */
export const RecordActivityTaskHeartbeatRequestSchema: GenMessage<RecordActivityTaskHeartbeatRequest> =
  /*@__PURE__*/
...
export type RecordActivityTaskHeartbeatResponse =
  Message<'temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatResponse'> & {
    /**
 ...
 */
export const RecordActivityTaskHeartbeatResponseSchema: GenMessage<RecordActivityTaskHeartbeatResponse> =
  /*@__PURE__*/
...
export type RecordActivityTaskHeartbeatByIdRequest =
  Message<'temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdRequest'> & {
    /**
 ...
 */
export const RecordActivityTaskHeartbeatByIdRequestSchema: GenMessage<RecordActivityTaskHeartbeatByIdRequest> =
  /*@__PURE__*/
...
export type RecordActivityTaskHeartbeatByIdResponse =
  Message<'temporal.api.workflowservice.v1.RecordActivityTaskHeartbeatByIdResponse'> & {
    /**
     * Will be set to true if the activity has been asked to cancel itself. The SDK should then
     * notify the activity of cancellation if it is still running.
     *
 ...
 */
export const RecordActivityTaskHeartbeatByIdResponseSchema: GenMessage<RecordActivityTaskHeartbeatByIdResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskCompletedRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCompletedRequest'> & {
    /**
     * The task token as received in `PollActivityTaskQueueResponse`
     *
     * @generated from field: bytes task_token = 1;
 ...
 */
export const RespondActivityTaskCompletedRequestSchema: GenMessage<RespondActivityTaskCompletedRequest> =
  /*@__PURE__*/
...
export type RespondActivityTaskCompletedResponse =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCompletedResponse'> & {}
 ...
 */
export const RespondActivityTaskCompletedResponseSchema: GenMessage<RespondActivityTaskCompletedResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskCompletedByIdRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCompletedByIdRequest'> & {
    /**
     * Namespace of the workflow which scheduled this activity
     *
     * @generated from field: string namespace = 1;
 ...
 */
export const RespondActivityTaskCompletedByIdRequestSchema: GenMessage<RespondActivityTaskCompletedByIdRequest> =
  /*@__PURE__*/
 ...
 */
export const RespondActivityTaskCompletedByIdResponseSchema: GenMessage<RespondActivityTaskCompletedByIdResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskFailedRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskFailedRequest'> & {
    /**
     * The task token as received in `PollActivityTaskQueueResponse`
     *
     * @generated from field: bytes task_token = 1;
 ...
 */
export const RespondActivityTaskFailedRequestSchema: GenMessage<RespondActivityTaskFailedRequest> =
  /*@__PURE__*/
...
export type RespondActivityTaskFailedResponse =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskFailedResponse'> & {
    /**
 ...
 */
export const RespondActivityTaskFailedResponseSchema: GenMessage<RespondActivityTaskFailedResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskFailedByIdRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdRequest'> & {
    /**
     * Namespace of the workflow which scheduled this activity
     *
     * @generated from field: string namespace = 1;
 ...
 */
export const RespondActivityTaskFailedByIdRequestSchema: GenMessage<RespondActivityTaskFailedByIdRequest> =
  /*@__PURE__*/
...
export type RespondActivityTaskFailedByIdResponse =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskFailedByIdResponse'> & {
    /**
     * Server validation failures could include
     * last_heartbeat_details payload is too large, request failure is too large
     *
 ...
 */
export const RespondActivityTaskFailedByIdResponseSchema: GenMessage<RespondActivityTaskFailedByIdResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskCanceledRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCanceledRequest'> & {
    /**
     * The task token as received in `PollActivityTaskQueueResponse`
     *
     * @generated from field: bytes task_token = 1;
 ...
 */
export const RespondActivityTaskCanceledRequestSchema: GenMessage<RespondActivityTaskCanceledRequest> =
  /*@__PURE__*/
...
export type RespondActivityTaskCanceledResponse =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCanceledResponse'> & {}
 ...
 */
export const RespondActivityTaskCanceledResponseSchema: GenMessage<RespondActivityTaskCanceledResponse> =
  /*@__PURE__*/
...
export type RespondActivityTaskCanceledByIdRequest =
  Message<'temporal.api.workflowservice.v1.RespondActivityTaskCanceledByIdRequest'> & {
    /**
     * Namespace of the workflow which scheduled this activity
     *
     * @generated from field: string namespace = 1;
 ...
 */
export const RespondActivityTaskCanceledByIdRequestSchema: GenMessage<RespondActivityTaskCanceledByIdRequest> =
  /*@__PURE__*/
 ...
 */
export const RespondActivityTaskCanceledByIdResponseSchema: GenMessage<RespondActivityTaskCanceledByIdResponse> =
  /*@__PURE__*/
...
export type RequestCancelWorkflowExecutionRequest =
  Message<'temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const RequestCancelWorkflowExecutionRequestSchema: GenMessage<RequestCancelWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type RequestCancelWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.RequestCancelWorkflowExecutionResponse'> & {}
 ...
 */
export const RequestCancelWorkflowExecutionResponseSchema: GenMessage<RequestCancelWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const SignalWorkflowExecutionRequestSchema: GenMessage<SignalWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type SignalWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.SignalWorkflowExecutionResponse'> & {}
 ...
 */
export const SignalWorkflowExecutionResponseSchema: GenMessage<SignalWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const SignalWithStartWorkflowExecutionRequestSchema: GenMessage<SignalWithStartWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type SignalWithStartWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.SignalWithStartWorkflowExecutionResponse'> & {
    /**
 ...
 */
export const SignalWithStartWorkflowExecutionResponseSchema: GenMessage<SignalWithStartWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const ResetWorkflowExecutionRequestSchema: GenMessage<ResetWorkflowExecutionRequest> =
  /*@__PURE__*/
 ...
 */
export const ResetWorkflowExecutionResponseSchema: GenMessage<ResetWorkflowExecutionResponse> =
  /*@__PURE__*/
...
export type TerminateWorkflowExecutionRequest =
  Message<'temporal.api.workflowservice.v1.TerminateWorkflowExecutionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const TerminateWorkflowExecutionRequestSchema: GenMessage<TerminateWorkflowExecutionRequest> =
  /*@__PURE__*/
 ...
 */
export const TerminateWorkflowExecutionResponseSchema: GenMessage<TerminateWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const DeleteWorkflowExecutionRequestSchema: GenMessage<DeleteWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type DeleteWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.DeleteWorkflowExecutionResponse'> & {}
 ...
 */
export const DeleteWorkflowExecutionResponseSchema: GenMessage<DeleteWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export type ListOpenWorkflowExecutionsRequest =
  Message<'temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const ListOpenWorkflowExecutionsRequestSchema: GenMessage<ListOpenWorkflowExecutionsRequest> =
  /*@__PURE__*/
 ...
 */
export type ListOpenWorkflowExecutionsResponse =
  Message<'temporal.api.workflowservice.v1.ListOpenWorkflowExecutionsResponse'> & {
    /**
 ...
 */
export const ListOpenWorkflowExecutionsResponseSchema: GenMessage<ListOpenWorkflowExecutionsResponse> =
  /*@__PURE__*/
 ...
 */
export type ListClosedWorkflowExecutionsRequest =
  Message<'temporal.api.workflowservice.v1.ListClosedWorkflowExecutionsRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const ListClosedWorkflowExecutionsRequestSchema: GenMessage<ListClosedWorkflowExecutionsRequest> =
  /*@__PURE__*/
 ...
 */
export type ListClosedWorkflowExecutionsResponse =
 ...
 */
export const ListClosedWorkflowExecutionsResponseSchema: GenMessage<ListClosedWorkflowExecutionsResponse> =
  /*@__PURE__*/
...
export type ListWorkflowExecutionsResponse =
  Message<'temporal.api.workflowservice.v1.ListWorkflowExecutionsResponse'> & {
    /**
     * @generated from field: repeated temporal.api.workflow.v1.WorkflowExecutionInfo executions = 1;
     */
    executions: WorkflowExecutionInfo[]
 ...
 */
export const ListWorkflowExecutionsResponseSchema: GenMessage<ListWorkflowExecutionsResponse> =
  /*@__PURE__*/
 ...
 */
export type ListArchivedWorkflowExecutionsRequest =
  Message<'temporal.api.workflowservice.v1.ListArchivedWorkflowExecutionsRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const ListArchivedWorkflowExecutionsRequestSchema: GenMessage<ListArchivedWorkflowExecutionsRequest> =
  /*@__PURE__*/
 ...
 */
export type ListArchivedWorkflowExecutionsResponse =
  Message<'temporal.api.workflowservice.v1.ListArchivedWorkflowExecutionsResponse'> & {
    /**
     * @generated from field: repeated temporal.api.workflow.v1.WorkflowExecutionInfo executions = 1;
     */
    executions: WorkflowExecutionInfo[]
 ...
 */
export const ListArchivedWorkflowExecutionsResponseSchema: GenMessage<ListArchivedWorkflowExecutionsResponse> =
  /*@__PURE__*/
 ...
 */
export const ScanWorkflowExecutionsRequestSchema: GenMessage<ScanWorkflowExecutionsRequest> =
  /*@__PURE__*/
 ...
 */
export type ScanWorkflowExecutionsResponse =
  Message<'temporal.api.workflowservice.v1.ScanWorkflowExecutionsResponse'> & {
    /**
     * @generated from field: repeated temporal.api.workflow.v1.WorkflowExecutionInfo executions = 1;
     */
    executions: WorkflowExecutionInfo[]
 ...
 */
export const ScanWorkflowExecutionsResponseSchema: GenMessage<ScanWorkflowExecutionsResponse> =
  /*@__PURE__*/
 ...
 */
export type CountWorkflowExecutionsRequest =
 ...
 */
export const CountWorkflowExecutionsRequestSchema: GenMessage<CountWorkflowExecutionsRequest> =
  /*@__PURE__*/
...
export type CountWorkflowExecutionsResponse =
  Message<'temporal.api.workflowservice.v1.CountWorkflowExecutionsResponse'> & {
    /**
 ...
 */
export const CountWorkflowExecutionsResponseSchema: GenMessage<CountWorkflowExecutionsResponse> =
  /*@__PURE__*/
 ...
 */
export type CountWorkflowExecutionsResponse_AggregationGroup =
 ...
 */
export const CountWorkflowExecutionsResponse_AggregationGroupSchema: GenMessage<CountWorkflowExecutionsResponse_AggregationGroup> =
  /*@__PURE__*/
 ...
 */
export const GetSearchAttributesRequestSchema: GenMessage<GetSearchAttributesRequest> =
  /*@__PURE__*/
 ...
 */
export const GetSearchAttributesResponseSchema: GenMessage<GetSearchAttributesResponse> =
  /*@__PURE__*/
 ...
 */
export type RespondQueryTaskCompletedRequest =
 ...
 */
export const RespondQueryTaskCompletedRequestSchema: GenMessage<RespondQueryTaskCompletedRequest> =
  /*@__PURE__*/
 ...
 */
export type RespondQueryTaskCompletedResponse =
  Message<'temporal.api.workflowservice.v1.RespondQueryTaskCompletedResponse'> & {}
 ...
 */
export const RespondQueryTaskCompletedResponseSchema: GenMessage<RespondQueryTaskCompletedResponse> =
  /*@__PURE__*/
 ...
 */
export const ResetStickyTaskQueueRequestSchema: GenMessage<ResetStickyTaskQueueRequest> =
  /*@__PURE__*/
 ...
 */
export const ResetStickyTaskQueueResponseSchema: GenMessage<ResetStickyTaskQueueResponse> =
  /*@__PURE__*/
 ...
 */
export const ShutdownWorkerRequestSchema: GenMessage<ShutdownWorkerRequest> =
  /*@__PURE__*/
 ...
 */
export const ShutdownWorkerResponseSchema: GenMessage<ShutdownWorkerResponse> =
  /*@__PURE__*/
 ...
 */
export const QueryWorkflowRequestSchema: GenMessage<QueryWorkflowRequest> =
  /*@__PURE__*/
 ...
 */
export const QueryWorkflowResponseSchema: GenMessage<QueryWorkflowResponse> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkflowExecutionRequest =
  Message<'temporal.api.workflowservice.v1.DescribeWorkflowExecutionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const DescribeWorkflowExecutionRequestSchema: GenMessage<DescribeWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type DescribeWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.DescribeWorkflowExecutionResponse'> & {
    /**
 ...
 */
export const DescribeWorkflowExecutionResponseSchema: GenMessage<DescribeWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeTaskQueueRequestSchema: GenMessage<DescribeTaskQueueRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeTaskQueueResponseSchema: GenMessage<DescribeTaskQueueResponse> =
  /*@__PURE__*/
 ...
 */
export type DescribeTaskQueueResponse_EffectiveRateLimit =
  Message<'temporal.api.workflowservice.v1.DescribeTaskQueueResponse.EffectiveRateLimit'> & {
    /**
 ...
 */
export const DescribeTaskQueueResponse_EffectiveRateLimitSchema: GenMessage<DescribeTaskQueueResponse_EffectiveRateLimit> =
  /*@__PURE__*/
 ...
 */
export const GetClusterInfoRequestSchema: GenMessage<GetClusterInfoRequest> =
  /*@__PURE__*/
 ...
 */
export const GetClusterInfoResponseSchema: GenMessage<GetClusterInfoResponse> =
  /*@__PURE__*/
 ...
 */
export const GetSystemInfoRequestSchema: GenMessage<GetSystemInfoRequest> =
  /*@__PURE__*/
 ...
 */
export const GetSystemInfoResponseSchema: GenMessage<GetSystemInfoResponse> =
  /*@__PURE__*/
...
export type GetSystemInfoResponse_Capabilities =
  Message<'temporal.api.workflowservice.v1.GetSystemInfoResponse.Capabilities'> & {
    /**
 ...
 */
export const GetSystemInfoResponse_CapabilitiesSchema: GenMessage<GetSystemInfoResponse_Capabilities> =
  /*@__PURE__*/
 ...
 */
export const ListTaskQueuePartitionsRequestSchema: GenMessage<ListTaskQueuePartitionsRequest> =
  /*@__PURE__*/
 ...
 */
export type ListTaskQueuePartitionsResponse =
  Message<'temporal.api.workflowservice.v1.ListTaskQueuePartitionsResponse'> & {
    /**
 ...
 */
export const ListTaskQueuePartitionsResponseSchema: GenMessage<ListTaskQueuePartitionsResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeScheduleRequestSchema: GenMessage<DescribeScheduleRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeScheduleResponseSchema: GenMessage<DescribeScheduleResponse> =
  /*@__PURE__*/
 ...
 */
export const PatchScheduleRequestSchema: GenMessage<PatchScheduleRequest> =
  /*@__PURE__*/
 ...
 */
export const PatchScheduleResponseSchema: GenMessage<PatchScheduleResponse> =
  /*@__PURE__*/
 ...
 */
export type ListScheduleMatchingTimesRequest =
  Message<'temporal.api.workflowservice.v1.ListScheduleMatchingTimesRequest'> & {
    /**
 ...
 */
export const ListScheduleMatchingTimesRequestSchema: GenMessage<ListScheduleMatchingTimesRequest> =
  /*@__PURE__*/
...
export type ListScheduleMatchingTimesResponse =
  Message<'temporal.api.workflowservice.v1.ListScheduleMatchingTimesResponse'> & {
    /**
 ...
 */
export const ListScheduleMatchingTimesResponseSchema: GenMessage<ListScheduleMatchingTimesResponse> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerBuildIdCompatibilityRequest =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const UpdateWorkerBuildIdCompatibilityRequestSchema: GenMessage<UpdateWorkerBuildIdCompatibilityRequest> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersion =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.AddNewCompatibleVersion'> & {
    /**
 ...
 */
export const UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersionSchema: GenMessage<UpdateWorkerBuildIdCompatibilityRequest_AddNewCompatibleVersion> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerBuildIdCompatibilityRequest_MergeSets =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerBuildIdCompatibilityRequest.MergeSets'> & {
    /**
 ...
 */
export const UpdateWorkerBuildIdCompatibilityRequest_MergeSetsSchema: GenMessage<UpdateWorkerBuildIdCompatibilityRequest_MergeSets> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerBuildIdCompatibilityResponse =
 ...
 */
export const UpdateWorkerBuildIdCompatibilityResponseSchema: GenMessage<UpdateWorkerBuildIdCompatibilityResponse> =
  /*@__PURE__*/
 ...
 */
export type GetWorkerBuildIdCompatibilityRequest =
  Message<'temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const GetWorkerBuildIdCompatibilityRequestSchema: GenMessage<GetWorkerBuildIdCompatibilityRequest> =
  /*@__PURE__*/
...
export type GetWorkerBuildIdCompatibilityResponse =
  Message<'temporal.api.workflowservice.v1.GetWorkerBuildIdCompatibilityResponse'> & {
    /**
 ...
 */
export const GetWorkerBuildIdCompatibilityResponseSchema: GenMessage<GetWorkerBuildIdCompatibilityResponse> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const UpdateWorkerVersioningRulesRequestSchema: GenMessage<UpdateWorkerVersioningRulesRequest> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRule =
 ...
 */
export const UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_InsertBuildIdAssignmentRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRule =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceBuildIdAssignmentRule'> & {
    /**
     * @generated from field: int32 rule_index = 1;
     */
    ruleIndex: number
 ...
 */
export const UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_ReplaceBuildIdAssignmentRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRule =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteBuildIdAssignmentRule'> & {
    /**
     * @generated from field: int32 rule_index = 1;
     */
    ruleIndex: number
 ...
 */
export const UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_DeleteBuildIdAssignmentRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRule =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.AddCompatibleBuildIdRedirectRule'> & {
    /**
 ...
 */
export const UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_AddCompatibleBuildIdRedirectRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRule =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.ReplaceCompatibleBuildIdRedirectRule'> & {
    /**
     * @generated from field: temporal.api.taskqueue.v1.CompatibleBuildIdRedirectRule rule = 1;
     */
    rule?: CompatibleBuildIdRedirectRule
 ...
 */
export const UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_ReplaceCompatibleBuildIdRedirectRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRule =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.DeleteCompatibleBuildIdRedirectRule'> & {
    /**
 ...
 */
export const UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRuleSchema: GenMessage<UpdateWorkerVersioningRulesRequest_DeleteCompatibleBuildIdRedirectRule> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesRequest_CommitBuildId =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesRequest.CommitBuildId'> & {
    /**
 ...
 */
export const UpdateWorkerVersioningRulesRequest_CommitBuildIdSchema: GenMessage<UpdateWorkerVersioningRulesRequest_CommitBuildId> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerVersioningRulesResponse =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerVersioningRulesResponse'> & {
    /**
 ...
 */
export const UpdateWorkerVersioningRulesResponseSchema: GenMessage<UpdateWorkerVersioningRulesResponse> =
  /*@__PURE__*/
 ...
 */
export type GetWorkerVersioningRulesRequest =
  Message<'temporal.api.workflowservice.v1.GetWorkerVersioningRulesRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const GetWorkerVersioningRulesRequestSchema: GenMessage<GetWorkerVersioningRulesRequest> =
  /*@__PURE__*/
 ...
 */
export const GetWorkerVersioningRulesResponseSchema: GenMessage<GetWorkerVersioningRulesResponse> =
  /*@__PURE__*/
 ...
 */
export type GetWorkerTaskReachabilityRequest =
 ...
 */
export const GetWorkerTaskReachabilityRequestSchema: GenMessage<GetWorkerTaskReachabilityRequest> =
  /*@__PURE__*/
...
export type GetWorkerTaskReachabilityResponse =
  Message<'temporal.api.workflowservice.v1.GetWorkerTaskReachabilityResponse'> & {
    /**
 ...
 */
export const GetWorkerTaskReachabilityResponseSchema: GenMessage<GetWorkerTaskReachabilityResponse> =
  /*@__PURE__*/
...
export type UpdateWorkflowExecutionRequest =
  Message<'temporal.api.workflowservice.v1.UpdateWorkflowExecutionRequest'> & {
    /**
 ...
 */
export const UpdateWorkflowExecutionRequestSchema: GenMessage<UpdateWorkflowExecutionRequest> =
  /*@__PURE__*/
...
export type UpdateWorkflowExecutionResponse =
  Message<'temporal.api.workflowservice.v1.UpdateWorkflowExecutionResponse'> & {
    /**
 ...
 */
export const UpdateWorkflowExecutionResponseSchema: GenMessage<UpdateWorkflowExecutionResponse> =
  /*@__PURE__*/
 ...
 */
export const StartBatchOperationRequestSchema: GenMessage<StartBatchOperationRequest> =
  /*@__PURE__*/
 ...
 */
export const StartBatchOperationResponseSchema: GenMessage<StartBatchOperationResponse> =
  /*@__PURE__*/
 ...
 */
export const StopBatchOperationRequestSchema: GenMessage<StopBatchOperationRequest> =
  /*@__PURE__*/
 ...
 */
export const StopBatchOperationResponseSchema: GenMessage<StopBatchOperationResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeBatchOperationRequestSchema: GenMessage<DescribeBatchOperationRequest> =
  /*@__PURE__*/
...
export type DescribeBatchOperationResponse =
  Message<'temporal.api.workflowservice.v1.DescribeBatchOperationResponse'> & {
    /**
 ...
 */
export const DescribeBatchOperationResponseSchema: GenMessage<DescribeBatchOperationResponse> =
  /*@__PURE__*/
 ...
 */
export const ListBatchOperationsRequestSchema: GenMessage<ListBatchOperationsRequest> =
  /*@__PURE__*/
 ...
 */
export const ListBatchOperationsResponseSchema: GenMessage<ListBatchOperationsResponse> =
  /*@__PURE__*/
 ...
 */
export type PollWorkflowExecutionUpdateRequest =
  Message<'temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateRequest'> & {
    /**
 ...
 */
export const PollWorkflowExecutionUpdateRequestSchema: GenMessage<PollWorkflowExecutionUpdateRequest> =
  /*@__PURE__*/
 ...
 */
export type PollWorkflowExecutionUpdateResponse =
  Message<'temporal.api.workflowservice.v1.PollWorkflowExecutionUpdateResponse'> & {
    /**
 ...
 */
export const PollWorkflowExecutionUpdateResponseSchema: GenMessage<PollWorkflowExecutionUpdateResponse> =
  /*@__PURE__*/
 ...
 */
export const PollNexusTaskQueueRequestSchema: GenMessage<PollNexusTaskQueueRequest> =
  /*@__PURE__*/
 ...
 */
export const PollNexusTaskQueueResponseSchema: GenMessage<PollNexusTaskQueueResponse> =
  /*@__PURE__*/
 ...
 */
export type RespondNexusTaskCompletedRequest =
  Message<'temporal.api.workflowservice.v1.RespondNexusTaskCompletedRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const RespondNexusTaskCompletedRequestSchema: GenMessage<RespondNexusTaskCompletedRequest> =
  /*@__PURE__*/
 ...
 */
export type RespondNexusTaskCompletedResponse =
  Message<'temporal.api.workflowservice.v1.RespondNexusTaskCompletedResponse'> & {}
 ...
 */
export const RespondNexusTaskCompletedResponseSchema: GenMessage<RespondNexusTaskCompletedResponse> =
  /*@__PURE__*/
 ...
 */
export const RespondNexusTaskFailedRequestSchema: GenMessage<RespondNexusTaskFailedRequest> =
  /*@__PURE__*/
 ...
 */
export type RespondNexusTaskFailedResponse =
  Message<'temporal.api.workflowservice.v1.RespondNexusTaskFailedResponse'> & {}
 ...
 */
export const RespondNexusTaskFailedResponseSchema: GenMessage<RespondNexusTaskFailedResponse> =
  /*@__PURE__*/
 ...
 */
export const ExecuteMultiOperationRequestSchema: GenMessage<ExecuteMultiOperationRequest> =
  /*@__PURE__*/
...
export type ExecuteMultiOperationRequest_Operation =
  Message<'temporal.api.workflowservice.v1.ExecuteMultiOperationRequest.Operation'> & {
    /**
 ...
 */
export const ExecuteMultiOperationRequest_OperationSchema: GenMessage<ExecuteMultiOperationRequest_Operation> =
  /*@__PURE__*/
 ...
 */
export const ExecuteMultiOperationResponseSchema: GenMessage<ExecuteMultiOperationResponse> =
  /*@__PURE__*/
 ...
 */
export type ExecuteMultiOperationResponse_Response =
  Message<'temporal.api.workflowservice.v1.ExecuteMultiOperationResponse.Response'> & {
    /**
 ...
 */
export const ExecuteMultiOperationResponse_ResponseSchema: GenMessage<ExecuteMultiOperationResponse_Response> =
  /*@__PURE__*/
 ...
 */
export const UpdateActivityOptionsRequestSchema: GenMessage<UpdateActivityOptionsRequest> =
  /*@__PURE__*/
 ...
 */
export const UpdateActivityOptionsResponseSchema: GenMessage<UpdateActivityOptionsResponse> =
  /*@__PURE__*/
 ...
 */
export const PauseActivityRequestSchema: GenMessage<PauseActivityRequest> =
  /*@__PURE__*/
 ...
 */
export const PauseActivityResponseSchema: GenMessage<PauseActivityResponse> =
  /*@__PURE__*/
 ...
 */
export const UnpauseActivityRequestSchema: GenMessage<UnpauseActivityRequest> =
  /*@__PURE__*/
 ...
 */
export const UnpauseActivityResponseSchema: GenMessage<UnpauseActivityResponse> =
  /*@__PURE__*/
 ...
 */
export const ResetActivityRequestSchema: GenMessage<ResetActivityRequest> =
  /*@__PURE__*/
 ...
 */
export const ResetActivityResponseSchema: GenMessage<ResetActivityResponse> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkflowExecutionOptionsRequest =
  Message<'temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsRequest'> & {
    /**
     * The namespace name of the target Workflow.
     *
     * @generated from field: string namespace = 1;
 ...
 */
export const UpdateWorkflowExecutionOptionsRequestSchema: GenMessage<UpdateWorkflowExecutionOptionsRequest> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkflowExecutionOptionsResponse =
  Message<'temporal.api.workflowservice.v1.UpdateWorkflowExecutionOptionsResponse'> & {
    /**
 ...
 */
export const UpdateWorkflowExecutionOptionsResponseSchema: GenMessage<UpdateWorkflowExecutionOptionsResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeDeploymentRequestSchema: GenMessage<DescribeDeploymentRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeDeploymentResponseSchema: GenMessage<DescribeDeploymentResponse> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkerDeploymentVersionRequest =
  Message<'temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const DescribeWorkerDeploymentVersionRequestSchema: GenMessage<DescribeWorkerDeploymentVersionRequest> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkerDeploymentVersionResponse =
  Message<'temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse'> & {
    /**
 ...
 */
export const DescribeWorkerDeploymentVersionResponseSchema: GenMessage<DescribeWorkerDeploymentVersionResponse> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkerDeploymentVersionResponse_VersionTaskQueue =
  Message<'temporal.api.workflowservice.v1.DescribeWorkerDeploymentVersionResponse.VersionTaskQueue'> & {
    /**
 ...
 */
export const DescribeWorkerDeploymentVersionResponse_VersionTaskQueueSchema: GenMessage<DescribeWorkerDeploymentVersionResponse_VersionTaskQueue> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkerDeploymentRequest =
  Message<'temporal.api.workflowservice.v1.DescribeWorkerDeploymentRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const DescribeWorkerDeploymentRequestSchema: GenMessage<DescribeWorkerDeploymentRequest> =
  /*@__PURE__*/
 ...
 */
export type DescribeWorkerDeploymentResponse =
  Message<'temporal.api.workflowservice.v1.DescribeWorkerDeploymentResponse'> & {
    /**
 ...
 */
export const DescribeWorkerDeploymentResponseSchema: GenMessage<DescribeWorkerDeploymentResponse> =
  /*@__PURE__*/
 ...
 */
export const SetCurrentDeploymentRequestSchema: GenMessage<SetCurrentDeploymentRequest> =
  /*@__PURE__*/
 ...
 */
export const SetCurrentDeploymentResponseSchema: GenMessage<SetCurrentDeploymentResponse> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentCurrentVersionRequest =
  Message<'temporal.api.workflowservice.v1.SetWorkerDeploymentCurrentVersionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const SetWorkerDeploymentCurrentVersionRequestSchema: GenMessage<SetWorkerDeploymentCurrentVersionRequest> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentCurrentVersionResponse =
 ...
 */
export const SetWorkerDeploymentCurrentVersionResponseSchema: GenMessage<SetWorkerDeploymentCurrentVersionResponse> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentRampingVersionRequest =
  Message<'temporal.api.workflowservice.v1.SetWorkerDeploymentRampingVersionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const SetWorkerDeploymentRampingVersionRequestSchema: GenMessage<SetWorkerDeploymentRampingVersionRequest> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentRampingVersionResponse =
 ...
 */
export const SetWorkerDeploymentRampingVersionResponseSchema: GenMessage<SetWorkerDeploymentRampingVersionResponse> =
  /*@__PURE__*/
 ...
 */
export const ListWorkerDeploymentsRequestSchema: GenMessage<ListWorkerDeploymentsRequest> =
  /*@__PURE__*/
 ...
 */
export const ListWorkerDeploymentsResponseSchema: GenMessage<ListWorkerDeploymentsResponse> =
  /*@__PURE__*/
 ...
 */
export type ListWorkerDeploymentsResponse_WorkerDeploymentSummary =
  Message<'temporal.api.workflowservice.v1.ListWorkerDeploymentsResponse.WorkerDeploymentSummary'> & {
    /**
     * @generated from field: string name = 1;
     */
    name: string
 ...
 */
export const ListWorkerDeploymentsResponse_WorkerDeploymentSummarySchema: GenMessage<ListWorkerDeploymentsResponse_WorkerDeploymentSummary> =
  /*@__PURE__*/
 ...
 */
export type DeleteWorkerDeploymentVersionRequest =
  Message<'temporal.api.workflowservice.v1.DeleteWorkerDeploymentVersionRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const DeleteWorkerDeploymentVersionRequestSchema: GenMessage<DeleteWorkerDeploymentVersionRequest> =
  /*@__PURE__*/
 ...
 */
export type DeleteWorkerDeploymentVersionResponse =
  Message<'temporal.api.workflowservice.v1.DeleteWorkerDeploymentVersionResponse'> & {}
 ...
 */
export const DeleteWorkerDeploymentVersionResponseSchema: GenMessage<DeleteWorkerDeploymentVersionResponse> =
  /*@__PURE__*/
 ...
 */
export const DeleteWorkerDeploymentRequestSchema: GenMessage<DeleteWorkerDeploymentRequest> =
  /*@__PURE__*/
 ...
 */
export type DeleteWorkerDeploymentResponse =
  Message<'temporal.api.workflowservice.v1.DeleteWorkerDeploymentResponse'> & {}
 ...
 */
export const DeleteWorkerDeploymentResponseSchema: GenMessage<DeleteWorkerDeploymentResponse> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerDeploymentVersionMetadataRequest =
  Message<'temporal.api.workflowservice.v1.UpdateWorkerDeploymentVersionMetadataRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const UpdateWorkerDeploymentVersionMetadataRequestSchema: GenMessage<UpdateWorkerDeploymentVersionMetadataRequest> =
  /*@__PURE__*/
 ...
 */
export type UpdateWorkerDeploymentVersionMetadataResponse =
 ...
 */
export const UpdateWorkerDeploymentVersionMetadataResponseSchema: GenMessage<UpdateWorkerDeploymentVersionMetadataResponse> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentManagerRequest =
 ...
 */
export const SetWorkerDeploymentManagerRequestSchema: GenMessage<SetWorkerDeploymentManagerRequest> =
  /*@__PURE__*/
 ...
 */
export type SetWorkerDeploymentManagerResponse =
  Message<'temporal.api.workflowservice.v1.SetWorkerDeploymentManagerResponse'> & {
    /**
     * This value is returned so that it can be optionally passed to APIs
     * that write to the Worker Deployment state to ensure that the state
     * did not change between this API call and a future write.
 ...
 */
export const SetWorkerDeploymentManagerResponseSchema: GenMessage<SetWorkerDeploymentManagerResponse> =
  /*@__PURE__*/
 ...
 */
export const GetCurrentDeploymentRequestSchema: GenMessage<GetCurrentDeploymentRequest> =
  /*@__PURE__*/
 ...
 */
export const GetCurrentDeploymentResponseSchema: GenMessage<GetCurrentDeploymentResponse> =
  /*@__PURE__*/
 ...
 */
export type GetDeploymentReachabilityRequest =
  Message<'temporal.api.workflowservice.v1.GetDeploymentReachabilityRequest'> & {
    /**
     * @generated from field: string namespace = 1;
     */
    namespace: string
 ...
 */
export const GetDeploymentReachabilityRequestSchema: GenMessage<GetDeploymentReachabilityRequest> =
  /*@__PURE__*/
 ...
 */
export type GetDeploymentReachabilityResponse =
  Message<'temporal.api.workflowservice.v1.GetDeploymentReachabilityResponse'> & {
    /**
     * @generated from field: temporal.api.deployment.v1.DeploymentInfo deployment_info = 1;
     */
    deploymentInfo?: DeploymentInfo
 ...
 */
export const GetDeploymentReachabilityResponseSchema: GenMessage<GetDeploymentReachabilityResponse> =
  /*@__PURE__*/
 ...
 */
export const CreateWorkflowRuleRequestSchema: GenMessage<CreateWorkflowRuleRequest> =
  /*@__PURE__*/
 ...
 */
export const CreateWorkflowRuleResponseSchema: GenMessage<CreateWorkflowRuleResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeWorkflowRuleRequestSchema: GenMessage<DescribeWorkflowRuleRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeWorkflowRuleResponseSchema: GenMessage<DescribeWorkflowRuleResponse> =
  /*@__PURE__*/
 ...
 */
export const DeleteWorkflowRuleRequestSchema: GenMessage<DeleteWorkflowRuleRequest> =
  /*@__PURE__*/
 ...
 */
export const DeleteWorkflowRuleResponseSchema: GenMessage<DeleteWorkflowRuleResponse> =
  /*@__PURE__*/
 ...
 */
export const ListWorkflowRulesRequestSchema: GenMessage<ListWorkflowRulesRequest> =
  /*@__PURE__*/
 ...
 */
export const ListWorkflowRulesResponseSchema: GenMessage<ListWorkflowRulesResponse> =
  /*@__PURE__*/
 ...
 */
export const TriggerWorkflowRuleRequestSchema: GenMessage<TriggerWorkflowRuleRequest> =
  /*@__PURE__*/
 ...
 */
export const TriggerWorkflowRuleResponseSchema: GenMessage<TriggerWorkflowRuleResponse> =
  /*@__PURE__*/
 ...
 */
export const RecordWorkerHeartbeatRequestSchema: GenMessage<RecordWorkerHeartbeatRequest> =
  /*@__PURE__*/
 ...
 */
export type RecordWorkerHeartbeatResponse =
  Message<'temporal.api.workflowservice.v1.RecordWorkerHeartbeatResponse'> & {}
 ...
 */
export const RecordWorkerHeartbeatResponseSchema: GenMessage<RecordWorkerHeartbeatResponse> =
  /*@__PURE__*/
 ...
 */
export const UpdateTaskQueueConfigRequestSchema: GenMessage<UpdateTaskQueueConfigRequest> =
  /*@__PURE__*/
 ...
 */
export type UpdateTaskQueueConfigRequest_RateLimitUpdate =
  Message<'temporal.api.workflowservice.v1.UpdateTaskQueueConfigRequest.RateLimitUpdate'> & {
    /**
 ...
 */
export const UpdateTaskQueueConfigRequest_RateLimitUpdateSchema: GenMessage<UpdateTaskQueueConfigRequest_RateLimitUpdate> =
  /*@__PURE__*/
 ...
 */
export const UpdateTaskQueueConfigResponseSchema: GenMessage<UpdateTaskQueueConfigResponse> =
  /*@__PURE__*/
 ...
 */
export const FetchWorkerConfigRequestSchema: GenMessage<FetchWorkerConfigRequest> =
  /*@__PURE__*/
 ...
 */
export const FetchWorkerConfigResponseSchema: GenMessage<FetchWorkerConfigResponse> =
  /*@__PURE__*/
 ...
 */
export const UpdateWorkerConfigRequestSchema: GenMessage<UpdateWorkerConfigRequest> =
  /*@__PURE__*/
 ...
 */
export const UpdateWorkerConfigResponseSchema: GenMessage<UpdateWorkerConfigResponse> =
  /*@__PURE__*/
 ...
 */
export const DescribeWorkerRequestSchema: GenMessage<DescribeWorkerRequest> =
  /*@__PURE__*/
 ...
 */
export const DescribeWorkerResponseSchema: GenMessage<DescribeWorkerResponse> =
  /*@__PURE__*/
