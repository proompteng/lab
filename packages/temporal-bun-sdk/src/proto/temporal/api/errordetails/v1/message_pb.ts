...
import type { WorkflowExecution } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { ResourceExhaustedCause, ResourceExhaustedScope } from '../../enums/v1/failed_cause_pb.ts'
import { file_temporal_api_enums_v1_failed_cause } from '../../enums/v1/failed_cause_pb.ts'
import type { NamespaceState } from '../../enums/v1/namespace_pb.ts'
 ...
 */
export const file_temporal_api_errordetails_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
 ...
 */
export const NotFoundFailureSchema: GenMessage<NotFoundFailure> =
  /*@__PURE__*/
 ...
 */
export type WorkflowExecutionAlreadyStartedFailure =
 ...
 */
export const WorkflowExecutionAlreadyStartedFailureSchema: GenMessage<WorkflowExecutionAlreadyStartedFailure> =
  /*@__PURE__*/
 ...
 */
export const NamespaceNotActiveFailureSchema: GenMessage<NamespaceNotActiveFailure> =
  /*@__PURE__*/
 ...
 */
export const NamespaceUnavailableFailureSchema: GenMessage<NamespaceUnavailableFailure> =
  /*@__PURE__*/
 ...
 */
export const NamespaceInvalidStateFailureSchema: GenMessage<NamespaceInvalidStateFailure> =
  /*@__PURE__*/
 ...
 */
export const NamespaceNotFoundFailureSchema: GenMessage<NamespaceNotFoundFailure> =
  /*@__PURE__*/
 ...
 */
export const NamespaceAlreadyExistsFailureSchema: GenMessage<NamespaceAlreadyExistsFailure> =
  /*@__PURE__*/
 ...
 */
export type ClientVersionNotSupportedFailure =
  Message<'temporal.api.errordetails.v1.ClientVersionNotSupportedFailure'> & {
    /**
 ...
 */
export const ClientVersionNotSupportedFailureSchema: GenMessage<ClientVersionNotSupportedFailure> =
  /*@__PURE__*/
 ...
 */
export type ServerVersionNotSupportedFailure =
  Message<'temporal.api.errordetails.v1.ServerVersionNotSupportedFailure'> & {
    /**
 ...
 */
export const ServerVersionNotSupportedFailureSchema: GenMessage<ServerVersionNotSupportedFailure> =
  /*@__PURE__*/
 ...
 */
export type CancellationAlreadyRequestedFailure =
  Message<'temporal.api.errordetails.v1.CancellationAlreadyRequestedFailure'> & {}
 ...
 */
export const CancellationAlreadyRequestedFailureSchema: GenMessage<CancellationAlreadyRequestedFailure> =
  /*@__PURE__*/
 ...
 */
export const QueryFailedFailureSchema: GenMessage<QueryFailedFailure> =
  /*@__PURE__*/
 ...
 */
export const PermissionDeniedFailureSchema: GenMessage<PermissionDeniedFailure> =
  /*@__PURE__*/
 ...
 */
export const ResourceExhaustedFailureSchema: GenMessage<ResourceExhaustedFailure> =
  /*@__PURE__*/
 ...
 */
export const SystemWorkflowFailureSchema: GenMessage<SystemWorkflowFailure> =
  /*@__PURE__*/
 ...
 */
export const WorkflowNotReadyFailureSchema: GenMessage<WorkflowNotReadyFailure> =
  /*@__PURE__*/
 ...
 */
export const NewerBuildExistsFailureSchema: GenMessage<NewerBuildExistsFailure> =
  /*@__PURE__*/
 ...
 */
export const MultiOperationExecutionFailureSchema: GenMessage<MultiOperationExecutionFailure> =
  /*@__PURE__*/
 ...
 */
export type MultiOperationExecutionFailure_OperationStatus =
  Message<'temporal.api.errordetails.v1.MultiOperationExecutionFailure.OperationStatus'> & {
    /**
 ...
 */
export const MultiOperationExecutionFailure_OperationStatusSchema: GenMessage<MultiOperationExecutionFailure_OperationStatus> =
  /*@__PURE__*/
