...
export const file_temporal_api_errordetails_v1_message: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_any, file_temporal_api_common_v1_message, file_temporal_api_enums_v1_failed_cause, file_temporal_api_enums_v1_namespace, file_temporal_api_failure_v1_message]);
 ...
 * existing one.
 *
 * @generated from message temporal.api.errordetails.v1.NexusOperationExecutionAlreadyStartedFailure
 */
export type NexusOperationExecutionAlreadyStartedFailure = Message<"temporal.api.errordetails.v1.NexusOperationExecutionAlreadyStartedFailure"> & {
  /**
   * @generated from field: string start_request_id = 1;
   */
  startRequestId: string;
...
/**
 * Describes the message temporal.api.errordetails.v1.NexusOperationExecutionAlreadyStartedFailure.
 * Use `create(NexusOperationExecutionAlreadyStartedFailureSchema)` to create a new message.
 */
export const NexusOperationExecutionAlreadyStartedFailureSchema: GenMessage<NexusOperationExecutionAlreadyStartedFailure> = /*@__PURE__*/
  messageDesc(file_temporal_api_errordetails_v1_message, 18);
 ...
 *
 * @generated from message temporal.api.errordetails.v1.WorkflowTaskCompletionBufferLostFailure
 */
export type WorkflowTaskCompletionBufferLostFailure = Message<"temporal.api.errordetails.v1.WorkflowTaskCompletionBufferLostFailure"> & {
};

/**
 * Describes the message temporal.api.errordetails.v1.WorkflowTaskCompletionBufferLostFailure.
 * Use `create(WorkflowTaskCompletionBufferLostFailureSchema)` to create a new message.
 */
export const WorkflowTaskCompletionBufferLostFailureSchema: GenMessage<WorkflowTaskCompletionBufferLostFailure> = /*@__PURE__*/
  messageDesc(file_temporal_api_errordetails_v1_message, 19);
