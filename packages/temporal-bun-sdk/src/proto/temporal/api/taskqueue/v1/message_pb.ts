...
import type { BuildIdTaskReachability, TaskQueueKind, TaskReachability } from '../../enums/v1/task_queue_pb.ts'
import { file_temporal_api_enums_v1_task_queue } from '../../enums/v1/task_queue_pb.ts'
import type { WorkerVersionCapabilities } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { WorkerDeploymentOptions, WorkerDeploymentVersion } from '../../deployment/v1/message_pb.ts'
 ...
 */
export const file_temporal_api_taskqueue_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
      file_google_protobuf_duration,
      file_google_protobuf_timestamp,
      file_google_protobuf_wrappers,
      file_temporal_api_enums_v1_task_queue,
 ...
 */
export const TaskQueueSchema: GenMessage<TaskQueue> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueMetadataSchema: GenMessage<TaskQueueMetadata> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueVersioningInfoSchema: GenMessage<TaskQueueVersioningInfo> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueVersionSelectionSchema: GenMessage<TaskQueueVersionSelection> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueVersionInfoSchema: GenMessage<TaskQueueVersionInfo> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueTypeInfoSchema: GenMessage<TaskQueueTypeInfo> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueStatsSchema: GenMessage<TaskQueueStats> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueStatusSchema: GenMessage<TaskQueueStatus> =
  /*@__PURE__*/
 ...
 */
export const TaskIdBlockSchema: GenMessage<TaskIdBlock> =
  /*@__PURE__*/
 ...
 */
export const TaskQueuePartitionMetadataSchema: GenMessage<TaskQueuePartitionMetadata> =
  /*@__PURE__*/
 ...
 */
export const PollerInfoSchema: GenMessage<PollerInfo> =
  /*@__PURE__*/
 ...
 */
export const StickyExecutionAttributesSchema: GenMessage<StickyExecutionAttributes> =
  /*@__PURE__*/
 ...
 */
export const CompatibleVersionSetSchema: GenMessage<CompatibleVersionSet> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueReachabilitySchema: GenMessage<TaskQueueReachability> =
  /*@__PURE__*/
 ...
 */
export const BuildIdReachabilitySchema: GenMessage<BuildIdReachability> =
  /*@__PURE__*/
 ...
 */
export const RampByPercentageSchema: GenMessage<RampByPercentage> =
  /*@__PURE__*/
 ...
 */
export const BuildIdAssignmentRuleSchema: GenMessage<BuildIdAssignmentRule> =
  /*@__PURE__*/
 ...
 */
export const CompatibleBuildIdRedirectRuleSchema: GenMessage<CompatibleBuildIdRedirectRule> =
  /*@__PURE__*/
 ...
 */
export const TimestampedBuildIdAssignmentRuleSchema: GenMessage<TimestampedBuildIdAssignmentRule> =
  /*@__PURE__*/
 ...
 */
export type TimestampedCompatibleBuildIdRedirectRule =
 ...
 */
export const TimestampedCompatibleBuildIdRedirectRuleSchema: GenMessage<TimestampedCompatibleBuildIdRedirectRule> =
  /*@__PURE__*/
 ...
 */
export const PollerScalingDecisionSchema: GenMessage<PollerScalingDecision> =
  /*@__PURE__*/
 ...
 */
export const ConfigMetadataSchema: GenMessage<ConfigMetadata> =
  /*@__PURE__*/
 ...
 */
export const TaskQueueConfigSchema: GenMessage<TaskQueueConfig> =
  /*@__PURE__*/
