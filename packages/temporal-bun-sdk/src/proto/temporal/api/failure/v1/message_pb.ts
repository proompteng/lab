...
import type { ActivityType, Payload, Payloads, WorkflowExecution, WorkflowType } from '../../common/v1/message_pb.ts'
import { file_temporal_api_common_v1_message } from '../../common/v1/message_pb.ts'
import type { RetryState, TimeoutType } from '../../enums/v1/workflow_pb.ts'
...
import type { ApplicationErrorCategory } from '../../enums/v1/common_pb.ts'
 ...
 */
export const file_temporal_api_failure_v1_message: GenFile =
  /*@__PURE__*/
  fileDesc(
    '',
    [
 ...
 */
export const ApplicationFailureInfoSchema: GenMessage<ApplicationFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const TimeoutFailureInfoSchema: GenMessage<TimeoutFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const CanceledFailureInfoSchema: GenMessage<CanceledFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const TerminatedFailureInfoSchema: GenMessage<TerminatedFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const ServerFailureInfoSchema: GenMessage<ServerFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const ResetWorkflowFailureInfoSchema: GenMessage<ResetWorkflowFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const ActivityFailureInfoSchema: GenMessage<ActivityFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const ChildWorkflowExecutionFailureInfoSchema: GenMessage<ChildWorkflowExecutionFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const NexusOperationFailureInfoSchema: GenMessage<NexusOperationFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const NexusHandlerFailureInfoSchema: GenMessage<NexusHandlerFailureInfo> =
  /*@__PURE__*/
 ...
 */
export const FailureSchema: GenMessage<Failure> = /*@__PURE__*/ messageDesc(file_temporal_api_failure_v1_message, 10)
 ...
 */
export const MultiOperationExecutionAbortedSchema: GenMessage<MultiOperationExecutionAborted> =
  /*@__PURE__*/
