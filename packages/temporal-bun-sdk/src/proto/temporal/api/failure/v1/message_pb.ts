...
export class ApplicationFailureInfo extends Message<ApplicationFailureInfo> {
  ...
  static equals(
    a: ApplicationFailureInfo | PlainMessage<ApplicationFailureInfo> | undefined,
    b: ApplicationFailureInfo | PlainMessage<ApplicationFailureInfo> | undefined,
  ): boolean {
...
export class TimeoutFailureInfo extends Message<TimeoutFailureInfo> {
  ...
  static equals(
    a: TimeoutFailureInfo | PlainMessage<TimeoutFailureInfo> | undefined,
    b: TimeoutFailureInfo | PlainMessage<TimeoutFailureInfo> | undefined,
  ): boolean {
...
export class CanceledFailureInfo extends Message<CanceledFailureInfo> {
  ...
  static equals(
    a: CanceledFailureInfo | PlainMessage<CanceledFailureInfo> | undefined,
    b: CanceledFailureInfo | PlainMessage<CanceledFailureInfo> | undefined,
  ): boolean {
...
export class TerminatedFailureInfo extends Message<TerminatedFailureInfo> {
  ...
  static equals(
    a: TerminatedFailureInfo | PlainMessage<TerminatedFailureInfo> | undefined,
    b: TerminatedFailureInfo | PlainMessage<TerminatedFailureInfo> | undefined,
  ): boolean {
...
export class ServerFailureInfo extends Message<ServerFailureInfo> {
  ...
  static equals(
    a: ServerFailureInfo | PlainMessage<ServerFailureInfo> | undefined,
    b: ServerFailureInfo | PlainMessage<ServerFailureInfo> | undefined,
  ): boolean {
...
export class ResetWorkflowFailureInfo extends Message<ResetWorkflowFailureInfo> {
  ...
  static equals(
    a: ResetWorkflowFailureInfo | PlainMessage<ResetWorkflowFailureInfo> | undefined,
    b: ResetWorkflowFailureInfo | PlainMessage<ResetWorkflowFailureInfo> | undefined,
  ): boolean {
...
export class ActivityFailureInfo extends Message<ActivityFailureInfo> {
  ...
  static equals(
    a: ActivityFailureInfo | PlainMessage<ActivityFailureInfo> | undefined,
    b: ActivityFailureInfo | PlainMessage<ActivityFailureInfo> | undefined,
  ): boolean {
...
export class ChildWorkflowExecutionFailureInfo extends Message<ChildWorkflowExecutionFailureInfo> {
  ...
  static equals(
    a: ChildWorkflowExecutionFailureInfo | PlainMessage<ChildWorkflowExecutionFailureInfo> | undefined,
    b: ChildWorkflowExecutionFailureInfo | PlainMessage<ChildWorkflowExecutionFailureInfo> | undefined,
  ): boolean {
...
export class NexusOperationFailureInfo extends Message<NexusOperationFailureInfo> {
  ...
  static equals(
    a: NexusOperationFailureInfo | PlainMessage<NexusOperationFailureInfo> | undefined,
    b: NexusOperationFailureInfo | PlainMessage<NexusOperationFailureInfo> | undefined,
  ): boolean {
...
export class NexusHandlerFailureInfo extends Message<NexusHandlerFailureInfo> {
  ...
  static equals(
    a: NexusHandlerFailureInfo | PlainMessage<NexusHandlerFailureInfo> | undefined,
    b: NexusHandlerFailureInfo | PlainMessage<NexusHandlerFailureInfo> | undefined,
  ): boolean {
...
export class Failure extends Message<Failure> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 11, name: 'activity_failure_info', kind: 'message', T: ActivityFailureInfo, oneof: 'failure_info' },
    {
      ...
      kind: 'message',
      T: ChildWorkflowExecutionFailureInfo,
      oneof: 'failure_info',
    },
    {
      no: 13,
...
export class MultiOperationExecutionAborted extends Message<MultiOperationExecutionAborted> {
  ...
  static equals(
    a: MultiOperationExecutionAborted | PlainMessage<MultiOperationExecutionAborted> | undefined,
    b: MultiOperationExecutionAborted | PlainMessage<MultiOperationExecutionAborted> | undefined,
  ): boolean {
